...
function fenxi(arr = []) {
  ...
  arr.forEach((item, index) => {
    ...
    const flag_4 = !item[2].endsWith('A'); // 排除 A类
    const flag_5 = !item[2].endsWith('ETF'); // 排除 ETF结尾
    ...
    const flag_6 = !arr_2.some((text) => item[3].includes(text)); // 排除 类型中包含
