...
async function fetchFundData() {
  ...
  for (let i = 0; i < arr.length; i++) {
    ...
    let obj_2 = fund_data_arr[22];// 近一月
    let obj_3 = fund_data_arr[fund_data_arr.length - 1];
    // 计算差值
    let total_1_month = Math.floor(obj_1.totalNetValue * 10000) - Math.floor(obj_2.totalNetValue * 10000);
    let total_3_month = Math.floor(obj_1.totalNetValue * 10000) - Math.floor(obj_3.totalNetValue * 10000);
