  ...
  <div class="hello">
    <a v-for="(item, index) in info" :key="index" target="_blank" :href="'http://fund.eastmoney.com/' + numberArr[index] + '.html?spm=aladin'
      ...
      <div class="price_Reminder">
        ...
        <div class="price_state1" v-show="businessArr[index] === 1">低于设定的值</div>
        <div class="price_state2" v-show="businessArr[index] === 2">正常区间</div>
        <div class="price_state3" v-show="businessArr[index] === 3">高于设定值</div>
