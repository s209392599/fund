...
const info = reactive({
  ...
  list: [
    ...
    {
      name: '天天基金可转债排行',
      adress: 'http://fund.eastmoney.com/data/fundranking.html#tzq;c0;r;s6yzf;pn50;ddesc;qsd20201027;qed20211027;qdii;zq045;gg;gzbd;gzfs;bbzt;sfbb',
    },
    {
      name: '天天基金-基金对比',
...
console.log('qwewqe', localStorage.getItem('email'));
