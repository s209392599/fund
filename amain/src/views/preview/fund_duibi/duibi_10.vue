<script setup>
console.log('amain/src/views/preview/fund_duibi/duibi_10.vue');
/*
011496 多个基金经理
*/
...
<template>
  <div class="page_wrapper">
    ...
    <div class="pb-5">
      <el-button class="top_btn" @click="btn_fn_01()" disabled>删除不可买</el-button>
      <!-- <el-button class="top_btn btn_2" @click="btn_fn_02()" disabled>删除小于1亿</el-button> -->
      <!-- <el-button class="top_btn btn_3" @click="btn_fn_03()" disabled>删除1、3、6月排名靠后</el-button> -->
    ...
    <el-table :data="info.tableData" style="width: 100%" border stripe :max-height="tableMaxHeight">
      ...
      <el-table-column label="历史业绩" align="center">
        <template v-for="(item, index_1) in his_name_arr" :key="item">
          <el-table-column :label="item" width="96" align="right" sortable
