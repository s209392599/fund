<script setup>
console.log('amain/src/views/preview/other/other_002_003.vue');
...
watch(() => props.data, (newVal = {}) => {
  ...
  info.ri_zhou = newVal.gupiao_jiaocha_ri_zhou || [];
  info.zhou_yue = newVal.gupiao_jiaocha_zhou_yue || [];
  info.ri_zhou_yue = newVal.gupiao_jiaocha_ri_zhou_yue || [];
...
<template>
  <div class="page_wrapper">
    <div class="desc">算法说明：读取日周月的排行榜前300名，去除A类进行交叉排名取交集。{{ props.mtime ? '最后更新时间：' + props.mtime : '' }}</div>
...
@use '@/views/preview/other/css/other_002_001.scss';
</style>
