<script setup>
console.log('amain/src/views/preview/other/other_002_002.vue');
...
watch(() => props.data, (newVal = {}) => {
  ...
  info.ri_zhou = newVal.zhishu_jiaocha_ri_zhou || [];
  info.zhou_yue = newVal.zhishu_jiaocha_zhou_yue || [];
  info.ri_zhou_yue = newVal.zhishu_jiaocha_ri_zhou_yue || [];
