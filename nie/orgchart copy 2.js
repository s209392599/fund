...
var OrgChart = function (t, e) {
  ...
  Object.defineProperty(this, "element", {
    get: () => t.querySelector("[data-boc-content]"),
    set(t) {
      r.mainElement = t;
    },
  }),
    ...
    Object.defineProperty(this, "leftElement", {
      get: () => t.querySelector("[data-boc-left]"),
    }),
    (this.element = t);
};
(OrgChart.prototype._constructor = function (t) {
  var e = this;
  if (
    ((this.config = OrgChart.mergeDeep(OrgChart._defaultConfig(t), t)),
    (this._layoutConfigs = {
      base: {
    ...
    for (var r in this.config.tags) {
      var i = this.config.tags[r];
      null != i.subTreeConfig &&
        (this._layoutConfigs[r] = {
          orientation:
            null != i.subTreeConfig.orientation
              ? i.subTreeConfig.orientation
              : this.config.orientation,
          levelSeparation:
            null != i.subTreeConfig.levelSeparation
              ? i.subTreeConfig.levelSeparation
              : this.config.levelSeparation,
          mixedHierarchyNodesSeparation:
            null != i.subTreeConfig.mixedHierarchyNodesSeparation
              ? i.subTreeConfig.mixedHierarchyNodesSeparation
              : this.config.mixedHierarchyNodesSeparation,
          assistantSeparation:
          ...
          subtreeSeparation:
            null != i.subTreeConfig.subtreeSeparation
              ? i.subTreeConfig.subtreeSeparation
              : this.config.subtreeSeparation,
          siblingSeparation:
            null != i.subTreeConfig.siblingSeparation
              ? i.subTreeConfig.siblingSeparation
              : this.config.siblingSeparation,
          layout:
            null != i.subTreeConfig.layout
              ? i.subTreeConfig.layout
              : this.config.layout,
          columns:
            null != i.subTreeConfig.columns
              ? i.subTreeConfig.columns
              : this.config.columns,
          collapse:
            null != i.subTreeConfig.collapse
              ? i.subTreeConfig.collapse
              : this.config.collapse,
          partnerNodeSeparation:
            null != i.subTreeConfig.partnerNodeSeparation
              ? i.subTreeConfig.partnerNodeSeparation
              : this.config.partnerNodeSeparation,
          template: i.subTreeConfig.template,
        });
    }
  (this._event_id = OrgChart._guid()),
    OrgChart._validateConfig(this.config) &&
      ...
      (this._ai = new OrgChart._ai(this)),
      this.config.searchUI
        ? (this.searchUI = this.config.searchUI)
        : (this.searchUI = new OrgChart.searchUI()),
      this.config.aiUI
        ? (this.aiUI = this.config.aiUI)
        : (this.aiUI = new OrgChart.aiUI()),
      this.config.orgScribeUI
        ? (this.orgScribeUI = this.config.orgScribeUI)
        : (this.orgScribeUI = new OrgChart.orgScribeUI()),
      this.config.powerPointPreviewUI
        ? (this.powerPointPreviewUI = this.config.powerPointPreviewUI)
        : (this.powerPointPreviewUI = new OrgChart.exportUI("pptx")),
      this.config.pdfPreviewUI
        ? (this.pdfPreviewUI = this.config.pdfPreviewUI)
        : (this.pdfPreviewUI = new OrgChart.exportUI("pdf")),
      this.config.svgPreviewUI
        ? (this.svgPreviewUI = this.config.svgPreviewUI)
        : (this.svgPreviewUI = new OrgChart.exportUI("svg")),
      this.config.pngPreviewUI
        ? (this.pngPreviewUI = this.config.pngPreviewUI)
        : (this.pngPreviewUI = new OrgChart.exportUI("png")),
      ...
      this.config.controlsUI
        ? (this.controlsUI = this.config.controlsUI)
        : (this.controlsUI = new OrgChart.controlsUI()),
      ...
      this.config.xScrollUI ||
        (this.xScrollUI = new OrgChart.xScrollUI(
          ...
          function () {
            return {
              boundary: e.response.boundary,
              scale: e.getScale(),
              viewBox: e.getViewBox(),
              padding: e.config.padding,
            };
          },
          function (t) {
            e.setViewBox(t);
          ...
          function () {
            e._draw(!0, OrgChart.action.xScroll);
          }
        )),
      ...
      this.mainElement.classList.add("boc-" + this.config.mode),
      ...
      (this.nodes = null),
      (this.isVisible = null),
      (this._connectorLines = { x: {}, y: {} }),
      OrgChart._intersectionObserver(this.element, function (t) {
        (e.isVisible = t),
          !1 !== OrgChart.events.publish("visibility-change", [e]) &&
            OrgChart.LAZY_LOADING &&
            e.isVisible &&
            (e._loaded
              ? e._draw(!1, OrgChart.action.update)
              : (e._setInitialSizeIfNotSet(),
                e._draw(!1, OrgChart.action.init)));
      }),
      (this._resizeObserver = new ResizeObserver((t) => {
        for (let r of t) {
          const { width: t, height: i } = r.contentRect;
          e._resizeHandler(t, i);
        }
      })),
  ...
  (OrgChart.prototype._draw = function (t, e, r, i) {
    ...
    if (!OrgChart.LAZY_LOADING || this.isVisible)
      if (
        ...
        var a = e == OrgChart.action.init ? null : this.getViewBox();
        this.manager.read(
          t,
          this.width(),
          this.height(),
          ...
          r,
          function (t) {
            if (!n.notifierUI.show(t.notif)) {
              e != OrgChart.action.exporting &&
                ((n.nodes = t.nodes),
                (n.visibleNodeIds = t.visibleNodeIds),
                (n.roots = t.roots)),
                (n._connectorLines = { x: {}, y: {} }),
                (n.editUI.fields = t.allFields);
              var a = { defs: "" };
              OrgChart.events.publish("renderdefs", [n, a]);
              var o = n.ui.defs(a.defs),
                s = n.getScale(t.viewBox);
              o += n.ui.pointer(n.config, e, s);
              var l = n.getViewBox(),
                h = t.viewBox;
              a = { content: o, res: t };
              OrgChart.events.publish("prerender", [n, a]), (o = a.content);
              var c = [];
              if (OrgChart.RENDER_LINKS_BEFORE_NODES)
                for (var d = 0; d < t.visibleNodeIds.length; d++) {
                  var g = t.nodes[t.visibleNodeIds[d]];
              ...
              for (d = 0; d < t.visibleNodeIds.length; d++) {
                ...
                if (
                  ...
                  var u = function (r) {
                      if (!g.treeList.pinnedIds.includes(r.id)) {
                        var i = n._get(r.id);
                        (o += n.ui.node(
                          r,
                          i,
                      ...
                      for (var a of r.children) u(a);
                    },
                    f = OrgChart.randomId();
                  for (var m of ((o += `<clipPath id="treelist_${f}">\n                    <rect rx="10" ry="10" x="${
                    g.x + g.padding[3]
                  }" y="${g.y + g.padding[0]}" width="${
                    g.w - g.padding[1] - g.padding[3]
                  }" height="${
                    g.h - g.padding[2] - g.padding[0]
                  }">\n                    </clipPath><g clip-path="url(#treelist_${f})"><g data-treelist-content="${
                    g.id
                  }" transform="matrix(1,0,0,1,0,-${g.treeList.scrollTop})">`),
                  g.stChildren))
                    u(m);
                  for (var C of g.treeList.pinnedIds) {
                    var b = n.getNode(C),
                      x = n._get(C);
                    (o += n.ui.node(
                      b,
                  ...
                  var {
                    ...
                    thumbPosition: O,
                    scrollBarDisplay: y,
                  } = OrgChart._treeListGetTumbPositionFromScrollTop(g);
                  o += `</g>\n\n                \n                <rect style="display: ${y}" data-treelist-scroll="${
                    g.id
                  }"  class="boc-scroll" x="${
                    g.x + g.w - g.padding[1] - OrgChart.TREELIST_SCROLLBAR_WIDTH
                  }" y="${g.y + g.padding[0]}" width="${
                    OrgChart.TREELIST_SCROLLBAR_WIDTH
                  }" height="${
                    g.h - g.padding[2] - g.padding[0]
                  }"></rect>\n                <rect style="display: ${y}" data-treelist-thumb="${
                    g.id
                  }" class="boc-scroll-thumb" x="${
                    g.x + g.w - g.padding[1] - OrgChart.TREELIST_SCROLLBAR_WIDTH
                  }" y="${O}" width="${
                    OrgChart.TREELIST_SCROLLBAR_WIDTH
                  }" height="${v}"></rect>\n\n                </g>`;
              ...
              for (d = 0; d < t.visibleNodeIds.length; d++) {
                (g = t.nodes[t.visibleNodeIds[d]]), (p = n._get(g.id));
                g.isTreeListItem ||
                  (OrgChart.RENDER_LINKS_BEFORE_NODES ||
                    (o += n.ui.link(
                      g,
              ...
              a = { content: o, res: t };
              if (
                (OrgChart.events.publish("render", [n, a]),
                (o = a.content),
                (t = a.res),
                (o += n.ui.lonely(n.config)),
                e !== OrgChart.action.exporting)
              ) {
                (e !== OrgChart.action.centernode &&
                  ...
                  (h = l),
                  e === OrgChart.action.init && null != l && (h = l),
                  e === OrgChart.action.centerNode && null != l && (h = l),
                  (n.response = t),
                  (n._lastSize = { width: n.width(), height: n.height() });
                A = n.ui.svg("100%", "100%", h, n.config, o);
                if (n._initialized) {
                  var _ = n.getSvg(),
                    w = _.parentNode;
                  w.removeChild(_),
                    w.insertAdjacentHTML("afterbegin", A),
                    n._attachEventHandlers(),
                    n.xScrollUI.addListener(n.getSvg()),
                    n.yScrollUI.addListener(n.getSvg()),
                    n.xScrollUI.setPosition(),
                    n.yScrollUI.setPosition();
                } else
                  (n.element.innerHTML =
                    n.ui.css() +
                    A +
                    n.ui.menuButton(n.config) +
                    n.ui.aiButton(n.config)),
                    n._attachEventHandlers(),
                    n.xScrollUI.create(n.width(), n.config.padding),
                    n.xScrollUI.setPosition(),
                    n.xScrollUI.addListener(n.getSvg()),
                    n.yScrollUI.create(n.height(), n.config.padding),
                    n.yScrollUI.setPosition(),
                    n.yScrollUI.addListener(n.getSvg()),
                    n.config.enableSearch && n.searchUI.init(n),
                    n.aiUI.init(n),
                    n.orgScribeUI.init(n),
                    n.powerPointPreviewUI.init(n),
                    n.pdfPreviewUI.init(n),
                    n.svgPreviewUI.init(n),
                    n.pngPreviewUI.init(n),
                    n.toolbarUI.init(n, n.config.toolbar),
                    n.undoRedoUI.init(n),
                    n.controlsUI.init(n);
                var k = !1,
                  I = n.response.animations;
                if (I[0].length > 0) {
                  n._hideBeforeAnimation(I[0].length);
                  for (d = 0; d < I[0].length; d++)
                    I[0][d] = n.getNodeElement(I[0][d]);
                  OrgChart.animate(
                    I[0],
                    I[1],
                    I[2],
                    n.config.anim.duration,
                    n.config.anim.func,
                    function () {
                      k ||
                        (i && i.call(n),
                        OrgChart.events.publish("redraw", [n]),
                        n._showAfterAnimation(),
                        (k = !0));
                    }
                  );
                }
                e === OrgChart.action.centerNode
                  ? OrgChart.animate(
                      n.getSvg(),
                      { viewbox: l },
                      { viewbox: n.response.viewBox },
                      n.config.anim.duration,
                      n.config.anim.func,
                      function () {
                        n.ripple(r.options.rippleId),
                          k ||
                            (i && i.call(n),
                            OrgChart.events.publish("redraw", [n]),
                            n._showAfterAnimation(),
                      ...
                      function () {
                        n.xScrollUI.setPosition(), n.yScrollUI.setPosition();
                      }
                    )
                  : !l ||
                    !n.response ||
                    (l[0] == n.response.viewBox[0] &&
                      l[1] == n.response.viewBox[1] &&
                      l[2] == n.response.viewBox[2] &&
                      l[3] == n.response.viewBox[3]) ||
                    (e !== OrgChart.action.insert &&
                      e !== OrgChart.action.expand &&
                      e !== OrgChart.action.collapse &&
                      e !== OrgChart.action.update &&
                  ...
                  n._initialized ||
                    ...
                    n.filterUI.update(),
                    n._ai.setContext(),
                    OrgChart.events.publish("init", [n])),
                  !n._loaded &&
                    t &&
                    t.nodes &&
                ...
                var S = t.boundary,
                  L = S.maxX - S.minX,
                  E = S.maxY - S.minY,
                  A = n.ui.svg(L, E, [S.minX, S.minY, L, E], n.config, o, s);
                i.call(n, A, t);
              }
            }
          },
          function (t) {
            OrgChart.events.publish("ready", [n, t]);
          }
        );
      } else
        console.error(
  ...
  (OrgChart.prototype._setInitialSizeIfNotSet = function () {
    (this.mainElement.style.overflow = "hidden"),
      ...
      0 == this.mainElement.offsetHeight &&
        ((this.mainElement.style.height = "100%"),
        0 == this.mainElement.offsetHeight &&
          (this.mainElement.style.height = "700px")),
      0 == this.mainElement.offsetWidth &&
        ((this.mainElement.style.width = "100%"),
        0 == this.mainElement.offsetWidth &&
          (this.mainElement.style.width = "700px"));
  }),
  ...
  (OrgChart.prototype.centerOutNodes = function (t) {
    if (this._centerInNodes) {
      var e = JSON.parse(this._centerInNodes);
      this._centerInNodes = null;
      var r = this;
      this._centerInNodesTimeout = OrgChart.animate(
        this.getSvg(),
        ...
        function () {
          r.draw(OrgChart.action.update, null, function () {
            t && t.call(r);
          });
        }
      );
  ...
  (OrgChart.prototype.centerInNodes = function (t, e) {
    var r = this.getViewBox();
    this._centerInNodes || (this._centerInNodes = JSON.stringify(r));
    ...
    var l = o - a,
      h = n - i,
      c =
        (d = l / (l + 2 * this.config.padding)) >
        (g = h / (h + 2 * this.config.padding))
          ? g
          : d;
    c > this.config.scaleMax && (c = this.config.scaleMax),
      c < this.config.scaleMin && (c = this.config.scaleMin);
    var d,
      g,
      p = [50, 50],
      u = this.width(),
      f = this.height(),
      m = (d = u / r[2]) > (g = f / r[3]) ? g : d,
      C = r,
      b = r[2],
      x = r[3];
    (r[2] = r[2] / (c / m)),
      (r[3] = r[3] / (c / m)),
      (r[0] = C[0] - (r[2] - b) / (100 / p[0])),
      (r[1] = C[1] - (r[3] - x) / (100 / p[1])),
      (r[0] = a - (u / c - l) / 2),
      (r[1] = i - (f / c - h) / 2);
    var v = this;
    this._centerInNodesTimeout &&
      (clearTimeout(this._centerInNodesTimeout),
      (this._centerInNodesTimeout = null)),
      (this._centerInNodesTimeout = OrgChart.animate(
        this.getSvg(),
        { viewBox: this.getViewBox() },
        { viewBox: r },
        ...
        this.config.anim.func,
        function () {
          v.draw(OrgChart.action.update, null, function () {
            e && e.call(v);
          });
        }
      ));
  ...
  (OrgChart.prototype.center = function (t, e, r) {
    ...
    e && null != e.parentState && (i = e.parentState),
      e && null != e.childrenState && (n = e.childrenState),
      e && null != e.rippleId && (a = e.rippleId),
      e && null != e.vertical && (o = e.vertical),
      e && null != e.horizontal && (s = e.horizontal);
    var l = {
      parentState: i,
      childrenState: n,
      rippleId: a,
    ...
    this._draw(!1, OrgChart.action.centerNode, { id: t, options: l }, r);
  }),
  ...
  (OrgChart.prototype.fitIfOutside = function (t) {
    (this.config.scaleInitial = OrgChart.match.boundaryIfOutside),
      this._draw(!0, OrgChart.action.init, { method: "fit" }, t);
  }),
  ...
  (OrgChart.prototype._hideBeforeAnimation = function (t) {
    if (
      ...
      var n = this.element.querySelectorAll("[" + OrgChart.attr.link_id + "]");
      if (n.length > OrgChart.LINKS_THRESHOLD)
        for (r = 0; r < n.length; r++) n[r].style.display = "none";
      var a = this.element.querySelectorAll(
        "[" + OrgChart.attr.control_expcoll_id + "]"
      );
      if (a.length > OrgChart.BUTTONS_THRESHOLD)
  ...
  (OrgChart.prototype.moveNodesToVisibleArea = function (t, e) {
    for (
      ...
      var d = this.nodes[t[c]];
      null != d.x &&
        null != d.y &&
        ((null === o || o < d.x + d.w) && (o = d.x + d.w),
        (null === s || s < d.y + d.h) && (s = d.y + d.h),
        (null === l || l > d.x) && (l = d.x),
        (null === h || h > d.y) && (h = d.y));
    }
    if (null != o && null != s && null != l && null != h) {
      var g = this.width(),
        p = this.height(),
        u = g / (x = o - l + 2 * this.config.padding),
        f = p / (v = s - h + 2 * this.config.padding),
        m = u > f ? f : u,
        C = Math.ceil(g / m),
        b = Math.ceil(p / m),
        x = 0,
        v = 0;
      if (C - 2 * this.config.padding >= o - l) x = (o + l) / 2 - C / 2;
      else
        switch (
          ((x =
            i.x - C / 2 + OrgChart.manager._getNodeWidth(i, this.config) / 2),
          this.config.orientation)
        ) {
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            (x = -(C / 2 - (l - o) / 2)) < this.config.padding - C &&
              (x = this.config.padding - C);
            break;
          ...
          case OrgChart.orientation.left_top:
            (x = -(C / 2 - (o - l) / 2)) > -this.config.padding &&
              (x = -this.config.padding);
        }
      if (b - 2 * this.config.padding >= s - h) v = (s + h) / 2 - b / 2;
      else
        switch (
          ((v = -(b / 2 - (s - h) / 2)) > -this.config.padding &&
            (v = -this.config.padding),
          this.config.orientation)
        ) {
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            (v = -(b / 2 - (h - s) / 2)) < this.config.padding - b &&
              (v = this.config.padding - b);
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.right:
            v =
              i.y - b / 2 + OrgChart.manager._getNodeWidth(i, this.config) / 2;
        }
      var O = [x, v, C, b];
      a[0] !== O[0] || a[1] !== O[1]
        ? OrgChart.animate(
  ...
  (OrgChart.prototype.updateNode = function (t, e, r, i) {
    if (t) {
      var n = this,
        a = this.get(t.id);
      if (!0 === r)
        if (!1 === OrgChart.events.publish("update", [this, a, t])) return !1;
      this.update(t),
        this._ai.setContext(),
      ...
      var o = this.getNode(t.id),
        s = o.pid;
      null == s && (s = o.stpid),
        this._draw(!1, OrgChart.action.update, { id: s }, function () {
          i || n.ripple(t.id), e && e();
        });
    }
  }),
  ...
  (OrgChart.prototype.removeNode = function (t, e, r) {
    ...
    if (!0 === r && !1 === OrgChart.events.publish("remove", [this, t, i]))
      return !1;
    return (
      this.remove(t),
      this._ai.setContext(),
  ...
  (OrgChart.prototype._getNewPidsAndStpidsForIds = function (t) {
    var e = this.get(t),
      ...
      i = {};
    if (e)
      for (var n = this.config.nodes.length - 1; n >= 0; n--)
        this.config.nodes[n].pid == t
          ? (r[this.config.nodes[n].id] = e.pid)
          : this.config.nodes[n].stpid == t &&
            (i[this.config.nodes[n].id] = e.stpid);
    ...
    for (
      var e = function (e) {
          for (var r = 0; r < e.length; r++) {
            ...
            for (var n in t) {
              var a = t[n];
              i.from == n && (i.from = a), i.to == n && (i.to = a);
            }
          }
        },
        r = 0;
    ...
    if (this.nodes)
      for (var o in this.nodes)
        if (!OrgChart.isNEU(t[o])) {
          a = t[o];
          ((s = this.nodes[o]).id = a), (this.nodes[a] = s);
        }
    if (this.manager.oldNodes)
      for (var o in this.manager.oldNodes)
        if (!OrgChart.isNEU(t[o])) {
          a = t[o];
          ((s = this.manager.oldNodes[o]).id = a),
            (this.manager.oldNodes[a] = s);
        }
    if (this.roots)
      for (var o in this.roots)
        if (!OrgChart.isNEU(t[o])) {
          var s;
          a = t[o];
          ((s = this.roots[o]).id = a), (this.roots[a] = s);
        }
  ...
  (OrgChart._ajax = function (t, e, r, i, n) {
    null == i && (i = "arraybuffer");
    var a = new XMLHttpRequest();
    for (var o in ((a.onload = function (t) {
      4 == a.readyState &&
        200 === this.status &&
        (null == t.target ? n(this.response) : n(t.target.response));
    }),
    ...
    OrgChart.REQUEST_CUSTOM_HEADERS))
      a.setRequestHeader(o, OrgChart.REQUEST_CUSTOM_HEADERS[o]);
    null == r ? a.send() : a.send(r);
  }),
  void 0 === OrgChart && (OrgChart = {}),
  (OrgChart.animate = function (t, e, r, i, n, a, o) {
    var s,
      l = 10,
      h = 1,
      c = i / l + 1;
        ...
        for (var d = 0; d < t.length; d++)
          for (var g in r[d]) {
            ...
            switch (g.toLowerCase()) {
              case "d":
                var u =
                    n((h * l - l) / i) * (r[d][g][0] - e[d][g][0]) + e[d][g][0],
                  f =
                    n((h * l - l) / i) * (r[d][g][1] - e[d][g][1]) + e[d][g][1];
                t[d].setAttribute(
                  "d",
                ...
                break;
              case "r":
                var m = n((h * l - l) / i) * (r[d][g] - e[d][g]) + e[d][g];
                t[d].setAttribute("r", m);
                break;
              case "x1":
                m = n((h * l - l) / i) * (r[d][g] - e[d][g]) + e[d][g];
              ...
              case "rotate3d":
                if (r[d][g]) {
                  var C = e[d][g],
                    ...
                    x = [0, 0, 0, 0];
                  for (var v in C)
                    x[v] = n((h * l - l) / i) * (b[v] - C[v]) + C[v];
                  t[d].style.transform = "rotate3d(" + x.toString() + "deg)";
                }
                break;
              case "transform":
                if (r[d][g]) {
                  (C = e[d][g]), (b = r[d][g]), (x = [0, 0, 0, 0, 0, 0]);
                  for (var v in C)
                    x[v] = n((h * l - l) / i) * (b[v] - C[v]) + C[v];
                  t[d].hasAttribute("transform")
                    ...
                    : (t[d].style.transform = "matrix(" + x.toString() + ")");
                }
                break;
              case "viewbox":
                if (r[d][g]) {
                  (C = e[d][g]), (b = r[d][g]), (x = [0, 0, 0, 0]);
                  for (var v in C)
                    x[v] = n((h * l - l) / i) * (b[v] - C[v]) + C[v];
                  t[d].setAttribute("viewBox", x.toString());
                }
                break;
              case "margin":
                if (r[d][g]) {
                  ...
                  for (var v in C)
                    x[v] = n((h * l - l) / i) * (b[v] - C[v]) + C[v];
                  var O = "";
                  for (v = 0; v < x.length; v++) O += parseInt(x[v]) + "px ";
                  t[d] && t[d].style && (t[d].style[g] = O);
                }
                break;
              case "scrolly":
                m = n((h * l - l) / i) * (r[d][g] - e[d][g]) + e[d][g];
  ...
  (OrgChart.prototype._attachEventHandlers = function (t) {
    if (this.config.interactive) {
      ...
      t.addEventListener(
        "touchstart",
        function (t) {
          t.preventDefault(), e._globalMouseDownHandler.apply(e, [this, t]);
        },
        { passive: !1 }
      ),
        t.addEventListener(
          "mousedown",
          function (t) {
            e._globalMouseDownHandler.apply(e, [this, t]);
          },
          { passive: !0 }
        ),
        t.addEventListener(
          "contextmenu",
          function (t) {
            e._globalContextHandler.apply(e, [this, t]);
          },
          { passive: !1 }
        ),
        t.addEventListener(
          "dblclick",
          function (t) {
            e._globalDbClickHandler.apply(e, [this, t]);
          },
          { passive: !0 }
        ),
        this.config.mouseScrool != OrgChart.action.none &&
          t.addEventListener(
            "wheel",
            function (t) {
              e._mouseScrollHandler.apply(e, [this, t]);
            },
            { passive: !1 }
          );
      ...
      r &&
        r.addEventListener("click", function (t) {
          e._menuClickHandler.apply(e, [this, t]);
        });
    }
  }),
  void 0 === OrgChart && (OrgChart = {}),
  (OrgChart.VERSION = "9.01.36"),
  ...
  (OrgChart.match.boundaryIfOutside = 100004),
  (OrgChart.match.none = 1),
  (OrgChart.movable = {}),
  ...
  (OrgChart.A5 = { width: 420, height: 595 }),
  (OrgChart.A4 = { width: 595, height: 842 }),
  (OrgChart.A3 = { width: 842, height: 1191 }),
  (OrgChart.A2 = { width: 1191, height: 1684 }),
  (OrgChart.A1 = { width: 1684, height: 2384 }),
  (OrgChart.Letter = { width: 612, height: 791 }),
  (OrgChart.Legal = { width: 612, height: 1009 }),
  (OrgChart.Legal = { width: 612, height: 1009 }),
  (OrgChart.Widescreen = { width: 720, height: 1280 }),
  (OrgChart.Standard = { width: 720, height: 960 }),
  ...
  (OrgChart.TEXT_THRESHOLD = 4e3),
  (OrgChart.IMAGES_THRESHOLD = 1e3),
  (OrgChart.LINKS_THRESHOLD = 2e3),
  (OrgChart.BUTTONS_THRESHOLD = 700),
  (OrgChart.ANIM_THRESHOLD = 500),
  ...
  (OrgChart.MIXED_LAYOUT_ALL_NODES = !1),
  ...
  (OrgChart.LAZY_LOADING_FACTOR = "auto"),
  ...
  (OrgChart.TREELIST_WHEEL_STEP = "auto"),
  (OrgChart.TREELIST_SCROLLBAR_WIDTH = 10),
  (OrgChart.CONVERT_IMAGES_TO_BASE64_BEFORE_EXPORT = !1),
  (OrgChart.REQUEST_CUSTOM_HEADERS = {}),
  (OrgChart.SLINK_GAP = 7),
  "undefined" != typeof module && (module.exports = OrgChart),
  (OrgChart._intersects = function (t, e, r) {
    var i = t.x - r.siblingSeparation / 4,
      n = t.y,
      a = t.x + t.w + r.siblingSeparation / 4,
      o = t.y;
    ...
    return (
      0 !== (s = (a - i) * (p - d) - (g - c) * (o - n)) &&
      ((l = ((n - o) * (g - i) + (a - i) * (p - n)) / s),
      0 < (h = ((p - d) * (g - i) + (c - g) * (p - n)) / s) &&
        h < 1 &&
        0 < l &&
        l < 1)
    );
  }),
  (OrgChart._addPoint = function (t, e, r, i, n) {
    switch (r.orientation) {
      case OrgChart.orientation.top:
      case OrgChart.orientation.top_left:
        return OrgChart._addPointTop(t, e, r, i, n);
      case OrgChart.orientation.bottom:
      case OrgChart.orientation.bottom_left:
        return OrgChart._addPointBottom(t, e, r, i, n);
      case OrgChart.orientation.left:
      case OrgChart.orientation.left_top:
        return OrgChart._addPointLeft(t, e, r, i, n);
      case OrgChart.orientation.right:
      case OrgChart.orientation.right_top:
        return OrgChart._addPointRight(t, e, r, i, n);
    }
  }),
  (OrgChart._addPointTop = function (t, e, r, i, n) {
    var a, o, s;
    return (
      "left" == n
        ? (a = t.leftNeighbor
      ...
      e.push([a, e[e.length - 1][1]]),
      e.push([a, t.y - r.levelSeparation / 3]),
      (o = e[e.length - 1][1]),
      (s = a),
      (i.p = a),
      (i.q = o),
  ...
  (OrgChart._addPointBottom = function (t, e, r, i, n) {
    var a, o, s;
    return (
      "left" == n
        ? (a = t.leftNeighbor
        ...
        : "right" == n &&
          (a = t.rightNeighbor
            ...
            : t.x + t.w + r.siblingSeparation / 2),
      e.push([a, e[e.length - 1][1]]),
      e.push([a, t.y + t.h + r.levelSeparation / 3]),
      (o = e[e.length - 1][1]),
      (s = a),
      (i.p = a),
      (i.q = o),
  ...
  (OrgChart._addPointLeft = function (t, e, r, i, n) {
    var a,
      o = e[e.length - 1][0];
    "bottom" == n
      ? (a = t.rightNeighbor
      ...
      e.push([e[e.length - 1][0], a]),
      e.push([t.x - r.levelSeparation / 3, a]),
      (o = e[e.length - 1][0]);
    var s = a;
    return (i.p = o), (i.q = a), (i.s = s), i;
  }),
  (OrgChart._addPointRight = function (t, e, r, i, n) {
    var a,
      o = e[e.length - 1][0];
    "bottom" == n
      ? (a = t.rightNeighbor
      ...
      : "top" == n &&
        (a = t.leftNeighbor
          ...
          : t.y - r.siblingSeparation / 2),
      e.push([e[e.length - 1][0], a]),
      e.push([t.x + t.w + r.levelSeparation / 3, a]),
      (o = e[e.length - 1][0]);
    var s = a;
    return (i.p = o), (i.q = a), (i.s = s), i;
  }),
  (OrgChart._addConnectorLines = function (t, e) {
    OrgChart._addConnectorLine(t, { x1: e.xa, y1: e.ya, x2: e.xb, y2: e.yb }),
      OrgChart._addConnectorLine(t, { x1: e.xb, y1: e.yb, x2: e.xc, y2: e.yc }),
      OrgChart._addConnectorLine(t, { x1: e.xc, y1: e.yc, x2: e.xd, y2: e.yd });
  }),
  (OrgChart._addConnectorLine = function (t, e) {
    if (e.x1 == e.x2) {
      if ((t.x[e.x1] || (t.x[e.x1] = []), e.y1 > e.y2)) {
        var r = e.y1;
        (e.y1 = e.y2), (e.y2 = r);
      }
      t.x[e.x1].push({ y1: e.y1, y2: e.y2 });
    }
    if (e.y1 == e.y2) {
      if ((t.y[e.y1] || (t.y[e.y1] = []), e.x1 > e.x2)) {
        var i = e.x1;
        (e.x1 = e.x2), (e.x2 = i);
      }
      t.y[e.y1].push({ x1: e.x1, x2: e.x2 });
    }
  }),
  (OrgChart._addLineToPath = function (t, e, r) {
    return (
      OrgChart._avoidOverlapping(e, r),
      t.push([r.x1, r.y1]),
      t.push([r.x2, r.y2]),
      OrgChart._addConnectorLine(e, r),
      r
    );
  }),
  (OrgChart._slinkRemoveUnusedPoints = function (t) {
    for (var e = t.length - 2; e >= 1; e--) {
      var r = t[e - 1],
        i = t[e],
        n = t[e + 1];
      ((i[0] == r[0] && i[0] == n[0]) || (i[1] == r[1] && i[1] == n[1])) &&
        t.splice(e, 1);
    }
  }),
  (OrgChart._slinkAvoidOverlaping = function (t, e, r, i) {
    for (var n = 1; n < e.length; n++) {
        ...
        for (var s = t.x[o[0]]; s; ) {
          ...
          for (var h of s)
            if (
              ...
              i == OrgChart.orientation.top ||
              i == OrgChart.orientation.top_left
                ? "left" == r
                  ? (o[0] -= OrgChart.SLINK_GAP)
                  : "right" == r && (o[0] += OrgChart.SLINK_GAP)
                : (i != OrgChart.orientation.bottom &&
                    i != OrgChart.orientation.bottom_left) ||
                  ("right" == r
                    ? (o[0] += OrgChart.SLINK_GAP)
                    : "left" == r && (o[0] -= OrgChart.SLINK_GAP)),
                (l = !1);
              break;
            }
          if (l) break;
      ...
      var c = !0;
      if ((a[1] == o[1] && a[0] >= o[0] && (c = !1), c && a[1] == o[1])) {
        for (s = t.y[o[1]]; s; ) {
          l = !0;
          for (var h of s)
            if (
  ...
  (OrgChart._slinkAvoidOverlapingSecond = function (t, e, r) {
        ...
        for (var s = t.y[a[1]]; s; ) {
          ...
          for (var h of s)
            if (
              ...
              n[0] >= a[0]
                ? (r == OrgChart.orientation.top ||
                  r == OrgChart.orientation.top_left
                    ? (a[1] -= OrgChart.SLINK_GAP)
                    : (r != OrgChart.orientation.bottom &&
                        r != OrgChart.orientation.bottom_left) ||
                      (a[1] += OrgChart.SLINK_GAP),
                  (l = !1))
                : (o = !0);
              break;
  ...
  (OrgChart._slinkAvoidOverlaping2 = function (t, e, r, i) {
    for (var n = 1; n < e.length; n++) {
      var a = e[n - 1],
        o = e[n];
      if (a[1] == o[1]) {
        for (var s = t.y[o[1]]; s; ) {
          ...
          for (var h of s)
            if (
              ...
              i == OrgChart.orientation.left ||
              i == OrgChart.orientation.left_top
                ? "top" == r
                  ? (o[1] -= OrgChart.SLINK_GAP)
                  : "bottom" == r && (o[1] += OrgChart.SLINK_GAP)
                : (i != OrgChart.orientation.right &&
                    i != OrgChart.orientation.right_top) ||
                  ("bottom" == r
                    ? (o[1] += OrgChart.SLINK_GAP)
                    : "top" == r && (o[1] -= OrgChart.SLINK_GAP)),
                (l = !1);
              break;
            }
          if (l) break;
      ...
      var c = !0;
      if ((a[0] == o[0] && a[1] >= o[1] && (c = !1), c && a[0] == o[0])) {
        for (s = t.x[o[0]]; s; ) {
          l = !0;
          for (var h of s)
            if (
  ...
  (OrgChart._slinkAvoidOverlapingSecond2 = function (t, e, r) {
    for (var i = 1; i < e.length; i++) {
      var n = e[i - 1],
        a = e[i],
        o = !1;
        ...
        for (var s = t.x[a[0]]; s; ) {
          ...
          for (var h of s)
            if (
              ...
              n[1] >= a[1]
                ? (r == OrgChart.orientation.left ||
                  r == OrgChart.orientation.left_top
                    ? (a[0] -= OrgChart.SLINK_GAP)
                    : (r != OrgChart.orientation.right &&
                        r != OrgChart.orientation.right_top) ||
                      (a[0] += OrgChart.SLINK_GAP),
                  (l = !1))
                : (o = !0);
              break;
  ...
  (OrgChart.editUI.prototype.show = function (t, e, r) {
    if (this.hide(!0)) {
      if (
        ...
        return !1;
      var i = this,
        n = this.content(t, e, r);
      this.obj.element.appendChild(n.element),
        OrgChart.input.init(this.obj.element),
        OrgChart.events.publish("shown", [this, { nodeId: t }]),
        r
          ? e || this._focusElement(n.focusId)
      ...
      for (
        var a = this.obj.element.querySelectorAll("[data-input-btn]"), o = 0;
        o < a.length;
        o++
      ) {
        ...
        .addEventListener("click", function (t) {
          ...
          n.focus(),
            n.nextElementSibling.addEventListener("click", function (t) {
              t.stopPropagation(), t.preventDefault();
              var r = n.value,
                a = i.obj.element.querySelector(
                  '[data-binding="' +
                    OrgChart._escapeDoubleQuotes(n.value) +
                    '"]'
                );
              if (OrgChart.isNEU(r) || a) n.focus();
              else {
                ...
                n.parentNode.parentNode.parentNode.removeChild(
        ...
        this.obj.element
          ...
          .addEventListener("click", function (e) {
            ...
            if (r && r.hasAttribute) {
              ...
              if (!1 === OrgChart.events.publish("button-click", [i, a]))
                return !1;
              switch (n) {
                case "edit":
      ...
      var s = this.obj.element.querySelectorAll(
        "[data-boc-edit-form] [data-binding]"
      );
      for (o = 0; o < s.length; o++) {
        var l = s[o];
        l.getAttribute("data-binding") &&
  ...
  (OrgChart.editUI.prototype._drawCurrentNodeElement = function () {
    var t = this.obj.element.querySelector("[data-boc-edit-form]"),
      e = OrgChart.input.getData(t),
      r = this.obj.get(this.nodeId),
      i = this.obj.getNode(this.nodeId),
      n = OrgChart.mergeDeep(r, e),
      a = this.obj.ui.node(
        i,
        n,
        [],
    ...
    this._replaceNodeWith(a);
  }),
  (OrgChart.editUI.prototype._replaceNodeWith = function (t) {
    var e = document.createElementNS("http://www.w3.org/2000/svg", "g");
    e.innerHTML = t;
    var r = e.firstElementChild;
    this.obj.getNodeElement(this.nodeId).replaceWith(r);
  }),
  (OrgChart.editUI.prototype.setAvatar = function (t) {
    var e = this.obj.element.querySelector('[id="boc-avatar"]'),
      r = this.obj.element.querySelector('[id="boc-avatar"] img'),
      i = this.obj.element.querySelector('[id="boc-avatar"] svg');
    e &&
      (r
        ? r.setAttribute("src", t)
        : i &&
          (e.innerHTML = `<img style="width: 100%;height:100%;border-radius: 50%;object-fit:cover;" src="${t}">`),
      this._drawCurrentNodeElement());
  }),
  (OrgChart.editUI.prototype.save = function (t) {
    var e = this.obj.element.querySelector("[data-boc-edit-form]"),
      r = OrgChart.input.validateAndGetData(e);
    if (!1 !== r) {
      var i = this.obj.get(this.nodeId),
        n = { data: OrgChart.mergeDeep(i, r) };
      if (!1 === OrgChart.events.publish("save", [this, n])) return;
      return this.obj.updateNode(n.data, null, !0, t), !0;
    }
    return !1;
  }),
  ...
  (OrgChart.editUI.prototype.content = function (t, e, r, i, n) {
    var a,
      o = this.obj.config.editForm.readOnly,
      s = JSON.parse(JSON.stringify(this.obj.config.editForm.elements)),
      l = this.obj.config.editForm.addMore,
      h = this.obj.config.editForm.saveAndCloseBtn,
      c = this.obj.config.editForm.buttons,
      d = this.obj.config.editForm.titleBinding,
      g = this.obj.config.editForm.photoBinding,
      p = this.obj.getNode(t),
      u = this.obj._get(t),
      f = OrgChart.t(p.templateName, p.min, this.obj.getScale()),
      m = u[d],
      C = u[g];
    if (this.obj.config.editForm.generateElementsFromFields)
      for (var b = 0; b < this.fields.length; b++) {
        var x = this.fields[b];
        if ("tags" != x) {
          for (var v = !1, O = 0; O < s.length; O++) {
            if (Array.isArray(s[O])) {
              for (var y = 0; y < s[O].length; y++)
                if (x == s[O][y].binding) {
                  v = !0;
                  break;
                }
            } else if (x == s[O].binding) {
              v = !0;
              break;
            }
            if (v) break;
          }
          v || s.push({ type: "textbox", label: x, binding: x });
        }
      }
    OrgChart.isNEU(m) && (m = ""),
      (C = OrgChart.isNEU(C)
        ? OrgChart.icon.user(150, 150, "#8C8C8C", 0, 0)
        : `<img style="width: 100%;height:100%;border-radius: 50%;object-fit:cover;" src="${C}"></img>`);
    var _ = !e,
      w = e ? "display:none;" : "",
      k = e || !l ? "display:none;" : "",
      I = f.editFormHeaderColor
    ...
    if (
      ...
      S.classList.add(p.templateName.replaceAll(" ", "")),
      S.classList.add(OrgChart.ui._defsIds[p.templateName]),
      Array.isArray(p.tags) && p.tags.length)
    )
      for (b = 0; b < p.tags.length; b++)
        S.classList.add(p.tags[b].replaceAll(" ", ""));
    (S.style.display = "flex"),
      (S.style.opacity = r ? 1 : 0),
      (S.style.right = r ? 0 : "-20px"),
      i && (S.style.width = i);
    var L = [],
      E = n ? "" : OrgChart.EDITFORM_CLOSE_BTN;
    return (
        ...
        for (var t = "", r = 0; r < s.length; r++) {
          ...
          if (Array.isArray(i)) {
            ...
            for (var n = 0; n < i.length; n++) {
              var o = i[n],
                l = OrgChart.elements[o.type](u, o, "unset", e);
              !OrgChart.isNEU(l.id) &&
                OrgChart.isNEU(a) &&
                OrgChart.isNEU(l.value) &&
                (a = l.id),
                OrgChart.isNEU(l.value) || L.push(`${o.label}: ${l.value}`),
                (t += l.html);
            }
            t += "</div>";
          } else {
            l = OrgChart.elements[i.type](u, i, "280px", e);
            !OrgChart.isNEU(l.id) &&
              OrgChart.isNEU(a) &&
              OrgChart.isNEU(l.value) &&
              (a = l.id),
              OrgChart.isNEU(l.value) || L.push(`${i.label}: ${l.value}`),
              (t += l.html);
          }
        }
        return t;
      ...
      { element: S, focusId: a, title: m, shareText: L.join("\n") }
    );
  }),
  ...
  (OrgChart.menuUI.prototype.show = function (t, e, r, i, n) {
    this._show(t, e, r, i, n);
  }),
  (OrgChart.menuUI.prototype._show = function (t, e, r, i, n) {
    var a = this;
    this.hide();
    var o = "";
    n || (n = this.menu);
    var s = { firstNodeId: r, secondNodeId: i, menu: n };
    if (!1 === OrgChart.events.publish("show", [this, s])) return !1;
    for (var l in (n = s.menu)) {
      var h = n[l].icon,
        c = n[l].text;
      void 0 === h &&
        (h = OrgChart.icon[l] ? OrgChart.icon[l](24, 24, "#7A7A7A") : ""),
    ...
    if ("" != o) {
      ...
      for (
        ...
        (l = u[f]).addEventListener("click", function (t) {
          var e = this.getAttribute(OrgChart.attr.item),
            o = n[e].onClick;
          0 != OrgChart._onClickHandler(a.obj, e, o, r, i) && a.hide();
        });
      }
    }
  }),
  ...
  (OrgChart.controlsUI = function () {}),
  (OrgChart.controlsUI.prototype.init = function (t) {
    (this.instance = t),
      (this.elements = {
        top_right: null,
        right_top: null,
  ...
  (OrgChart.controlsUI.prototype.show = function () {
    var t = this,
      e = function (e) {
        for (
          var r = e.target;
          r && r.hasAttribute && !r.hasAttribute("data-control-id");

        )
          r = r.parentNode;
        if (r.hasAttribute && r.hasAttribute("data-control-id")) {
          var i = r.getAttribute("data-control-id"),
            n = t.instance.config.controls[i];
          if (!OrgChart.isNEU(n.isOn))
            r.classList.contains("boc-control-selected")
              ? r.classList.remove("boc-control-selected")
              : r.classList.add("boc-control-selected");
          var a = n.onClick;
          OrgChart._onClickHandler(t.instance, i, a, void 0, void 0);
        }
      },
    ...
    if (r) {
      ...
      for (var n in r) {
        ...
        void 0 === o &&
          (o = OrgChart.icon[n]
            ? OrgChart.icon[n](32, 32, "#7A7A7A")
            : OrgChart.icon.cursor(32, 32, "#7A7A7A"));
        var s = a.title;
        s || (s = n);
        var l = "";
        !0 === a.isOn && (l = 'class="boc-control-selected"');
        var h = `<div ${l} data-control-id="${n}" title="${s}">${o}</div>`;
        a.anchor || (a.anchor = OrgChart.anchor.bottom_right),
          (i[a.anchor] += h);
      }
      for (var n in i)
        i[n] &&
          ((this.elements[n] = document.createElement("div")),
          (this.elements[n].className = "boc-controls boc-controls-" + n),
          (this.elements[n].innerHTML = i[n]),
          this.elements[n].addEventListener("click", e),
          this.instance.element.appendChild(this.elements[n]));
    }
  }),
  (OrgChart.controlsUI.prototype.hide = function () {
  ...
  (OrgChart.circleMenuUI.prototype.isVisible = function () {
    return (
      null !==
  ...
  (OrgChart.circleMenuUI.prototype._show = function (t, e) {
    var r = this,
      ...
      n = OrgChart.t(i.templateName, i.min, this.obj.getScale());
    if (!OrgChart.isNEU(n.nodeCircleMenuButton)) {
      var a = this.obj.getSvg(),
        o = this.obj.element.querySelector(
          "[" + OrgChart.attr.control_node_circle_menu_id + '="' + t + '"]'
        ),
        s = this.obj.getNodeElement(t),
        l = OrgChart._getTransform(o),
        h = OrgChart._getTransform(s),
        c = l[4] + h[4],
        d = l[5] + h[5],
      ...
      if (
        ...
        for (
          var m = 0,
            ...
            b = 2 * n.nodeCircleMenuButton.radius + 4,
            x = 2 * Math.PI * b,
            v = x / C - (2 * n.nodeCircleMenuButton.radius + 2);
          v < 0;
          ...
          (b += 8),
            (v =
              (x = 2 * Math.PI * b) / C -
              (2 * n.nodeCircleMenuButton.radius + 2));
        for (var O in ((p = document.createElementNS(
          "http://www.w3.org/2000/svg",
          "g"
        ...
        u.menu)) {
          ...
          k.setAttribute("transform", "matrix(1,0,0,1,0,0)"),
            k.setAttribute(OrgChart.attr.control_node_circle_menu_name, O),
            (k.style.cursor = "pointer");
          var I = document.createElementNS(
            "http://www.w3.org/2000/svg",
            "title"
          );
          OrgChart.isNEU(w) || (I.innerHTML = w);
          ...
          S.setAttribute("cx", 0),
            S.setAttribute("cy", 0),
            S.setAttribute("r", n.nodeCircleMenuButton.radius),
            S.setAttribute("fill", _),
            S.setAttribute("stroke-width", "1"),
            S.setAttribute("stroke", n.nodeCircleMenuButton.stroke),
            k.appendChild(S),
            k.appendChild(I),
            (k.innerHTML += y),
            p.appendChild(k);
          ...
          if ((L.setAttribute("pointer-events", "none"), L)) {
            var E = parseInt(L.getAttribute("width")),
              A = parseInt(L.getAttribute("height"));
            L.setAttribute("x", -E / 2), L.setAttribute("y", -A / 2);
          }
          var N = (m * Math.PI) / (C / 2);
          m++;
          var $ = Math.cos(N) * b,
        ...
        this._linesInterval.push(
          OrgChart.animate(
            g[0],
            {
              x1: -n.nodeCircleMenuButton.radius / 2,
              y1: -6,
              x2: n.nodeCircleMenuButton.radius / 2,
              y2: -6,
            },
            { x1: -7, y1: -7, x2: 7, y2: 7 },
            500,
  ...
  (OrgChart.circleMenuUI.prototype.hide = function () {
    ...
    if (null != e) {
      ...
      a[0].setAttribute("x1", -n.nodeCircleMenuButton.radius / 2),
        a[0].setAttribute("x2", n.nodeCircleMenuButton.radius / 2),
        a[0].setAttribute("y1", -6),
        a[0].setAttribute("y2", -6),
        a[1].setAttribute("x1", -n.nodeCircleMenuButton.radius / 2),
        a[1].setAttribute("x2", n.nodeCircleMenuButton.radius / 2),
        a[1].setAttribute("y1", 0),
        a[1].setAttribute("y2", 0),
        a[2].setAttribute("x1", -n.nodeCircleMenuButton.radius / 2),
        a[2].setAttribute("x2", n.nodeCircleMenuButton.radius / 2),
        a[2].setAttribute("y1", 6),
        a[2].setAttribute("y2", 6),
  ...
  (OrgChart.toolbarUI.prototype.init = function (t, e) {
    if (e) {
      ...
      var r = this.div.querySelector("[" + OrgChart.attr.tlbr + '="plus"]'),
        ...
        n = this.div.querySelector("[" + OrgChart.attr.tlbr + '="fit"]'),
        a = this.div.querySelector("[" + OrgChart.attr.tlbr + '="fullScreen"]'),
      ...
      r &&
        ...
        a &&
          a.addEventListener("click", function () {
            s.obj.toggleFullScreen();
          }),
        o &&
          o.addEventListener("click", function () {
            s.obj.expand(null, "all");
          }),
        this.layoutBtn &&
          this.layoutBtn.addEventListener("click", function () {
            s._visible ? s.hideLayout() : s.showLayout();
          }),
        this.layouts &&
            ...
            for (var e = t.target; e; ) {
              if (e.hasAttribute && e.hasAttribute(OrgChart.attr.layout)) {
                (e = e.getAttribute(OrgChart.attr.layout)),
                  s.obj.setLayout(OrgChart.layout[e]);
                break;
              }
              e = e.parentNode;
            }
  ...
  (OrgChart.notifierUI.prototype.show = function (t, e) {
    ...
    var i = this.obj.width() / 2 - r.offsetWidth / 2,
      n = this.obj.height() / 2 - r.offsetHeight / 2;
  ...
  (OrgChart.icon.svg_export =
    OrgChart.icon.svg_preview =
    OrgChart.icon.svg =
      function (t, e, r, i, n) {
        return (
          null == i && (i = 0),
  ...
  (OrgChart.icon.csv_export = OrgChart.icon.csv =
    function (t, e, r, i, n) {
      return (
        null == i && (i = 0),
        null == n && (n = 0),
        `<svg width="${t}" height="${e}" viewBox="0 0 548.29 548.291" x="${i}" y="${n}">'\n                <path fill="${r}" d="M486.2,196.121h-13.164V132.59c0-0.399-0.064-0.795-0.116-1.2c-0.021-2.52-0.824-5-2.551-6.96L364.656,3.677 c-0.031-0.034-0.064-0.044-0.085-0.075c-0.629-0.707-1.364-1.292-2.141-1.796c-0.231-0.157-0.462-0.286-0.704-0.419 c-0.672-0.365-1.386-0.672-2.121-0.893c-0.199-0.052-0.377-0.134-0.576-0.188C358.229,0.118,357.4,0,356.562,0H96.757 C84.893,0,75.256,9.649,75.256,21.502v174.613H62.093c-16.972,0-30.733,13.756-30.733,30.73v159.81 c0,16.966,13.761,30.736,30.733,30.736h13.163V526.79c0,11.854,9.637,21.501,21.501,21.501h354.777 c11.853,0,21.502-9.647,21.502-21.501V417.392H486.2c16.966,0,30.729-13.764,30.729-30.731v-159.81 C516.93,209.872,503.166,196.121,486.2,196.121z M96.757,21.502h249.053v110.006c0,5.94,4.818,10.751,10.751,10.751h94.973v53.861 H96.757V21.502z M258.618,313.18c-26.68-9.291-44.063-24.053-44.063-47.389c0-27.404,22.861-48.368,60.733-48.368 c18.107,0,31.447,3.811,40.968,8.107l-8.09,29.3c-6.43-3.107-17.862-7.632-33.59-7.632c-15.717,0-23.339,7.149-23.339,15.485 c0,10.247,9.047,14.769,29.78,22.632c28.341,10.479,41.681,25.239,41.681,47.874c0,26.909-20.721,49.786-64.792,49.786 c-18.338,0-36.449-4.776-45.497-9.77l7.38-30.016c9.772,5.014,24.775,10.006,40.264,10.006c16.671,0,25.488-6.908,25.488-17.396 C285.536,325.789,277.909,320.078,258.618,313.18z M69.474,302.692c0-54.781,39.074-85.269,87.654-85.269 c18.822,0,33.113,3.811,39.549,7.149l-7.392,28.816c-7.38-3.084-17.632-5.939-30.491-5.939c-28.822,0-51.206,17.375-51.206,53.099 c0,32.158,19.051,52.4,51.456,52.4c10.947,0,23.097-2.378,30.241-5.238l5.483,28.346c-6.672,3.34-21.674,6.919-41.208,6.919 C98.06,382.976,69.474,348.424,69.474,302.692z M451.534,520.962H96.757v-103.57h354.777V520.962z M427.518,380.583h-42.399 l-51.45-160.536h39.787l19.526,67.894c5.479,19.046,10.479,37.386,14.299,57.397h0.709c4.048-19.298,9.045-38.352,14.526-56.693 l20.487-68.598h38.599L427.518,380.583z" />'\n            </svg>`
      );
    }),
  (OrgChart.icon.json_export = OrgChart.icon.json =
    function (t, e, r, i, n) {
      return (
        null == i && (i = 0),
        null == n && (n = 0),
        `<svg width="${t}" height="${e}" viewBox="0 0 32 32" x="${i}" y="${n}">\n                <polygon fill="${r}"  points="31 11 31 21 29 21 27 15 27 21 25 21 25 11 27 11 29 17 29 11 31 11"/>\n                <path fill="${r}"  d="M21.3335,21h-2.667A1.6684,1.6684,0,0,1,17,19.3335v-6.667A1.6684,1.6684,0,0,1,18.6665,11h2.667A1.6684,1.6684,0,0,1,23,12.6665v6.667A1.6684,1.6684,0,0,1,21.3335,21ZM19,19h2V13H19Z"/>\n                <path fill="${r}"  d="M13.3335,21H9V19h4V17H11a2.002,2.002,0,0,1-2-2V12.6665A1.6684,1.6684,0,0,1,10.6665,11H15v2H11v2h2a2.002,2.002,0,0,1,2,2v2.3335A1.6684,1.6684,0,0,1,13.3335,21Z"/>\n                <path fill="${r}"  d="M5.3335,21H2.6665A1.6684,1.6684,0,0,1,1,19.3335V17H3v2H5V11H7v8.3335A1.6684,1.6684,0,0,1,5.3335,21Z"/>\n                <rect fill="${r}"  id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;" style="fill: none;" width="32" height="32"/>'\n            </svg>`
      );
    }),
  (OrgChart.icon.excel = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
      `<svg width="${t}" height="${e}" viewBox="0 0 24 24" x="${i}" y="${n}">\n                <path fill="${r}" d="M9.29289 1.29289C9.48043 1.10536 9.73478 1 10 1H18C19.6569 1 21 2.34315 21 4V9C21 9.55228 20.5523 10 20 10C19.4477 10 19 9.55228 19 9V4C19 3.44772 18.5523 3 18 3H11V8C11 8.55228 10.5523 9 10 9H5V20C5 20.5523 5.44772 21 6 21H7C7.55228 21 8 21.4477 8 22C8 22.5523 7.55228 23 7 23H6C4.34315 23 3 21.6569 3 20V8C3 7.73478 3.10536 7.48043 3.29289 7.29289L9.29289 1.29289ZM6.41421 7H9V4.41421L6.41421 7ZM19 12C19.5523 12 20 12.4477 20 13V19H23C23.5523 19 24 19.4477 24 20C24 20.5523 23.5523 21 23 21H19C18.4477 21 18 20.5523 18 20V13C18 12.4477 18.4477 12 19 12ZM11.8137 12.4188C11.4927 11.9693 10.8682 11.8653 10.4188 12.1863C9.96935 12.5073 9.86526 13.1318 10.1863 13.5812L12.2711 16.5L10.1863 19.4188C9.86526 19.8682 9.96935 20.4927 10.4188 20.8137C10.8682 21.1347 11.4927 21.0307 11.8137 20.5812L13.5 18.2205L15.1863 20.5812C15.5073 21.0307 16.1318 21.1347 16.5812 20.8137C17.0307 20.4927 17.1347 19.8682 16.8137 19.4188L14.7289 16.5L16.8137 13.5812C17.1347 13.1318 17.0307 12.5073 16.5812 12.1863C16.1318 11.8653 15.5073 11.9693 15.1863 12.4188L13.5 14.7795L11.8137 12.4188Z" fill="#000000"/>\n            </svg>`
    );
  }),
  (OrgChart.icon.pp_export =
    OrgChart.icon.pp_preview =
    OrgChart.icon.pppreview =
    OrgChart.icon.powerpoint =
      function (t, e, r, i, n) {
        return (
          null == i && (i = 0),
          null == n && (n = 0),
  ...
  (OrgChart.icon.edit = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
      `<svg width="${t}" height="${e}" viewBox="0 0 528.899 528.899" x="${i}" y="${n}">\n                <path fill="${r}" d="M328.883,89.125l107.59,107.589l-272.34,272.34L56.604,361.465L328.883,89.125z M518.113,63.177l-47.981-47.981 c-18.543-18.543-48.653-18.543-67.259,0l-45.961,45.961l107.59,107.59l53.611-53.611 C532.495,100.753,532.495,77.559,518.113,63.177z M0.3,512.69c-1.958,8.812,5.998,16.708,14.811,14.565l119.891-29.069 L27.473,390.597L0.3,512.69z" />'\n            </svg>`
    );
  }),
  (OrgChart.icon.details = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
      `<svg width="${t}" height="${e}" viewBox="0 0 512 512" x="${i}" y="${n}">\n                <path fill="${r}" d="M447.933,103.629c-0.034-3.076-1.224-6.09-3.485-8.352L352.683,3.511c-0.004-0.004-0.007-0.005-0.011-0.008 C350.505,1.338,347.511,0,344.206,0H89.278C75.361,0,64.04,11.32,64.04,25.237v461.525c0,13.916,11.32,25.237,25.237,25.237 h333.444c13.916,0,25.237-11.32,25.237-25.237V103.753C447.96,103.709,447.937,103.672,447.933,103.629z M356.194,40.931 l50.834,50.834h-49.572c-0.695,0-1.262-0.567-1.262-1.262V40.931z M423.983,486.763c0,0.695-0.566,1.261-1.261,1.261H89.278 c-0.695,0-1.261-0.566-1.261-1.261V25.237c0-0.695,0.566-1.261,1.261-1.261h242.94v66.527c0,13.916,11.322,25.239,25.239,25.239 h66.527V486.763z"/>\n                <path fill="${r}" d="M362.088,164.014H149.912c-6.62,0-11.988,5.367-11.988,11.988c0,6.62,5.368,11.988,11.988,11.988h212.175 c6.62,0,11.988-5.368,11.988-11.988C374.076,169.381,368.707,164.014,362.088,164.014z"/>\n                <path fill="${r}" d="M362.088,236.353H149.912c-6.62,0-11.988,5.368-11.988,11.988c0,6.62,5.368,11.988,11.988,11.988h212.175 c6.62,0,11.988-5.368,11.988-11.988C374.076,241.721,368.707,236.353,362.088,236.353z"/>\n                <path fill="${r}" d="M362.088,308.691H149.912c-6.62,0-11.988,5.368-11.988,11.988c0,6.621,5.368,11.988,11.988,11.988h212.175 c6.62,0,11.988-5.367,11.988-11.988C374.076,314.06,368.707,308.691,362.088,308.691z"/>\n                <path fill="${r}" d="M256,381.031H149.912c-6.62,0-11.988,5.368-11.988,11.988c0,6.621,5.368,11.988,11.988,11.988H256 c6.62,0,11.988-5.367,11.988-11.988C267.988,386.398,262.62,381.031,256,381.031z"/>\n            </svg>`
    );
  }),
  (OrgChart.icon.remove = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
      `<svg width="${t}" height="${e}" viewBox="0 0 900.5 900.5" x="${i}" y="${n}">\n                <path fill="${r}" d="M176.415,880.5c0,11.046,8.954,20,20,20h507.67c11.046,0,20-8.954,20-20V232.487h-547.67V880.5L176.415,880.5z M562.75,342.766h75v436.029h-75V342.766z M412.75,342.766h75v436.029h-75V342.766z M262.75,342.766h75v436.029h-75V342.766z"/>\n                <path fill="${r}" d="M618.825,91.911V20c0-11.046-8.954-20-20-20h-297.15c-11.046,0-20,8.954-20,20v71.911v12.5v12.5H141.874 c-11.046,0-20,8.954-20,20v50.576c0,11.045,8.954,20,20,20h34.541h547.67h34.541c11.046,0,20-8.955,20-20v-50.576 c0-11.046-8.954-20-20-20H618.825v-12.5V91.911z M543.825,112.799h-187.15v-8.389v-12.5V75h187.15v16.911v12.5V112.799z"/>\n            </svg>`
    );
  }),
  (OrgChart.icon.add = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
      `<svg width="${t}" height="${e}" viewBox="0 0 922 922" x="${i}" y="${n}">\n                <path fill="${r}" d="M922,453V81c0-11.046-8.954-20-20-20H410c-11.045,0-20,8.954-20,20v149h318c24.812,0,45,20.187,45,45v198h149 C913.046,473.001,922,464.046,922,453z" />\n                <path fill="${r}" d="M557,667.001h151c11.046,0,20-8.954,20-20v-174v-198c0-11.046-8.954-20-20-20H390H216c-11.045,0-20,8.954-20,20v149h194 h122c24.812,0,45,20.187,45,45v4V667.001z" />\n                <path fill="${r}" d="M0,469v372c0,11.046,8.955,20,20,20h492c11.046,0,20-8.954,20-20V692v-12.501V667V473v-4c0-11.046-8.954-20-20-20H390H196 h-12.5H171H20C8.955,449,0,457.955,0,469z" />\n            </svg>`
    );
  }),
  (OrgChart.icon.search = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
      `<svg width="${t}" height="${e}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 485.213 485.213" x="${i}" y="${n}">\n                <path fill="${r}" d="M471.882,407.567L360.567,296.243c-16.586,25.795-38.536,47.734-64.331,64.321l111.324,111.324 c17.772,17.768,46.587,17.768,64.321,0C489.654,454.149,489.654,425.334,471.882,407.567z" />\n                <path fill="${r}" d="M363.909,181.955C363.909,81.473,282.44,0,181.956,0C81.474,0,0.001,81.473,0.001,181.955s81.473,181.951,181.955,181.951 C282.44,363.906,363.909,282.437,363.909,181.955z M181.956,318.416c-75.252,0-136.465-61.208-136.465-136.46 c0-75.252,61.213-136.465,136.465-136.465c75.25,0,136.468,61.213,136.468,136.465 C318.424,257.208,257.206,318.416,181.956,318.416z" />\n                <path fill="${r}" d="M75.817,181.955h30.322c0-41.803,34.014-75.814,75.816-75.814V75.816C123.438,75.816,75.817,123.437,75.817,181.955z" />\n            </svg>`
    );
  }),
  (OrgChart.icon.xml_export = OrgChart.icon.xml =
    function (t, e, r, i, n) {
      return (
        null == i && (i = 0),
        null == n && (n = 0),
        `<svg width="${t}" height="${e}" viewBox="0 0 550.801 550.801" x="${i}" y="${n}">\n                <path fill="${r}"  d="M488.426,197.019H475.2v-63.816c0-0.401-0.063-0.799-0.116-1.205c-0.021-2.534-0.827-5.023-2.562-6.992L366.325,3.691 c-0.032-0.031-0.063-0.042-0.085-0.073c-0.633-0.707-1.371-1.298-2.151-1.804c-0.231-0.158-0.464-0.287-0.706-0.422 c-0.676-0.366-1.393-0.675-2.131-0.896c-0.2-0.053-0.38-0.135-0.58-0.19C359.87,0.119,359.037,0,358.193,0H97.2 c-11.918,0-21.6,9.693-21.6,21.601v175.413H62.377c-17.049,0-30.873,13.818-30.873,30.87v160.542 c0,17.044,13.824,30.876,30.873,30.876h13.224V529.2c0,11.907,9.682,21.601,21.6,21.601h356.4c11.907,0,21.6-9.693,21.6-21.601 V419.302h13.226c17.044,0,30.871-13.827,30.871-30.87V227.89C519.297,210.838,505.47,197.019,488.426,197.019z M97.2,21.605 h250.193v110.51c0,5.967,4.841,10.8,10.8,10.8h95.407v54.108H97.2V21.605z M369.531,374.53h-32.058l-2.156-55.519 c-0.644-17.434-1.298-38.518-1.298-59.611h-0.633c-4.514,18.516-10.547,39.166-16.137,56.162l-17.645,56.601h-25.618 l-15.494-56.157c-4.725-16.996-9.671-37.658-13.123-56.6h-0.43c-0.854,19.585-1.508,41.961-2.586,60.038l-2.576,55.086h-30.343 l9.26-145.035h43.677l14.207,48.421c4.517,16.774,9.041,34.847,12.258,51.843h0.654c4.081-16.77,9.038-35.923,13.774-52.064 l15.493-48.199h42.82L369.531,374.53z M69.992,374.53l41.955-73.385l-40.444-71.65h37.655l12.688,26.465 c4.316,8.828,7.533,15.928,10.99,24.092h0.422c3.438-9.242,6.23-15.694,9.893-24.092l12.274-26.465h37.434l-40.89,70.796 l43.044,74.239h-37.866l-13.134-26.257c-5.376-10.108-8.817-17.639-12.909-26.04h-0.433c-3.009,8.401-6.674,15.932-11.19,26.04 l-12.042,26.257H69.992z M453.601,523.353H97.2V419.302h356.4V523.353z M485.325,374.53h-90.608V229.495h32.933v117.497h57.682 v27.538H485.325z"/>\n            </svg>`
      );
    }),
  (OrgChart.icon.visio_export = OrgChart.icon.visio =
    function (t, e, r, i, n) {
      return (
        null == i && (i = 0),
        null == n && (n = 0),
  ...
  (OrgChart.icon.link = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
      `<svg width="${t}" height="${e}" viewBox="0 0 512.092 512.092" x="${i}" y="${n}">\n                <path fill="${r}" d="M312.453,199.601c-6.066-6.102-12.792-11.511-20.053-16.128c-19.232-12.315-41.59-18.859-64.427-18.859 c-31.697-0.059-62.106,12.535-84.48,34.987L34.949,308.23c-22.336,22.379-34.89,52.7-34.91,84.318 c-0.042,65.98,53.41,119.501,119.39,119.543c31.648,0.11,62.029-12.424,84.395-34.816l89.6-89.6 c1.628-1.614,2.537-3.816,2.524-6.108c-0.027-4.713-3.87-8.511-8.583-8.484h-3.413c-18.72,0.066-37.273-3.529-54.613-10.581 c-3.195-1.315-6.867-0.573-9.301,1.877l-64.427,64.512c-20.006,20.006-52.442,20.006-72.448,0 c-20.006-20.006-20.006-52.442,0-72.448l108.971-108.885c19.99-19.965,52.373-19.965,72.363,0 c13.472,12.679,34.486,12.679,47.957,0c5.796-5.801,9.31-13.495,9.899-21.675C322.976,216.108,319.371,206.535,312.453,199.601z" />\n                <path fill="${r}" d="M477.061,34.993c-46.657-46.657-122.303-46.657-168.96,0l-89.515,89.429c-2.458,2.47-3.167,6.185-1.792,9.387 c1.359,3.211,4.535,5.272,8.021,5.205h3.157c18.698-0.034,37.221,3.589,54.528,10.667c3.195,1.315,6.867,0.573,9.301-1.877 l64.256-64.171c20.006-20.006,52.442-20.006,72.448,0c20.006,20.006,20.006,52.442,0,72.448l-80.043,79.957l-0.683,0.768 l-27.989,27.819c-19.99,19.965-52.373,19.965-72.363,0c-13.472-12.679-34.486-12.679-47.957,0 c-5.833,5.845-9.35,13.606-9.899,21.845c-0.624,9.775,2.981,19.348,9.899,26.283c9.877,9.919,21.433,18.008,34.133,23.893 c1.792,0.853,3.584,1.536,5.376,2.304c1.792,0.768,3.669,1.365,5.461,2.048c1.792,0.683,3.669,1.28,5.461,1.792l5.035,1.365 c3.413,0.853,6.827,1.536,10.325,2.133c4.214,0.626,8.458,1.025,12.715,1.195h5.973h0.512l5.12-0.597 c1.877-0.085,3.84-0.512,6.059-0.512h2.901l5.888-0.853l2.731-0.512l4.949-1.024h0.939c20.961-5.265,40.101-16.118,55.381-31.403 l108.629-108.629C523.718,157.296,523.718,81.65,477.061,34.993z" />\n            </svg>`
    );
  }),
  (OrgChart.icon.happy = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
      `<svg width="${t}" height="${e}" viewBox="0 0 512 512" x="${i}" y="${n}">\n                <path fill="${r}" d="M256,0C114.615,0,0,114.615,0,256s114.615,256,256,256s256-114.615,256-256S397.385,0,256,0z M256,480 C132.288,480,32,379.712,32,256S132.288,32,256,32s224,100.288,224,224S379.712,480,256,480z"/>\n                <path fill="${r}" d="M176,176c17.673,0,32,14.327,32,32h32c0-35.346-28.654-64-64-64c-35.346,0-64,28.654-64,64h32 C144,190.327,158.327,176,176,176z"/>\n                <path fill="${r}" d="M336,144c-35.346,0-64,28.654-64,64h32c0-17.673,14.327-32,32-32c17.673,0,32,14.327,32,32h32 C400,172.654,371.346,144,336,144z"/>\n                <path fill="${r}" d="M256,368c-53.019,0-96-42.981-96-96h-32c0,70.692,57.308,128,128,128s128-57.308,128-128h-32 C352,325.019,309.019,368,256,368z"/>\n            </svg>`
    );
  }),
  (OrgChart.icon.sad = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
      `<svg width="${t}" height="${e}" viewBox="0 0 512 512" x="${i}" y="${n}">\n                <path fill="${r}" d="M256,0C114.615,0,0,114.615,0,256s114.615,256,256,256s256-114.615,256-256S397.385,0,256,0z M256,480 C132.288,480,32,379.712,32,256S132.288,32,256,32s224,100.288,224,224S379.712,480,256,480z"/>\n                <path fill="${r}" d="M336,192c-17.673,0-32-14.327-32-32h-32c0,35.346,28.654,64,64,64c35.346,0,64-28.654,64-64h-32 C368,177.673,353.673,192,336,192z"/>\n                <path fill="${r}" d="M176,224c35.346,0,64-28.654,64-64h-32c0,17.673-14.327,32-32,32s-32-14.327-32-32h-32C112,195.346,140.654,224,176,224z "/>\n                <path fill="${r}" d="M256,256c-70.692,0-128,57.308-128,128h32c0-53.019,42.981-96,96-96s96,42.981,96,96h32C384,313.308,326.692,256,256,256 z"/>\n            </svg>`
    );
  }),
  (OrgChart.icon.share = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
      `<svg width="${t}" height="${e}" x="${i}" y="${n}" viewBox="0 0 512 512">\n                <path fill="${r}" d="M406,332c-29.641,0-55.761,14.581-72.167,36.755L191.99,296.124c2.355-8.027,4.01-16.346,4.01-25.124\n                    c0-11.906-2.441-23.225-6.658-33.636l148.445-89.328C354.307,167.424,378.589,180,406,180c49.629,0,90-40.371,90-90\n                    c0-49.629-40.371-90-90-90c-49.629,0-90,40.371-90,90c0,11.437,2.355,22.286,6.262,32.358l-148.887,89.59\n                    C156.869,193.136,132.937,181,106,181c-49.629,0-90,40.371-90,90c0,49.629,40.371,90,90,90c30.13,0,56.691-15.009,73.035-37.806\n                    l141.376,72.395C317.807,403.995,316,412.75,316,422c0,49.629,40.371,90,90,90c49.629,0,90-40.371,90-90\n                    C496,372.371,455.629,332,406,332z"/>\n                </svg>`
    );
  }),
  (OrgChart.icon.user = function (t, e, r, i, n) {
    return (
      OrgChart.isNEU(i) && (i = 0),
      OrgChart.isNEU(n) && (n = 0),
      `<svg width="${t}" height="${e}" x="${i}" y="${n}" viewBox="0 0 24 24">\n                <path fill="${r}" d="M12 11.796C14.7189 11.796 16.9231 9.60308 16.9231 6.89801C16.9231 4.19294 14.7189 2.00005 12 2.00005C9.28106 2.00005 7.07692 4.19294 7.07692 6.89801C7.07692 9.60308 9.28106 11.796 12 11.796Z" fill="#030D45"/>\n                <path fill="${r}" d="M14.5641 13.8369H9.4359C6.46154 13.8369 4 16.2859 4 19.245C4 19.9593 4.30769 20.5716 4.92308 20.8777C5.84615 21.3879 7.89744 22.0001 12 22.0001C16.1026 22.0001 18.1538 21.3879 19.0769 20.8777C19.5897 20.5716 20 19.9593 20 19.245C20 16.1838 17.5385 13.8369 14.5641 13.8369Z" fill="#030D45"/>\n            </svg>`
    );
  }),
  (OrgChart.icon.close = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
  ...
  (OrgChart.icon.undo = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
  ...
  (OrgChart.icon.redo = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
  ...
  (OrgChart.icon.send = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
  ...
  (OrgChart.icon.x = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
  ...
  (OrgChart.icon.layout_left_offset = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
  ...
  (OrgChart.icon.layout_mixed = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
  ...
  (OrgChart.icon.layout_tree = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
  ...
  (OrgChart.icon.layout_grid = function (t, e, r, i, n) {
    return (
      null == i && (i = 0),
      null == n && (n = 0),
  ...
  (OrgChart.prototype.exportVisio = function (t, e) {
    console.warn("exportVisio is obsolete; use exportToVisio instead.");
  }),
  (OrgChart.exportPDFFromCharts = function (t, e, r, i) {
    console.warn(
      'The "exportPDFFromCharts" is depricated. Use "chart1.exportToPDF" with pages instead.'
    );
  }),
  ...
  (OrgChart.prototype.exportToCSV = OrgChart.prototype.exportCSV =
    function (t) {
      ...
      var n = { ext: "csv", filename: t, options: e, nodes: i };
      if (!1 === OrgChart.events.publish("exportstart", [this, n])) return !1;
      var a = OrgChart._json2csv(n.nodes),
        o = {
          ext: n.ext,
          filename: n.filename,
          options: e,
  ...
  (OrgChart.prototype.exportToXML = OrgChart.prototype.exportXML =
    function (t) {
      ...
      r
        ...
        ? OrgChart._exportIterateForJSON_XML_CSV(this, this.roots, e, i)
        : (i = JSON.parse(JSON.stringify(this.config.nodes)));
      var n = { ext: "xml", filename: t, options: e, nodes: i };
      if (!1 === OrgChart.events.publish("exportstart", [this, n])) return !1;
      var a = OrgChart._json2xml(n.nodes),
        o = {
          ext: n.ext,
          filename: n.filename,
          options: e,
  ...
  (OrgChart.prototype.exportToJSON = OrgChart.prototype.exportJSON =
    function (t) {
      ...
      r
        ...
        ? OrgChart._exportIterateForJSON_XML_CSV(this, this.roots, e, i)
        : (i = JSON.parse(JSON.stringify(this.config.nodes)));
      var n = { ext: "json", filename: e.filename, options: e, nodes: i };
      if (!1 === OrgChart.events.publish("exportstart", [this, n])) return !1;
      var a = {
        ext: n.ext,
        filename: n.filename,
        options: e,
        nodes: n.nodes,
        content: JSON.stringify(n.nodes),
      };
      if (!1 === OrgChart.events.publish("exportend", [this, a])) return !1;
      OrgChart._downloadFile(
        "application/json",
        a.content,
        a.options.filename,
  ...
  (OrgChart._exportIterateForJSON_XML_CSV = function (t, e, r, i) {
    if (Array.isArray(e))
      for (var n = 0; n < e.length; n++)
        OrgChart._exportIterateForJSON_XML_CSV(t, e[n], r, i);
    else {
      var a = t.get(e.id);
      if ((i.push(a), r.min))
        for (n = 0; n < e.stChildrenIds.length; n++)
          OrgChart._exportIterateForJSON_XML_CSV(
            t,
            t.getNode(e.stChildrenIds[n]),
            r,
            i
          );
      else
        for (n = 0; n < e.stChildren.length; n++)
          OrgChart._exportIterateForJSON_XML_CSV(t, e.stChildren[n], r, i);
      if (r.expandChildren)
        for (n = 0; n < e.childrenIds.length; n++)
          OrgChart._exportIterateForJSON_XML_CSV(
            t,
            t.getNode(e.childrenIds[n]),
            r,
            i
          );
      else
        for (n = 0; n < e.children.length; n++)
          OrgChart._exportIterateForJSON_XML_CSV(t, e.children[n], r, i);
    }
  }),
  ...
  (OrgChart.prototype.exportToPDFProfile = function (t, e) {
    chart.exportToPDF(
      { format: "A4", pages: [{ nodeId: t, isProfile: !0 }] },
      e
    );
  }),
  (OrgChart.prototype.exportToVisio = function (t, e) {
    var r = this;
    (t = OrgChart._setDefaultOptions(t, "vstx")),
      this._createExportPages("vstx", t, function (i) {
        for (var n = 0; n < t.pages.length; n++)
          OrgChart.loading.show(t.pages[n].chartInstance);
        r._requestToExportVisio(i, t, function (i) {
          var n = !0;
          if ((e && (n = e(i)), !1 !== n)) {
            if (!1 === (n = OrgChart.events.publish("exportend", [r, i])))
              return OrgChart._exportHideAnimation(t), !1;
            OrgChart._downloadFile(
          ...
          OrgChart._exportHideAnimation(t);
        });
      });
  }),
  (OrgChart.prototype.exportToPDF = function (t, e) {
    var r = this;
    (t = OrgChart._setDefaultOptions(t, "pdf")),
      this._createExportPages("pdf", t, function (i) {
        for (var n = 0; n < t.pages.length; n++)
          OrgChart.loading.show(t.pages[n].chartInstance);
  ...
  (OrgChart.prototype.exportToPNG = function (t, e) {
    var r = this;
    (t = OrgChart._setDefaultOptions(t, "png")),
      this._createExportPages("png", t, function (i) {
        for (var n = 0; n < t.pages.length; n++)
          OrgChart.loading.show(t.pages[n].chartInstance);
  ...
  (OrgChart.prototype.exportToSVG = function (t, e) {
    var r = this;
    (t = OrgChart._setDefaultOptions(t, "svg")),
      this._createExportPages("svg", t, function (i) {
        for (var n = 0; n < t.pages.length; n++)
          OrgChart.loading.show(t.pages[n].chartInstance);
  ...
  (OrgChart.prototype.exportToPowerPoint = function (t, e) {
    var r = this;
    (t = OrgChart._setDefaultOptions(t, "pptx")),
      this._createExportPages("pptx", t, function (i) {
        for (var n = 0; n < t.pages.length; n++)
          OrgChart.loading.show(t.pages[n].chartInstance);
  ...
  (OrgChart._exportHideAnimation = function (t) {
    for (var e = 0; e < t.pages.length; e++)
      OrgChart.loading.hide(t.pages[e].chartInstance);
  }),
  (OrgChart._setDefaultOptions = function (t, e, r) {
    return (
      t || (t = {}),
      (t.type = e),
      null == t.landscape &&
        ("pdf" == e ? (t.landscape = !1) : "pptx" == e && (t.landscape = !0)),
      null == t.header && (t.header = ""),
      null == t.expandChildren && (t.expandChildren = !1),
      null == t.childLevels && (t.childLevels = null),
      null == t.parentLevels && (t.parentLevels = null),
      null == t.min && (t.min = !0),
      null == t.format &&
        ("pdf" != e || r
          ? "pdf" == e && r
            ? (t.format = "A4")
            : "pptx" == e && (t.format = "Widescreen")
          : (t.format = "auto")),
      null == t.footer &&
        ("pdf" == e
          ? "auto" == t.format
            ? (t.footer = "")
            : (t.footer =
                '<text style="fill: #aeaeae" x="0" y="15">Page {current-page} of {total-pages}</text>')
          : "png" == e || "svg" == e
          ? (t.footer = "")
          : "pptx" == e
          ? (t.footer =
              '<text style="fill: #aeaeae" x="0" y="15">Slide {current-page} of {total-pages}</text>')
          : "vstx" == e && (t.footer = "")),
      null == t.fileName && (t.fileName = "OrgChart." + e),
      ...
      null == t.width &&
        ...
        ("pdf" == e && "auto" == t.format)
          ...
          : ((OrgChart.Screen = {
            ...
            t.landscape
              ? ((t.width = OrgChart[t.format].height),
                (t.height = OrgChart[t.format].width))
              : ((t.width = OrgChart[t.format].width),
                (t.height = OrgChart[t.format].height)))),
      null == t.margin && (t.margin = [30, 20, 30, 20]),
      null == t.padding && (t.padding = 0),
      t.pages || (t.pages = [{}]),
      t
    );
  }),
  (OrgChart.prototype._requestToExportPDF = function (t, e, r) {
    OrgChart.__requestExport(
      this.config.serverUrl + "/Export/PDF",
      e.fileName,
      t,
      r
    );
  }),
  (OrgChart.prototype._requestToExportPNG = function (t, e, r) {
    OrgChart.__requestExport(
      this.config.serverUrl + "/Export/PNG",
      e.fileName,
      t,
      r
    );
  }),
  (OrgChart.prototype._requestToExportVisio = function (t, e, r) {
    OrgChart.__requestExport(
      this.config.serverUrl + "/Export/VSTX",
      e.fileName,
      t,
      r
    );
  }),
  (OrgChart.prototype._requestToExportSVG = function (t, e, r) {
    OrgChart.__requestExport(
      this.config.serverUrl + "/Export/SVG",
      e.fileName,
      t,
      r
    );
  }),
  (OrgChart.prototype._requestToExportPowerPoint = function (t, e, r) {
    OrgChart.__requestExport(
      this.config.serverUrl + "/Export/PowerPoint",
      e.fileName,
      t,
      r
    );
  }),
  (OrgChart.__requestExport = function (t, e, r, i) {
    var n = { filename: e, pages: r };
    OrgChart._ajax(t, "POST", JSON.stringify(n), "arraybuffer", function (t) {
      i(t);
    });
  }),
  (OrgChart.prototype._createExportPages = function (t, e, r) {
    var i = [];
    if (e.pages.length)
      for (var n = 0; n < e.pages.length; n++)
        this.__createExportPages(t, n, i, e, r);
    else r(i);
  }),
  (OrgChart.prototype.__createExportPages = function (t, e, r, i, n) {
    var a = this,
      o = i.pages[e];
    if (
      (o.chartInstance || (o.chartInstance = this),
      void 0 === o.expandChildren && (o.expandChildren = i.expandChildren),
      void 0 === o.childLevels && (o.childLevels = i.childLevels),
      void 0 === o.parentLevels && (o.parentLevels = i.parentLevels),
      void 0 === o.min && (o.min = i.min),
      void 0 === o.header && (o.header = i.header),
      void 0 === o.footer && (o.footer = i.footer),
      null != o.childLevels && (o.expandChildren = !1),
      void 0 === o.padding && (o.padding = i.padding),
      void 0 === o.margin && (o.margin = i.margin),
      null != o.content || !0 === o.isProfile)
    ) {
      o.isProfile && (o.content = this._createProfileSvg(i, o));
      var s = a._createMasterSvg(t, o.content, e, i, null != o.content);
      if ((r.push(s), a.___createExportPages(t, e, r, i, n))) return;
    } else {
      var l = {
        id: o.nodeId,
        expandChildren: o.expandChildren,
        parentLevels: o.parentLevels,
        childLevels: o.childLevels,
        min: o.min,
      };
      i.pages[e].chartInstance._draw(
        !1,
        OrgChart.action.exporting,
        l,
        function (o, s) {
          var l = a._createMasterSvg(t, o, e, i, !1);
          r.push(l), a.___createExportPages(t, e, r, i, n);
        }
      );
    }
  }),
  (OrgChart.prototype._createMasterSvg = function (t, e, r, i, n) {
    var a = !1;
    "" == e &&
      ((a = !0),
      (e =
        '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  style="display:block;" width="100" height="100" viewBox="0,0,0,0"><svg>'));
    var o = i.pages[r],
      s = document.createElementNS("http://www.w3.org/2000/svg", "svg");
    s.setAttribute("xmlns", "http://www.w3.org/2000/svg"),
      s.setAttribute("xmlns:xlink", "http://www.w3.org/1999/xlink"),
      document.body.appendChild(s);
    var l = OrgChart._getSvgAttributes(e);
    a
      ? "auto" == i.width
        ? (o.width = 1e3)
        : (o.width = i.width)
      : "auto" == i.width
      ? (o.width = l.width + o.margin[3] + o.margin[1])
      : (o.width = i.width);
    var h = document.createElementNS("http://www.w3.org/2000/svg", "g");
    (h.innerHTML = `${o.header
      .replaceAll("{current-page}", r + 1)
      .replaceAll("{total-pages}", i.pages.length)}`),
      s.appendChild(h),
      OrgChart._setYAttrToTextElements(o, i, h);
    var c = h.getBoundingClientRect();
    c.height && (c.height += 10),
      h.setAttribute(
        "transform",
        `matrix(1,0,0,1,${o.margin[3]},${o.margin[0]})`
      );
    var d = document.createElementNS("http://www.w3.org/2000/svg", "g");
    (d.innerHTML = `${o.footer
      .replaceAll("{current-page}", r + 1)
      .replaceAll("{total-pages}", i.pages.length)}`),
      s.appendChild(d),
      OrgChart._setYAttrToTextElements(o, i, d);
    var g,
    ...
    if (
      (a
        ...
        : "auto" == i.height
        ? (o.height =
            l.height + o.margin[0] + o.margin[2] + c.height + p.height)
        : (o.height = i.height),
      d.setAttribute(
        "transform",
        `matrix(1,0,0,1,${o.margin[3]},${o.height - o.margin[2] - p.height})`
      ),
      s.classList.add("boc-" + this.config.mode),
      document.body.removeChild(s),
      !o.isProfile)
    ) {
      var u = (o.width - o.margin[3] - o.margin[1]) / l.width,
        f =
          (o.height - o.margin[0] - o.margin[2] - c.height - p.height) /
          l.height,
        m = Math.min(u, f, 1);
      (l.width *= m),
        (l.height *= m),
        (l.viewBox[0] -= o.padding),
        (l.viewBox[1] -= o.padding),
        (l.viewBox[2] += 2 * o.padding),
        (l.viewBox[3] += 2 * o.padding),
    ...
    g = n
      ? OrgChart._isSVG(e)
        ? e
        : `<foreignObject x="0" y="0" width="100%" height="100%">${e}</foreignObject>`
      : OrgChart._setSvgAttributes(e, l);
    var C = o.width,
      b = o.height;
    return (
      "pdf" != t || o.isProfile || ((C += 2), (b += 2)),
      s.setAttribute("width", C),
      s.setAttribute("height", b),
      (s.innerHTML = g + s.innerHTML),
      s
    );
  }),
  (OrgChart.prototype._createProfileSvg = function (t, e) {
    var r = this.editUI.content(e.nodeId, !0, !0, "100%", !0).element;
    return (
      OrgChart.input.init(r),
      `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="display:block;" width="${t.width}" height="${t.height}" viewBox="0,0,${t.width},${t.height}">        \n        <style>\n            form.boc-edit-form, div.boc-edit-form-header {\n                border-radius: 0;\n            }\n            \n        </style>\n        <foreignobject class="node" x="0" y="0" width="${t.width}" height="${t.height}">${r.outerHTML}</foreignobject>\n    </svg>`
    );
  }),
  (OrgChart.prototype.___createExportPages = function (t, e, r, i, n) {
    if (e >= i.pages.length - 1) {
      var a = { pages: r, options: i, styles: "" };
      if (!1 === OrgChart.events.publish("exportstart", [this, a])) return !1;
      var o = this.mainElement.querySelector("[data-boc-styles]");
      if ((o && (a.styles += o.outerHTML), a.styles))
        for (var s = 0; s < a.pages.length; s++) {
          var l = a.pages[s];
          l.insertAdjacentHTML("afterbegin", a.styles),
            (a.pages[s] = l.outerHTML);
        }
      return (
        OrgChart.CONVERT_IMAGES_TO_BASE64_BEFORE_EXPORT
          ? OrgChart._convertImagesToBase64(a.pages).then(function (t) {
              (a.pages = t), n(a.pages);
            })
          : n(a.pages),
        !0
  ...
  (OrgChart._setYAttrToTextElements = function (t, e, r) {
    for (var i = r.querySelectorAll("text"), n = 0; n < i.length; n++) {
      var a = i[n];
      if (!a.hasAttribute("y")) {
      ...
      if (a.hasAttribute("text-anchor") && !a.hasAttribute("x")) {
        var s = a.getAttribute("text-anchor").toLowerCase(),
          l = t.width - t.margin[1] - t.margin[3];
        "end" == s
          ? a.setAttribute("x", l)
          : "middle" == s && a.setAttribute("x", l / 2);
      }
    }
  }),
  (OrgChart.exportUI = function (t) {
    (this.instance = null),
      (this.interval = null),
      (this.element = null),
      (this.options = null),
      ...
      (this.type = t),
      (this.locExport = "Export"),
      (this.locLandscape = "Landscape"),
      (this.locPortrait = "Portrait"),
      (this.locCancel = "Close"),
      (this.locParentLevels = "parent levels"),
      (this.locChildLevels = "child levels"),
      (this.locClickToAdd = "Click on a node to display it here"),
      (this.locPrintTree = "Print tree"),
      (this.locPrintProfile = "Print profile"),
      "pdf" == t
        ? ((this.locAddNew = "Add new page"), (this.locRemove = "Remove page"))
        : "png" == t
        ? ((this.locAddNew = "Add new PNG"), (this.locRemove = "Remove PNG"))
        : "svg" == t
        ? ((this.locAddNew = "Add new SVG"), (this.locRemove = "Remove SVG"))
        : "pptx" == t &&
          ((this.locAddNew = "Add new slide"),
          (this.locRemove = "Remove slide")),
      (this.buttons = {
        parentLevels: !1,
        childLevels: !0,
      ...
      Object.defineProperty(this, "selectedPage", {
        get() {
          var t = this.instance.leftElement.querySelector(
            ".boc-export-selected"
          );
          if (t) {
            var e = t.getAttribute("data-boc-export-page");
            return (e = parseInt(e)), this.options.pages[e];
          }
          return null;
        },
      });
  }),
  (OrgChart.exportUI.prototype.init = function (t) {
    this.instance = t;
  }),
  (OrgChart.exportUI.prototype.show = function (t) {
    (this.selectedIndex = 0),
      this.instance.pdfPreviewUI.hide(),
      this.instance.svgPreviewUI.hide(),
      this.instance.pngPreviewUI.hide(),
      this.instance.powerPointPreviewUI.hide(),
      this.instance.aiUI.hide(),
      this.instance.orgScribeUI.hide(),
      (this.options = OrgChart._setDefaultOptions(t, this.type, !0));
    var e = this;
  ...
  (OrgChart.exportUI.prototype.hide = function () {
    (this.instance.leftElement.style.display = "none"),
      this.element &&
  ...
  (OrgChart.exportUI.prototype._init = function (t) {
    var e = this;
    (this.element = document.createElement("div")),
      this.element.setAttribute("data-boc-export-form", ""),
      (this.element.style.opacity = 0),
      this.element.classList.add("boc-export-form"),
      this.element.classList.add(this.instance.config.mode),
      (this.element.style.display = "");
    var r = "";
    "pdf" == this.type &&
      "auto" != this.options.format &&
      (r = `<button ${
        this.buttons.landscapePortrait ? "" : 'style="display: none;"'
      } data-boc-export-landcapeportrait>${
        this.options.landscape ? this.locPortrait : this.locLandscape
      }</button> `),
      (this.element.innerHTML = `<div class="boc-export-container">                                \n                                <div class="boc-export-btns">       \n                                \n                                    <div class="boc-export-btns-inner">   \n                                        <div class="boc-export-left">                               \n                                            <button data-boc-export-cancel>${
        this.locCancel
      }</button>   \n                                            ${r}                                                                    \n                                            <button ${
        this.buttons.addNewPage ? "" : 'style="display: none;"'
      } data-boc-export-btnnewpage>${
        this.locAddNew
      }</button>     \n                                        </div>                                    \n                                        <div class="boc-export-right">             \n                                            <button class="boc-export-btn" data-boc-export-export>${
        this.locExport
      ...
      this.instance.leftElement
        .querySelector("[data-boc-export-btnnewpage]")
        .addEventListener("click", function (t) {
          e.addPage({ content: "" });
        });
    var i = this.instance.leftElement.querySelector(
      "[data-boc-export-landcapeportrait]"
    );
    i &&
      ...
      this.instance.leftElement
        .querySelector("[data-boc-export-pages]")
        .addEventListener("click", function (t) {
          for (
            var r, i = t.target;
            i && i.hasAttribute && !i.hasAttribute("data-boc-export-page");

          )
            i = i.parentNode;
          i &&
            i.hasAttribute &&
            i.hasAttribute("data-boc-export-page") &&
            (r = i.getAttribute("data-boc-export-page")),
            t.target.hasAttribute &&
              (t.target.hasAttribute("data-export-remove")
                ? e.removePage(r)
                : t.target.hasAttribute("data-export-child-plus")
                ? e._incrementDecrementChildLevel(r, !0)
                : t.target.hasAttribute("data-export-child-minus")
                ? e._incrementDecrementChildLevel(r, !1)
                : t.target.hasAttribute("data-export-parent-plus")
                ? e._incrementDecrementParentLevel(r, !0)
                : t.target.hasAttribute("data-export-parent-minus")
                ? e._incrementDecrementParentLevel(r, !1)
                : t.target.hasAttribute("data-export-profiletree")
                ? e.toggelePrintTreeOrProfile(r, !1)
                : e.selectPage(r));
        });
    var n = this.instance.leftElement.querySelector("[data-boc-export-cancel]");
    n &&
      n.addEventListener("click", function (t) {
        e.hide();
      });
    var a = this.instance.leftElement.querySelector("[data-boc-export-export]");
    a &&
      a.addEventListener("click", function (t) {
        e.instance.powerPointPreviewUI.isVisible()
          ? e.instance.exportToPowerPoint(e.options)
          : e.instance.pdfPreviewUI.isVisible()
          ? e.instance.exportToPDF(e.options)
          : e.instance.pngPreviewUI.isVisible()
          ? e.instance.exportToPNG(e.options)
          : e.instance.svgPreviewUI.isVisible() &&
            e.instance.exportToSVG(e.options);
      }),
  ...
  (OrgChart.exportUI.prototype._draw = function (t) {
    var e = this.instance.leftElement.querySelector("[data-boc-export-pages]");
    e.innerHTML = "";
    for (var r = 0; r < t.length; r++) {
      var i = t[r],
        n = this.options.pages[r].width / this.options.pages[r].height,
        a = OrgChart._getSvgAttributes(i);
      (a.viewBox[0] = 0),
        (a.viewBox[1] = 0),
        (a.viewBox[2] = a.width),
        (a.viewBox[3] = a.height),
        (a.width = "100%"),
        (a.height = "100%");
      var o = OrgChart._setSvgAttributes(i, a),
        s = OrgChart._getSvgAttributes;
      "" == this.options.pages[r].content && (s = " boc-export-empty");
      var l = `<div ${
        this.buttons.removePage ? "" : 'style="display: none;"'
      } class="boc-export-remove-buttons">                    \n                        <button data-export-remove="${r}">${
        this.locRemove
      }</button>                    \n                    </div>`;
      "pdf" == this.type &&
        "auto" != this.options.format &&
        !OrgChart.isNEU(this.options.pages[r].nodeId) &&
        (!this.options.pages[r].content ||
          (this.options.pages[r].isProfile && this.options.pages[r].content)) &&
        (l += `<div ${
          this.buttons.printProfileOrTree ? "" : 'style="display: none;"'
        } class="boc-export-profiletree-buttons">                    \n                        <button data-export-profiletree="${r}">${
          this.options.pages[r].isProfile
            ? this.locPrintTree
            : this.locPrintProfile
        }</button>                    \n                    </div>`),
        this.options.pages[r].isProfile ||
          OrgChart.isNEU(this.options.pages[r].nodeId) ||
          (l =
            `<div ${
              this.buttons.parentLevels ? "" : 'style="display: none;"'
            } class="boc-export-parent-buttons">                    \n                                                <button data-export-parent-minus="${r}">-</button> \n                                                <button data-export-parent-plus="${r}">+</button> ${
              null == this.options.pages[r].parentLevels
                ? "all"
                : this.options.pages[r].parentLevels
            } ${
              this.locParentLevels
            }\n                                            </div>                                                    \n                                            <div ${
              this.buttons.childLevels ? "" : 'style="display: none;"'
            } class="boc-export-child-buttons">                    \n                                                <button data-export-child-minus="${r}">-</button>                                                                                              \n                                                <button data-export-child-plus="${r}">+</button> ${
              null == this.options.pages[r].childLevels
                ? "all"
                : this.options.pages[r].childLevels
            } ${
              this.locChildLevels
            }\n                                            </div>` + l),
        (e.innerHTML += `<div data-boc-export-page="${r}" style="aspect-ratio: ${n};" class="boc-export-page ${s}">\n                                            ${o}\n                                            ${l}                                                                                                                     \n                                        </div>`);
    }
    this.selectPage(this.selectedIndex);
  }),
  (OrgChart.exportUI.prototype.toggleLanscape = function () {
    var t = this;
    (this.options.landscape = !this.options.landscape),
      (this.options.width = void 0),
      (this.options.height = void 0),
      (this.options = OrgChart._setDefaultOptions(this.options, this.type, !0)),
      (this.instance.leftElement.querySelector(
        "[data-boc-export-landcapeportrait]"
      ).innerHTML = this.options.landscape
        ? this.locPortrait
        : this.locLandscape),
      this.instance._createExportPages(this.type, this.options, function (e) {
  ...
  (OrgChart.exportUI.prototype.addPage = function (t) {
    var e = this;
    this.options.pages.push(t),
      this.instance._createExportPages(this.type, this.options, function (t) {
        e._draw(t), e.selectPage(e.options.pages.length - 1);
        var r = e.element.querySelector(".boc-export-middle");
        OrgChart.animate(
          r,
  ...
  (OrgChart.exportUI.prototype.removePage = function (t) {
    t = parseInt(t);
    var e = this;
    t <= e.selectedIndex &&
      (e.selectedIndex--, e.selectedIndex < 0 && (e.selectedIndex = 0)),
      this.options.pages.splice(t, 1),
      this.instance._createExportPages(this.type, this.options, function (t) {
        e._draw(t), e.selectPage(e.selectedIndex);
      });
  }),
  (OrgChart.exportUI.prototype._incrementDecrementChildLevel = function (t, e) {
    var r = this;
    t < r.selectedIndex && r.selectedIndex--;
    var i = this.options.pages[t];
    null == i.childLevels && (i.childLevels = e ? 0 : 2),
      e ? i.childLevels++ : i.childLevels--,
      -1 == i.childLevels && (i.childLevels = 0),
      (i.expandChildren = !1),
      this.instance._createExportPages(this.type, this.options, function (t) {
        r._draw(t), r.selectPage(r.selectedIndex);
      });
  }),
  (OrgChart.exportUI.prototype.toggelePrintTreeOrProfile = function (t) {
    var e = this,
      r = this.options.pages[t];
    (r.isProfile = !r.isProfile),
      (this.options.pages[t].content = void 0),
      this.instance._createExportPages(this.type, this.options, function (t) {
        e._draw(t), e.selectPage(e.selectedIndex);
      });
  }),
  (OrgChart.exportUI.prototype._incrementDecrementParentLevel = function (
    t,
    e
  ) {
    var r = this;
    ...
    null == i.parentLevels
      ...
      ? i.parentLevels++
      : i.parentLevels--,
      -1 == i.parentLevels && (i.parentLevels = 0),
      this.instance._createExportPages(this.type, this.options, function (t) {
        r._draw(t), r.selectPage(r.selectedIndex);
      });
  }),
  (OrgChart.exportUI.prototype.selectPage = function (t) {
    for (
      var e = this.instance.leftElement.querySelectorAll(
          "[data-boc-export-page]"
        ),
        r = 0;
      r < e.length;
      r++
    )
      e[r].classList.remove("boc-export-selected");
    for (
      e = this.instance.leftElement.querySelectorAll(".boc-export-select"),
        r = 0;
      r < e.length;
      r++
    )
      e[r].parentNode.removeChild(e[r]);
    var i = this.instance.leftElement.querySelectorAll(
      "[data-boc-export-pages] .boc-export-page"
    );
    if (i.length) {
      var n = i[t];
      n.classList.contains("boc-export-empty") &&
        (n.innerHTML += `<div class="boc-export-select">${this.locClickToAdd}</div>`),
        n.classList.add("boc-export-selected"),
  ...
  (OrgChart.events = (function () {
    ...
    return {
      ...
      publish: function (e, r) {
        if (t[e]) {
          for (var i = [], n = 0; n < t[e].length; n++) {
            var a = t[e][n];
            (null != a.event_id && a.event_id != r[0]._event_id) ||
              i.push(a.listener);
          }
          if (i.length > 0) {
            var o = !0;
            for (
              ...
              (1 == r.length
                ...
                ? (o = i[n](r[0], r[1], r[2]) && o)
                : 4 == r.length
                ? (o = i[n](r[0], r[1], r[2], r[3]) && o)
                : 5 == r.length &&
                  (o = i[n](r[0], r[1], r[2], r[3], r[4]) && o),
              !1 !== o);
              n++
            );
            return o;
      ...
      (e.onchange = function (e) {
        ...
        (i.onload = function () {
          var e = i.result,
            ...
            n = [],
            a = r[0];
          OrgChart._importSetColumnNames(a, function (e) {
            for (var i = 1; i < r.length; i++) {
              for (var a = {}, o = 0; o < r[i].length; o++) {
                var s = e[o],
                  l = r[i][o];
                a[s] = OrgChart._convertStringToArray(s, l);
              }
              "" != a.id.trim() && n.push(a);
            }
            var h = { nodes: n, columnNames: r[0] };
  ...
  (OrgChart._importSetColumnNames = function (t, e) {
    if (-1 == t.indexOf("id") || -1 == t.indexOf("pid")) {
      ...
      n.setAttribute("id", "boc-sampleDialog"),
        (n.style.height = "260px"),
        (n.style.width = "400px"),
        (n.style.background = "white"),
        (n.style.border = "0.5px solid grey"),
        ...
        (a.style.height = "20px"),
        (a.style.padding = "3px 0 0 7px"),
        s.setAttribute("id", "close"),
        (s.style.cursor = "pointer"),
        (s.style.position = "absolute"),
        (s.style.color = "rgb(122, 122, 122)"),
        (s.style.fontWeight = "bold"),
        (s.style.top = "2px"),
        (s.style.zIndex = 100),
        o.setAttribute("id", "content"),
        (o.style.padding = "2px"),
        (a.innerHTML = "Import Organizational Chart Data"),
        (s.innerHTML = "&times;");
      var l = document.createElement("HR");
      (l.style.height = "0.1px"),
        (l.style.backgroundColor = "#aeaeae"),
        (l.style.border = "none"),
        (l.style.margin = "0"),
        n.appendChild(a),
        n.appendChild(l),
        ...
        OrgChart._importCenter(n),
        (s.style.left = n.offsetWidth - 20 + "px");
      ...
      for (var u = 0; u < t.length; u++) {
        (x = document.createElement("option")).setAttribute("value", t[u]);
        var f = document.createTextNode(t[u]);
        x.appendChild(f), g.appendChild(x);
      }
      ...
      for (u = 0; u < t.length; u++) {
        ...
        x.appendChild(f), b.appendChild(x);
      }
      ...
      (v.innerHTML = "Import"),
        ...
        (v.onclick = function () {
          (n.style.display = "none"),
            n._overlay && n._overlay.parentNode.removeChild(n._overlay);
      ...
      return (
        ...
        (a.onmousedown = function (t) {
          (t = t || window.event),
            (n._dragging = !0),
            (n._originalLeft = n.offsetLeft),
            (n._originalTop = n.offsetTop),
            (n._mouseLeft = t.clientX),
            (n._mouseTop = t.clientY);
        }),
        (document.onmousemove = function (t) {
          (t = t || window.event),
            n._dragging &&
              ((n.style.left =
                n._originalLeft + t.clientX - n._mouseLeft + "px"),
              (n.style.top = n._originalTop + t.clientY - n._mouseTop + "px"));
        }),
  ...
  (OrgChart.prototype.expandCollapse = function (t, e, r, i) {
    this._treeListExpandCollapseHandler(t),
      this._resetMovableNodes(),
      Array.isArray(e) || (e = []),
      Array.isArray(r) || (r = []);
    var n = { id: t, expandIds: e, collapseIds: r, ids: e.concat(r) };
    this._draw(!1, OrgChart.action.collapse, n, i);
  }),
  ...
  (OrgChart.prototype._resetMovableNodes = function () {
    if (
      ...
      t && (this._ai.setContext(), OrgChart.events.publish("updated", [this]));
    }
  }),
  (OrgChart.prototype.maximize = function (t, e, r, i) {
    var n = this,
      a = { id: t, options: {} };
    OrgChart.isNEU(a.id) && ((a.id = this.roots[0].id), (a.all = !0)),
      (a.options.horizontal = !1),
      (a.options.vertical = !1),
      e && (a.options.horizontal = e),
      r && (a.options.vertical = r),
      this._draw(!1, OrgChart.action.maximize, a, function () {
        n.ripple(t), i && i();
      });
  }),
  ...
  (OrgChart.prototype._upHandlerCreateArgs = function (t) {
    var e,
      ...
      n = this.getNode(r.pid);
    if ((n && (e = n), e)) {
      if (Array.isArray(i)) {
        var a = i.indexOf(r.id);
        -1 != a && i.splice(a, 1);
      } else i = [];
      i.push(e.id);
    }
  ...
  (OrgChart.prototype._clickHandler = function (t, e) {
    if (!(e.button > 0)) {
      for (var r = e.target; r != t; ) {
        if (r.hasAttribute(OrgChart.attr.control_expcoll_id)) {
          var i = r.getAttribute(OrgChart.attr.control_expcoll_id),
            n = this.getNode(i);
          return void this._expCollHandler(n.id);
        }
        if (r.hasAttribute(OrgChart.attr.node_id)) {
          (i = r.getAttribute(OrgChart.attr.node_id)), (n = this.getNode(i));
          return void this._nodeClickHandler(n.id, e);
        }
        if (r.hasAttribute(OrgChart.attr.control_node_menu_id)) {
          e.stopPropagation(), e.preventDefault();
          (i = r.getAttribute(OrgChart.attr.control_node_menu_id)),
            (n = this.getNode(i));
          return void this._nodeMenuClickHandler(n.id, r, e);
        }
        if (r.hasAttribute(OrgChart.attr.control_node_circle_menu_id)) {
          e.stopPropagation(), e.preventDefault();
          i = r.getAttribute(OrgChart.attr.control_node_circle_menu_id);
          return void this._nodeCircleMenuClickHandler(i);
        }
        if (r.hasAttribute(OrgChart.attr.control_node_circle_menu_name))
          return (
            e.stopPropagation(), void this._nodeCircleMenuItemClickHandler(r, e)
          );
        if (r.hasAttribute(OrgChart.attr.control_add))
          return void this._lonelyButtonHandler();
        if (r.hasAttribute(OrgChart.attr.control_up_id)) {
          i = r.getAttribute(OrgChart.attr.control_up_id);
          return (
            e.stopPropagation(), e.preventDefault(), void this._upHandler(i)
          );
        }
        if (r.hasAttribute(OrgChart.attr.c_link_from))
          return void OrgChart.events.publish("clink-click", [
            this,
            {
              from: r.getAttribute(OrgChart.attr.c_link_from),
              to: r.getAttribute(OrgChart.attr.c_link_to),
              event: e,
            },
          ]);
        if (r.hasAttribute(OrgChart.attr.s_link_from))
          return void OrgChart.events.publish("slink-click", [
            this,
            {
              from: r.getAttribute(OrgChart.attr.s_link_from),
              to: r.getAttribute(OrgChart.attr.s_link_to),
              event: e,
            },
          ]);
        if (r.hasAttribute("data-ctrl-n-dotted-close")) {
          i = r.getAttribute("data-ctrl-n-dotted-close");
          return void this.minimize(i);
        }
        if (r.hasAttribute("data-ctrl-n-dotted-open")) {
          i = r.getAttribute("data-ctrl-n-dotted-open");
          return void this.maximize(i);
        }
        r = r.parentNode;
      }
      OrgChart.events.publish("canvas-click", [this, { event: e }]);
    }
  }),
  (OrgChart.prototype._mouseDownHandler = function (t, e, r, i) {
    var n = this;
    ...
    var a = this.getViewBox(),
      o = this.getScale(),
      s = OrgChart._getClientTouchesXY(e, 0),
    ...
    e.touches &&
      ...
      ((h.type = "pinch"),
      (h.dist = Math.sqrt(
        (s.x - l.x) * (s.x - l.x) + (s.y - l.y) * (s.y - l.y)
      )));
    var c = null;
    if (i) {
      var d = i.stChildren[0].lcn ? i.stChildren[0].lcn : "base";
      (c = n.manager.layoutConfigs[d]), (h.scrollTop = i.treeList.scrollTop);
    }
    var g = 0,
      p = function (t) {
        ...
        if (h && "pan" == h.type) {
          clearTimeout(n._timeout),
            (h.diffX = e.x - h.x0),
            (h.diffY = e.y - h.y0),
            (g = Math.max(Math.abs(h.diffY), Math.abs(h.diffX)));
          var r = -h.diffY / o + h.viewBoxTop,
            s = -h.diffX / o + h.viewBoxLeft;
          g > 3 &&
            (i
              ? ((i.treeList.scrollTop = h.scrollTop - h.diffY / o),
                n._treeListUpdateInterval &&
                  (clearInterval(n._treeListUpdateInterval),
                  (n._treeListUpdateInterval = null)),
                n._treeListUpdate(i, c))
              : (n._hideBeforeAnimation(),
                n._changeCursorOnPanStart(a, o, t),
                n._move(r, s, a)));
        } else if (h && "pinch" == h.type) {
          var l = OrgChart._getClientTouchesXY(t, 1),
            d = Math.sqrt(
              (e.x - l.x) * (e.x - l.x) + (e.y - l.y) * (e.y - l.y)
            ),
            p = 1 + (d - h.dist) / (h.dist / 100) / 100;
          h.dist = d;
          var u = OrgChart._pinchMiddlePointInPercent(
            n.element,
            n.width(),
            n.height(),
            t
      ...
      u = function (e) {
        if (
          ...
          n._clickHandler(t, e);
        else if ("pan" == h.type && i) {
          var a = Date.now() - h.time,
            o = Math.abs(g / a);
          if (o > 0.5) {
            var s =
                (d = i.treeList.scrollTop) + 400 * o * (h.diffY > 0 ? -1 : 1),
              l = i.stChildren[0].h;
            (s = Math.round(s / l) * l) != d &&
              (n._treeListUpdateInterval &&
                (clearInterval(n._treeListUpdateInterval),
                (n._treeListUpdateInterval = null)),
              (n._treeListUpdateInterval = OrgChart.animate(
                null,
                {},
                {},
                1500,
                ...
                function () {},
                function (t) {
                  (i.treeList.scrollTop = t * (s - d) + d),
                    n._treeListUpdate(i, c.orientation);
                }
              )));
          } else {
            var d = i.treeList.scrollTop;
            l = i.stChildren[0].h;
            (s = Math.round(i.treeList.scrollTop / l) * l) != d &&
              (n._treeListUpdateInterval &&
                (clearInterval(n._treeListUpdateInterval),
                (n._treeListUpdateInterval = null)),
              (n._treeListUpdateInterval = OrgChart.animate(
          ...
          "pan" == h.type && !i && g > 10 && n._draw(!0, OrgChart.action.pan);
        "pan" != h.type || i || n._changeCursorOnPanEnd(),
          (h = null),
    ...
    t.addEventListener(r.move, p, { passive: !0 }),
      t.addEventListener(r.up, u),
      r.leave && t.addEventListener(r.leave, u),
      r.touchstart && t.addEventListener(r.touchstart, u, { passive: !0 });
  }),
  (OrgChart.prototype._changeCursorOnPanStart = function (t, e, r) {
    var i = this.getPointerElement();
    if (i) {
      var n = OrgChart._getOffsetXY(this.element, r),
        a = n.x / e + t[0] - 16 / e,
        o = n.y / e + t[1] - 16 / e;
      (i.style.display = "inherit"),
        i.setAttribute("transform", "matrix(0,0,0,0," + a + "," + o + ")"),
        OrgChart.animate(
          i,
          { transform: [0, 0, 0, 0, a, o], opacity: 0 },
          { transform: [1 / e, 0, 0, 1 / e, a, o], opacity: 1 },
          300,
          OrgChart.anim.outBack
        );
  ...
  (OrgChart.prototype._changeCursorOnPanEnd = function () {
    var t = this.getPointerElement();
    t ? (t.style.display = "none") : (this.element.style.cursor = "initial");
  }),
  (OrgChart.prototype._globalMouseDownHandler = function (t, e) {
    ...
    -1 != e.type.indexOf("touch") &&
      ...
      this._treeListUpdateInterval &&
        (clearInterval(this._treeListUpdateInterval),
        (this._treeListUpdateInterval = null));
    for (
      var i = null, n = e.target;
      n != t &&
      !n.hasAttribute(OrgChart.attr.control_node_menu_id) &&
      !n.hasAttribute(OrgChart.attr.control_node_circle_menu_id);

    ) {
      if (n.hasAttribute) {
        var a = null;
        n.hasAttribute(OrgChart.attr.node_id)
          ? (a = this.getNode(n.getAttribute(OrgChart.attr.node_id)))
          : n.hasAttribute(OrgChart.attr.control_expcoll_id)
          ? (a = this.getNode(n.getAttribute(OrgChart.attr.control_expcoll_id)))
          : (n.hasAttribute(OrgChart.attr.control_node_menu_id) ||
              n.hasAttribute(OrgChart.attr.control_node_menu_id)) &&
            (a = this.getNode(
              n.getAttribute(OrgChart.attr.control_node_menu_id)
            )),
          i || (i = OrgChart._getScrollableTreeListNodeInTouchEnabledDevice(a));
      }
      if (
        n.hasAttribute(OrgChart.attr.node_id) &&
        !i &&
        (this.config.enableDragDrop || this.config.movable)
      ) {
        if (null == e.touches || e.touches.length <= 1)
          return void this._nodeMouseDownHandler(n, e, r);
      } else if (n.hasAttribute(OrgChart.attr.control_node_circle_menu_name)) {
        if ((e.stopPropagation(), null == e.touches || e.touches.length <= 1))
          return void this._nodeCircleNodeMenuItemMouseDownHandler(t, n, e, r);
      } else if (
        n.hasAttribute("data-treelist-thumb") &&
        (e.stopPropagation(), null == e.touches || e.touches.length <= 1)
      )
        return void this._treeListThumbMouseDownHandler(n, e, r);
      n = n.parentNode;
    }
    e.stopPropagation(), this._mouseDownHandler(t, e, r, i);
  }),
    ...
    for (var r = e.target; r != t; ) {
      if (r.hasAttribute(OrgChart.attr.node_id)) {
        var i = r.getAttribute(OrgChart.attr.node_id),
          n = this.getNode(i);
        return void this._nodeContextHandler(n.id, e);
      }
      r = r.parentNode;
    }
  }),
  (OrgChart.prototype._nodeContextHandler = function (t, e) {
    ...
    var o = this.element.getBoundingClientRect(),
      s = e.clientX - o.left,
      l = e.clientY - o.top;
    this.nodeContextMenuUI.show(s, l, t, null, i);
  }),
  (OrgChart.prototype._globalDbClickHandler = function (t, e) {
    for (var r = e.target; r != t; ) {
      if (r.hasAttribute(OrgChart.attr.node_id)) {
        var i = r.getAttribute(OrgChart.attr.node_id),
          n = this.getNode(i);
        return void this._nodeDbClickHandler(n.id, e);
      }
      r = r.parentNode;
    }
  }),
  (OrgChart.prototype._mouseScrollHandler = function (t, e) {
    for (
      var r = !1, i = e.target, n = null;
      i &&
      i.hasAttribute &&
      !i.hasAttribute("data-n-id") &&
      !i.hasAttribute("data-ctrl-ec-id");

    )
      i = i.parentNode;
    if (i.hasAttribute && i.hasAttribute("data-n-id")) {
      var a = i.getAttribute("data-n-id");
      (n = this.getNode(a)).isTreeListItem && (r = !0);
    }
    if (i.hasAttribute && i.hasAttribute("data-ctrl-ec-id")) {
      a = i.getAttribute("data-ctrl-ec-id");
      (n = this.getNode(a)).isTreeListItem && (r = !0);
    }
    e.ctrlKey && (r = !1),
      r
        ? this.__mouseScrollHandlerTreeList(n, e)
  ...
  (OrgChart.prototype.__mouseScrollHandler = function (t, e) {
    ...
    if (
      (e.preventDefault(),
      !navigator.hardwareConcurrency || navigator.hardwareConcurrency < 9)
    ) {
      let i = e.deltaY / 1e3;
      i = Math.abs(i) < 0.1 ? (0.1 * e.deltaY) / Math.abs(e.deltaY) : i;
      var r = OrgChart._centerPointInPercent(t, e.clientX, e.clientY);
      this.zoom(1 - i, r);
    } else {
      var i = this,
        n = !1,
        ...
        s = 0,
        l = this.getScale();
      r = OrgChart._centerPointInPercent(t, e.clientX, e.clientY);
      var h =
  ...
  (OrgChart.prototype._nodeCircleNodeMenuItemMouseDownHandler = function (
    ...
    var n = e.parentNode.getAttribute(
        OrgChart.attr.control_node_circle_menu_wrraper_id
      ),
    ...
    if (o.draggable) {
      ...
      var m = OrgChart._getTransform(f),
        C = m[4],
        b = m[5],
        x = (function (t) {
          for (
      ...
      var v = function (t, e) {
          if (null != t) {
            ...
            for (
              var r = OrgChart.getStParentNodes(s.getNode(d)), i = 0;
              i < r.length;
              i++
            ) {
              var n = s.getNodeElement(r[i].id);
              n && (n.style.opacity = 1);
            }
          }
        },
        O = function (t) {
          if (u) {
            var r = OrgChart._getClientXY(t),
              i = t.target;
            OrgChart.isMobile() && (i = document.elementFromPoint(r.x, r.y)),
              (r.x += x.x * c),
              (r.y += x.y * c);
            var n = OrgChart._getOffsetXY(s.element, t),
              l = {
                left: s.width() - (n.x + s.config.padding) < 0,
                right: n.x - s.config.padding < 0,
                up: s.height() - (n.y + s.config.padding) < 0,
                down: n.y - s.config.padding < 0,
              };
            if (l.left || l.right || l.up || l.down) {
              p.classList &&
                (p.classList.remove("boc-cursor-grab"),
                p.classList.add("boc-cursor-move"),
                p.classList.remove("boc-cursor-nodrop"),
                p.classList.remove("boc-cursor-copy"));
              var h = m[4],
                O = m[5],
                _ = u.x,
                w = u.y,
                k = r.x,
                I = r.y;
              s.moveStart(l, function (t) {
                (m[4] = h + t.x),
                  (m[5] = O + t.y),
                  (u.x = _ - t.xWithoutScale),
                  (u.y = w - t.yWithoutScale),
                  (r.x = k - t.xWithoutScale),
                  (r.y = I - t.yWithoutScale),
                  f.setAttribute("transform", "matrix(" + m.toString() + ")");
              });
            } else {
              for (
                s.moveEnd(),
                  p.classList &&
                    (p.classList.add("boc-cursor-grab"),
                    p.classList.remove("boc-cursor-move"),
                    p.classList.remove("boc-cursor-nodrop"),
                    p.classList.remove("boc-cursor-copy")),
                  v(d, g),
                  d = null,
                ...
                if (i.hasAttribute && i.hasAttribute(OrgChart.attr.node_id)) {
                  var S = i.getAttribute(OrgChart.attr.node_id);
                  (d = S), (g = i);
                  break;
                }
                i = i.parentNode;
              ...
              if (null != d) {
                g.classList.add("boc-drag-over");
                for (
                  var L = s.getNode(d), E = OrgChart.getStParentNodes(L), A = 0;
                  A < E.length;
                  A++
                ) {
                  var N = s.getNodeElement(E[A].id);
                  N && (N.style.opacity = 0.1);
                }
                p.classList.remove("boc-cursor-grab"),
                  p.classList.remove("boc-cursor-move"),
                  p.classList.add("boc-cursor-copy"),
                  p.classList.remove("boc-cursor-nodrop");
              }
              var $ = (r.x - u.x) / c,
                M = (r.y - u.y) / c;
              if (
                ...
                (m[5] = b + M),
                !e._dragEventFired &&
                  (Math.abs(r.x - u.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE ||
                    Math.abs(r.y - u.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE))
              )
                (s._gragStartedId = e.parentNode.getAttribute(
                  OrgChart.attr.control_node_circle_menu_wrraper_id
                )),
                  !1 ===
                    OrgChart.events.publish("drag", [
                      s.nodeCircleMenuUI,
                      { from: S, menuItem: o, menuItemName: a },
                    ]) && y(),
                  (e._dragEventFired = !0);
              f.setAttribute("transform", "matrix(" + m.toString() + ")");
            }
        ...
        y = function (t) {
          if (
            ...
            p.classList &&
              ...
              p.classList.remove("boc-cursor-nodrop"),
              p.classList.remove("boc-cursor-copy")),
            p.removeEventListener(i.move, O),
            p.removeEventListener(i.up, y),
            i.leave && p.removeEventListener(i.leave, y),
            h.id == d || null == d)
          )
            return (
              p.removeChild(f),
              ...
              void (
                ...
                OrgChart.events.publish("drop", [
                  s.nodeCircleMenuUI,
                  { from: h.id, menuItemName: a, menuItem: o, event: t },
                ])
              )
            );
          var r = s.getNode(d);
          OrgChart.events.publish("drop", [
            s.nodeCircleMenuUI,
            { from: h.id, to: r.id, menuItem: o, menuItemName: a, event: t },
          ]),
            v(d, g),
            p.removeChild(f),
            (s._gragStartedId = null);
        };
      p.addEventListener(i.move, O),
        p.addEventListener(i.up, y),
        i.leave && p.addEventListener(i.leave, y);
    } else this._clickHandler(t, r);
  }),
  (OrgChart.prototype._nodeMouseDownHandler = function (t, e, r) {
    var i = t.getAttribute(OrgChart.attr.node_id),
      n = this.getNode(i);
    this.config.movable && !OrgChart.getRootOf(n).stParent
  ...
  (OrgChart.prototype._resizeHandler = function (t, e) {
    if (this.isVisible && 0 != t && 0 != e) {
      var r = this.getViewBox();
      if (r) {
        var i = t / (r = r.slice(0))[2],
          n = e / r[3];
        Math.abs(this._lastSize.width - t) > Math.abs(this._lastSize.height - e)
          ? (r[3] = e / i)
          : (r[2] = t / n),
          this.nodeMenuUI.hide(),
          this.nodeContextMenuUI.hide(),
          ...
          this.nodeCircleMenuUI.hide(),
          this.setViewBox(r),
          this.xScrollUI.create(t),
          this.yScrollUI.create(e),
          this._draw(!0, OrgChart.action.resize);
      }
    }
  }),
  ...
  (OrgChart.prototype._nodeClickHandler = function (t, e) {
    if (
      ...
      return !1;
    if (
      this.powerPointPreviewUI.isVisible() &&
      null != this.powerPointPreviewUI.selectedPage
    )
      return (
        (this.powerPointPreviewUI.selectedPage.content = void 0),
        (this.powerPointPreviewUI.selectedPage.nodeId = t),
        this.powerPointPreviewUI.refresh(t),
        void this.ripple(t, e.clientX, e.clientY)
      );
    if (this.pdfPreviewUI.isVisible() && null != this.pdfPreviewUI.selectedPage)
      return (
        (this.pdfPreviewUI.selectedPage.content = void 0),
        (this.pdfPreviewUI.selectedPage.nodeId = t),
        this.pdfPreviewUI.refresh(t),
        void this.ripple(t, e.clientX, e.clientY)
      );
    if (this.svgPreviewUI.isVisible() && null != this.svgPreviewUI.selectedPage)
      return (
        (this.svgPreviewUI.selectedPage.content = void 0),
        (this.svgPreviewUI.selectedPage.nodeId = t),
        this.svgPreviewUI.refresh(t),
        void this.ripple(t, e.clientX, e.clientY)
      );
    if (this.pngPreviewUI.isVisible() && null != this.pngPreviewUI.selectedPage)
      return (
        (this.pngPreviewUI.selectedPage.content = void 0),
        (this.pngPreviewUI.selectedPage.nodeId = t),
        this.pngPreviewUI.refresh(t),
        void this.ripple(t, e.clientX, e.clientY)
      );
  ...
  (OrgChart.prototype._nodeCircleMenuItemClickHandler = function (t, e) {
    var r = t.parentNode.getAttribute(
      ...
      n = this.nodeCircleMenuUI._menu[i];
    OrgChart.events.publish("click", [
      this.nodeCircleMenuUI,
      { nodeId: r, menuItemName: i, menuItem: n, event: e },
    ]);
  }),
  (OrgChart.prototype._nodeCircleMenuClickHandler = function (t) {
    if (
      ...
      this.nodeMenuUI.hide(),
      this.menuUI.hide(),
      this.nodeContextMenuUI.isVisible())
    )
      this.nodeContextMenuUI.hide();
    else {
      var e = this.getNode(t),
      ...
      if (Array.isArray(e.tags))
        for (var i = 0; i < e.tags.length; i++) {
          var n = e.tags[i];
          this.config.tags[n] &&
            this.config.tags[n].nodeCircleMenu &&
            (r = this.config.tags[n].nodeCircleMenu);
        }
    ...
    if (Array.isArray(i.tags))
      for (var a = 0; a < i.tags.length; a++) {
        ...
        this.config.tags[o] &&
          ...
          (n = this.config.tags[o].nodeMenu);
      }
    this.nodeMenuUI.showStickIn(e, t, null, n);
  }),
  ...
  (OrgChart.prototype._dragDropHandler = function (t, e, r) {
    var i = OrgChart._getClientXY(e),
      n = t.getAttribute(OrgChart.attr.node_id),
      a = this.getNode(n);
    t._dragEventFired = !1;
    var o = null,
      s = null;
    ...
    var m = function (t, e) {
        if (null != t) {
          e.classList.remove("boc-drag-over");
          for (
            var r = l.getNode(o), i = OrgChart.getStParentNodes(r), n = 0;
            n < i.length;
            n++
          ) {
            var a = l.getNodeElement(i[n].id);
            a && (a.style.opacity = 1);
          }
        }
      },
      C = function (e) {
        if (null != e.touches && e.touches.length > 1) b(e);
        else if (c) {
          var r = OrgChart._getClientXY(e),
            i = e.target;
          OrgChart.isMobile() && (i = document.elementFromPoint(r.x, r.y));
          var n = OrgChart._getOffsetXY(l.element, e),
            C = {
              left: l.width() - (n.x + l.config.padding) < 0,
              right: n.x - l.config.padding < 0,
              up: l.height() - (n.y + l.config.padding) < 0,
              down: n.y - l.config.padding < 0,
            };
          if (C.left || C.right || C.up || C.down) {
            ...
            var x = d[4],
              ...
              _ = r.x,
              w = r.y;
            l.moveStart(C, function (t) {
              (d[4] = x + t.x),
                (d[5] = v + t.y),
                (c.x = O - t.xWithoutScale),
            ...
            if (
              ...
              (o = null),
              (s = null),
              l.config.enableDragDrop)
            )
              for (; null != i && i != h; ) {
                if (i.hasAttribute && i.hasAttribute(OrgChart.attr.node_id)) {
                  var k = i.getAttribute(OrgChart.attr.node_id);
                  if (l._gragStartedId && k != l._gragStartedId) {
                    (o = k), (s = i);
                    break;
                  }
                }
            ...
            if (("draging" == o && ((o = null), (s = null)), null != o)) {
              s.classList.add("boc-drag-over");
              for (
                var I = l.getNode(o), S = OrgChart.getStParentNodes(I), L = 0;
                L < S.length;
                L++
              ) {
                var E = l.getNodeElement(S[L].id);
                E && (E.style.opacity = 0.1);
              }
              !l.canUpdateLink(a.id, o) && h.classList
                ? (h.classList.remove("boc-cursor-grab"),
                  h.classList.remove("boc-cursor-move"),
                  h.classList.remove("boc-cursor-copy"),
            ...
            if (
              ...
              (l._gragStartedId = k),
                !1 === OrgChart.events.publish("drag", [l, k, e]) && b(),
                (t._dragEventFired = !0);
            f.setAttribute("transform", "matrix(" + d.toString() + ")");
          }
        }
      ...
      b = function (e) {
        if (
          ...
          return (
            t._dragEventFired &&
              OrgChart.events.publish("drop", [l, a.id, void 0, f, e]),
            h.removeChild(f),
            void (l._gragStartedId = null)
          );
        var i = l.getNode(o);
        if (!1 === OrgChart.events.publish("drop", [l, a.id, i.id, f, e]))
          return m(o, s), h.removeChild(f), void (l._gragStartedId = null);
        if (l.canUpdateLink(a.id, o)) {
          var n = l.get(a.id);
          (n.pid = o),
            (n.stpid = null),
            null != n.movex && (n.movex = void 0),
            null != n.movey && (n.movey = void 0),
            l.updateNode(n, null, !0);
        } else h.removeChild(f), m(o, s);
  ...
  (OrgChart.prototype._movableHandler = function (t, e, r) {
      ...
      s = function (t, e) {
        if (Array.isArray(t)) for (var r = 0; r < t.length; r++) o(t[r], e);
          ...
          for (r = 0; r < t.stChildrenIds.length; r++)
            s(i.getNode(t.stChildrenIds[r]), e);
          for (r = 0; r < t.childrenIds.length; r++)
            s(i.getNode(t.childrenIds[r]), e);
        }
      },
      l = this.getNode(n);
    o(l, a);
    for (
      ...
      var v = this.getNode(a[x]);
      d.push(v), p.push({ x: v.x, y: v.y });
      var O = this.getNodeElement(a[x]);
      if (O) {
        f.push(O);
        var y = OrgChart._getTransform(O);
        u.push({ x: y[4], y: y[5] }), g.push(y);
        var _ = this.element.querySelector(`[data-ctrl-ec-id="${a[x]}"]`);
        if (_) {
          m.push(_);
    ...
    var S = { x: c.x, y: c.y },
      ...
      E = function (t, e) {
        if (null != t) {
          e.classList.remove("boc-drag-over");
          for (
            var r = i.getNode(k), n = OrgChart.getStParentNodes(r), a = 0;
            a < n.length;
            a++
          ) {
            var o = i.getNodeElement(n[a].id);
            o && (o.style.opacity = 1);
          }
        }
      },
      A = function (e) {
        if (null != e.touches && e.touches.length > 1) N(e);
        else if (S) {
          var r = OrgChart._getClientXY(e),
            o = e.target;
          OrgChart.isMobile() && (o = document.elementFromPoint(r.x, r.y));
          var s = OrgChart._getOffsetXY(i.element, e),
            c = {
              left: i.width() - (s.x + i.config.padding) < 0,
              right: s.x - i.config.padding < 0,
              up: i.height() - (s.y + i.config.padding) < 0,
              down: s.y - i.config.padding < 0,
            };
          if (c.left || c.right || c.up || c.down) {
            h.classList &&
              (h.classList.remove("boc-cursor-grab"),
              ...
              h.classList.remove("boc-cursor-nodrop"),
              h.classList.remove("boc-cursor-copy"));
            for (var x = [], v = [], O = [], y = [], _ = 0; _ < g.length; _++)
              x.push(g[_][4]),
                v.push(g[_][5]),
                C[_]
                  ? (O.push(C[_][4]), y.push(C[_][5]))
                  : (O.push(null), y.push(null));
            var w = S.x,
              A = S.y,
              $ = r.x,
              M = r.y;
            i.moveStart(c, function (t) {
              for (var e = 0; e < g.length; e++) {
                ...
                (g[e][4] = n + t.x),
                  ...
                  (d[e].movex = t.x),
                  (d[e].movey = t.y),
                  C[e] && ((C[e][4] = o + t.x), (C[e][5] = s + t.y));
                for (
                  var l = OrgChart.ui.link(
                      d[e],
                      i,
                      L,
            ...
            if (
              ...
              for (; null != o && o != h; ) {
                if (o.hasAttribute && o.hasAttribute(OrgChart.attr.node_id)) {
                  var T = o.getAttribute(OrgChart.attr.node_id);
            ...
            if (null != k) {
              I.classList.add("boc-drag-over");
              for (
                var P = i.getNode(k), U = OrgChart.getStParentNodes(P), R = 0;
                R < U.length;
                R++
              ) {
                var B = i.getNodeElement(U[R].id);
                B && (B.style.opacity = 0.1);
              }
              !i.canUpdateLink(d[0].id, k) && h.classList
                ? (h.classList.remove("boc-cursor-grab"),
                  h.classList.remove("boc-cursor-move"),
                  h.classList.remove("boc-cursor-copy"),
                  h.classList.add("boc-cursor-nodrop"))
            ...
            for (_ = 0; _ < g.length; _++) {
              (g[_][4] = u[_].x + F),
                (g[_][5] = u[_].y + H),
                C[_] && ((C[_][4] = b[_].x + F), (C[_][5] = b[_].y + H)),
                (d[_].x = p[_].x + F),
                (d[_].y = p[_].y + H);
            ...
            if (
              ...
              if (
                ((i._gragStartedId = a[0]),
                !1 === OrgChart.events.publish("drag", [i, n, e, a]) && N(),
                i.config.enableDragDrop)
              )
      ...
      N = function (n) {
        !t._dragEventFired &&
          (null == n.touches || n.touches.length <= 1) &&
          i._clickHandler(i.getSvg(), e);
        for (var a = 0; a < d.length; a++) (d[a].x = p[a].x), (d[a].y = p[a].y);
        if (
          (i.moveEnd(),
          h.classList &&
            (h.classList.remove("boc-cursor-grab"),
            ...
            h.classList.remove("boc-cursor-nodrop"),
            h.classList.remove("boc-cursor-copy")),
          h.removeEventListener(r.move, A),
          ...
          if (
            !1 ===
            (c = OrgChart.events.publish("drop", [i, d[0].id, o.id, f[0], n]))
          )
            return E(k, I), void (i._gragStartedId = null);
          if (i.canUpdateLink(d[0].id, k))
            ((b = i.get(d[0].id)).pid = k),
              (b.stpid = null),
              i.updateNode(b, null, !0);
          else E(k, I);
          i._gragStartedId = null;
        } else {
          if (t._dragEventFired) {
            var c = OrgChart.events.publish("drop", [
              i,
              d[0].id,
              void 0,
              f[0],
            ...
            if (i.config.movable && !1 !== c)
              if (i.config.movable == OrgChart.movable.detachTree) {
                var g = OrgChart._getTransform(i.getNodeElement(l.id));
                ((b = i.get(l.id)).pid = null),
                  (b.stpid = null),
                  i.updateNode(b, null, !0);
              } else {
                var u = [];
                i.config.movable == OrgChart.movable.node
                  ...
                  : s(l, u);
                var m =
                    (g = OrgChart._getTransform(i.getNodeElement(l.id)))[4] -
                    l.x,
                  C = g[5] - l.y;
                for (a = 0; a < u.length; a++) {
                  var b;
                  (b = i.get(u[a])) &&
                    (null != b.movex ? (b.movex += m) : (b.movex = m),
                    null != b.movey ? (b.movey += C) : (b.movey = C),
                    i.update(b));
                }
                i._ai.setContext(),
                  OrgChart.events.publish("updated", [i]),
                  i.draw(OrgChart.action.update, { dragNodeIdList: u });
              }
          }
          i._gragStartedId = null;
        }
      };
    h.addEventListener(r.move, A),
      ...
      if (!this._moveInterval) {
        ...
        OrgChart.isNEU(r) && (r = OrgChart.anim.inSin),
          ...
          (this._moveInterval = setInterval(function () {
            ...
            t.left
              ? (s++,
                (c.x = (s * OrgChart.MOVE_STEP) / o),
                (c.xWithoutScale = s * OrgChart.MOVE_STEP))
              : t.right &&
                (s++,
                (c.x = (-s * OrgChart.MOVE_STEP) / o),
                (c.xWithoutScale = -s * OrgChart.MOVE_STEP)),
              t.up
                ? (l++,
                  (c.y = (l * OrgChart.MOVE_STEP) / o),
                  (c.yWithoutScale = l * OrgChart.MOVE_STEP))
                : t.down &&
                  (l++,
                  (c.y = (-l * OrgChart.MOVE_STEP) / o),
                  (c.yWithoutScale = -l * OrgChart.MOVE_STEP));
            ...
            (c.x = c.x * d),
              ...
              n.setViewBox([a[0] + c.x, a[1] + c.y, a[2], a[3]]),
              e && e(c),
              (h += 1);
          }, 10));
      }
  ...
  (OrgChart.node = function (t, e, r, i) {
    (this.templateName = i),
      ...
      (this.tags = r),
      (this.childCount = 0),
      (this.collapsedChildCount = 0),
      (this.deepCollapsedChildCount = 0),
  ...
  (OrgChart.searchUI.prototype.init = function (t) {
    ...
    var e = this,
      ...
      n = this.instance.getMenuButton();
    if (n) {
      var a = n.getBoundingClientRect(),
        o = this.instance.getSvg().getBoundingClientRect();
      (r = o.right - a.left + 10), (i = a.top - o.top - 10);
    }
    var s = document.createElement("div");
    s.classList.add("boc-search"),
      (s.style.right = r + "px"),
      (s.style.top = i + "px");
    var l = OrgChart.elements.textbox(
      {},
      { label: OrgChart.SEARCH_PLACEHOLDER, btn: "X" },
      "320px"
    );
    (s.innerHTML += l.html),
      (this.xBtn = s.querySelector("[data-input-btn]")),
      (this.xBtn.style.display = "none"),
      (this.searchTableWrapper = document.createElement("div")),
      s.appendChild(this.searchTableWrapper);
    var h = this.instance.getSvg().nextSibling;
    this.instance.element.insertBefore(s, h),
      OrgChart.input.init(s),
      (this.input = document.getElementById(l.id)),
    ...
    if (t) {
      if (t.hasAttribute("data-search-item-id")) {
        ...
        if (this.input.value != OrgChart.SEARCH_HELP_SYMBOL)
          0 != OrgChart.events.publish("searchclick", [this, { nodeId: e }]) &&
            (this.instance.center(e), OrgChart.isMobile() && this.hide());
        else
          (this.input.value = e + " "),
      ...
      for (t = 0; t < this._searchFields.length; t++) {
        for (
          var r = this._searchFields[t],
            i = 0,
            n = r.slice(0, i + 1).toLowerCase();
          this.searchFieldsAbbreviation[n];

        )
          i++, (n = r.slice(0, i + 1).toLowerCase());
        this.searchFieldsAbbreviation[n] = r;
      }
    } else
      this.searchFieldsAbbreviation =
    ...
    if (
      ...
      t = `<table border="0" cellspacing="0" cellpadding="0">\n                        <tbody>\n                            ${(function () {
        for (
          ...
          var n = e.lastSearch[i],
            a = "";
          if (r) {
            var o = e.instance._get(n.id);
            "function" == typeof r
              ? (a = r(e.instance, e.instance.getNode(n.id), o))
              : o[r] && (a = o[r]);
          }
          var s = "",
            l = "";
          e.instance.config.searchDisplayField == n.__searchField
            ? (s = n.__searchMarks)
            : e.instance.config.searchDisplayField
            ? ((s = n[e.instance.config.searchDisplayField]),
              OrgChart.isNEU(s) && (s = ""),
              (l = n.__searchMarks))
            : (s = n.__searchMarks);
          var h = {
            ...
            second: l,
            searchItem: n,
            html: OrgChart.searchUI.createItem(a, n.id, s, l),
          };
        ...
        if (this.hasAttribute("data-search-item-id")) {
          ...
          if (e.input.value != OrgChart.SEARCH_HELP_SYMBOL) {
            ...
            if ((!1 === r && (i = !1), !1 !== i)) {
              ...
              var n = e.instance.element.querySelector('[data-selected="yes"]');
              n && n.removeAttribute("data-selected"),
                this.setAttribute("data-selected", "yes"),
                e.input.focus(),
                OrgChart.isMobile() && e.hide();
            }
          } else
            (e.input.value = t + " "),
  ...
  (OrgChart.searchUI.prototype.hide = function () {
    ...
    this._searchAfterEnterPress &&
      ...
      this.input &&
        (OrgChart.isMobile() || (this.input.value = ""),
  ...
  (OrgChart.manager.prototype.read = function (t, e, r, i, n, a, o, s) {
    var l = this;
    OrgChart.state._get(this.config.state, e, r, function (h) {
      (l.state = h),
        (l.action = n),
        (l.actionParams = a),
        n != OrgChart.action.init ||
        !l.state ||
        (a && a.method && "fit" == a.method)
          ? ((l.viewBox = i), (l.vbIsInitializedFromState = !1))
          : ((l.viewBox = l.state.vb),
            (l.vbIsInitializedFromState = !0),
            Array.isArray(l.state.roots) && (l.config.roots = l.state.roots));
      var c = l.maxX,
        d = l.maxY,
        g = l.minX,
        p = l.minY,
        u = l.bordersByRootIdAndLevel,
        f = l.roots,
        m = l.nodes;
      console.log('t-6709',t);
      if (t) {
        var C = OrgChart.manager._getResponse(
          ...
          m,
          l.oldNodes,
          l.vbIsInitializedFromState
        );
        n != OrgChart.action.exporting &&
          ((l.maxX = c),
          (l.maxY = d),
          (l.minX = g),
          (l.minY = p),
          (l.roots = f),
          (l.nodes = m),
          (l.visibleNodeIds = C.visibleNodeIds)),
          (C.bordersByRootIdAndLevel = u),
          (C.roots = f),
          (C.adjustify = { x: 0, y: 0 }),
          l.state && (C.adjustify = l.state.adjustify),
          o(C);
          console.log('fsdfsdfsf')
      } else
        (l.oldNodes = m || null),
          l._read(function (t) {
            (c = t.maxX),
            ...
            console.log('t.limit',i.notif,t.limit);
            (i.notif = t.limit),
              (i.roots = f),
              ...
              n != OrgChart.action.exporting &&
                ...
                (l.roots = f),
                (l.nodes = m),
                (l.visibleNodeIds = i.visibleNodeIds),
                (l.bordersByRootIdAndLevel = u),
                (l.rootList = t.rootList)),
              o(i);
          }, s);
    });
  }),
    ...
    null == o && (o = OrgChart.local),
      o._setPositions(
        ...
        function (e) {
          ...
          for (
            var s = { minX: null, minY: null, maxX: null, maxY: null },
              l = {},
              h = [],
              c = 0;
            c < a.length;
          ...
          for (c = 0; c < a.length; c++)
            OrgChart.manager._setChildCountPropsIterate(a[c], n);
          for (var d in h)
            for (var g in h[d]) {
              var p = l[d][g],
                u = h[d][g];
  ...
  (OrgChart.manager._setCollpasedProperty = function (t, e, r, i, n, a, o, s) {
    if (
      (null == t.collapsed && e.collapse && e.collapse.allChildren
        ? (t.collapsed = !0)
        : null == t.collapsed && (t.collapsed = !1),
      n == OrgChart.action.expand &&
        -1 != r.ids.indexOf(t.id) &&
        (t.collapsed = !1),
      n == OrgChart.action.collapse && (r.expandIds || r.collapseIds)
        ? r.expandIds && -1 != r.expandIds.indexOf(t.id)
          ? (t.collapsed = !1)
          : r.collapseIds &&
            -1 != r.collapseIds.indexOf(t.id) &&
            (t.collapsed = !0)
        : n == OrgChart.action.collapse &&
          -1 != r.ids.indexOf(t.id) &&
          (t.collapsed = !0),
      n == OrgChart.action.expand && "all" == r.ids && (t.collapsed = !1),
      n != OrgChart.action.exporting ||
        (OrgChart.isNEU(r.parentLevels) && OrgChart.isNEU(r.childLevels)) ||
        null == r.id)
    )
      n == OrgChart.action.exporting && r.expandChildren && (t.collapsed = !1);
    else if (
      !(
        null == r.id ||
        (OrgChart.isNEU(r.parentLevels) && OrgChart.isNEU(r.childLevels))
      ...
      if (l == t) t.collapsed = !1;
        ...
        (null != r.parentLevels && h && c <= r.parentLevels) ||
        (null != r.childLevels && d && g <= r.childLevels) ||
        (d && r.expandChildren)
          ? (t.collapsed = !1)
          : (t.collapsed = !0);
      }
    }
    n == OrgChart.action.init && null != o
      ...
      ? -1 != t.tags.indexOf("left-partner") ||
        ...
        t.parentPartner
        ? (t.collapsed =
            e.collapse && a >= e.collapse.level && -1 == i.indexOf(t.id))
        : (t.collapsed =
            e.collapse && a >= e.collapse.level - 1 && -1 == i.indexOf(t.id))
      : n == OrgChart.action.centerNode ||
        n == OrgChart.action.insert ||
        n == OrgChart.action.expand ||
        n == OrgChart.action.collapse
      ? i.has(t.id) && (t.collapsed = !1)
      : n == OrgChart.action.update &&
        r &&
        r.changeRoots &&
        r.changeRoots.has(t.id) &&
        (t.collapsed = !1);
  }),
  (OrgChart.manager._initNode = function (t, e, r, i, n, a, o) {
    var s = o.manager.config,
      l = o.manager.layoutConfigs,
      h = o.manager.action,
      c = o.manager.actionParams,
      d = o.manager.state,
      g = l[r || "base"];
    null == t.parent &&
      OrgChart.manager._setCollpasedProperty(t, g, c, n, h, i - 1, d, e);
    for (var p = 0; p < t.childrenIds.length; p++) {
      var u = e[t.childrenIds[p]];
      if (
        (OrgChart.manager._setCollpasedProperty(u, g, c, n, h, i, d, e),
        u.collapsed)
      )
        t.collapsedChildCount++;
      else {
    ...
    if (
      ...
      !(t.min || (t.tags && t.tags.has("filter"))))
    )
      for (p = 0; p < t.stChildrenIds.length; p++) {
        ((u = e[t.stChildrenIds[p]]).stParent = t), t.stChildren.push(u);
      }
    null != i && (t.level = i), r && (t.lcn = r);
    var m = OrgChart._getSubLevels(t.tags, s.tags);
    m > 0 && (t.subLevels = m),
      -1 != t.tags.indexOf("assistant") &&
        null != t.parent &&
        (t.isAssistant = !0),
      g.layout == OrgChart.layout.treeList && (t.isTreeListItem = !0),
      g.template &&
        s.template == t.templateName &&
        (t.templateName = g.template);
    ...
    if (
      ...
      t.isTreeListItem && t.stParent && null == t.stParent.treeList)
    ) {
      var b = OrgChart.t(t.stParent.templateName, t.stParent.min);
      t.stParent.treeList = {
        pinnedIds: [],
        scrollTop: 0,
        scrollTopMax: 0,
    ...
    var x = { node: t };
    OrgChart.events.publish("node-initialized", [o, x]);
  }),
  (OrgChart.manager._iterate = function (t, e, r, i, n, a, o, s, l, h, c, d) {
    var g = d.manager.layoutConfigs;
    if (
      (OrgChart.manager._initNode(e, r, l, i, h, c, d),
      e.isAssistant && (a[e.pid] || (a[e.pid] = []), a[e.pid].push(e.id)),
    ...
    for (b = 0; b < e.children.length; b++)
      e.isTreeListItem && (e.children[b].isTreeListItem = e.isTreeListItem),
        OrgChart.manager._iterate(
          t,
          e.children[b],
          r,
  ...
  (OrgChart.manager.__createNodes = function (t, e, r, i, n, a, o, s) {
    for (
      var l = [], h = OrgChart._addDottedLines(r), c = 0;
      c < h.length;
      c++
    ) {
      var d,
      ...
      (d = OrgChart.STRING_TAGS
        ...
        ? g.tags.slice(0)
        : []),
        s.filterUI.addFilterTag(g) && d.unshift("filter");
      var p = s.searchUI.addMatchTag(g.id);
    ...
    if (null != r.orderBy) {
      var m = OrgChart.manager._getOrderSortArray(r.orderBy);
      l.sort(function (t, e) {
        var r, i;
        for (var n of h)
          if ((n.id == t && (r = n), n.id == e && (i = n), r && i)) break;
        for (var a = 0; a < m.length; a++) {
          ...
          if (
            ...
            var d = l.localeCompare(c);
            if ((m[a].desc && (d *= -1), 0 !== d)) return d;
          } else {
            d = o < s ? -1 : o > s ? 1 : 0;
            if ((m[a].desc && (d *= -1), 0 !== d)) return d;
          }
    ...
    for (c = 0; c < l.length; c++) {
      var C = l[c],
        ...
        x = t[f.stpid],
        v = t[f.pid];
      if ((x || (f.stpid = null), v || (f.pid = null), x)) {
        var O = a ? a[x.id] : null;
        O && (x.min = O.min), x.stChildrenIds.push(f.id);
      } else
        v
          ? (b &&
              ((f.collapsed = b.collapsed),
              (f.min = b.min),
              (f.treeList = b.treeList)),
            v.childrenIds.push(f.id))
          : (b &&
              ((f.collapsed = b.collapsed),
              (f.min = b.min),
              (f.treeList = b.treeList)),
  ...
  (OrgChart.manager._createNodes = function (t) {
    var e = t.manager.config,
      ...
      i = t.manager.action,
      n = t.manager.actionParams,
      a = t.manager.oldNodes,
      o = t.manager.state,
      s = {},
      l = [],
      h = [];
    if (
      (OrgChart.manager.__createNodes(s, l, e, i, n, a, h, t), null != e.roots)
    ) {
      l = [];
      for (var c = 0; c < e.roots.length; c++) {
        ...
        if (d && i == OrgChart.action.centerNode) {
          for (var g = d; null != g.pid || null != g.stpid; )
            g = null == g.pid && null != g.stpid ? s[g.stpid] : s[g.pid];
          for (var p = s[n.id]; (null != p.pid || null != p.stpid) && p != d; )
            p = null == p.pid && null != p.stpid ? s[p.stpid] : s[p.pid];
          g == p && (d = g);
        }
        if (d) {
          ...
          if (!u) {
            if (!OrgChart.isNEU(d.pid))
              (mt = (m = s[d.pid]).childrenIds.indexOf(d.id)) > -1 &&
                m.childrenIds.splice(mt, 1);
            l.push(d);
          }
        }
      }
      e.roots = [];
      for (c = 0; c < l.length; c++) e.roots.push(l[c].id);
    }
    if (i == OrgChart.action.exporting && null != n.id)
      if (n.parentLevels) {
        for (var m = s[n.id], C = 0; C < n.parentLevels && s[m.pid]; )
          C++, (m = s[m.pid]);
        (m.pid = null), (l = [m]);
      } else {
        (x = s[n.id]) && ((x.pid = null), (l = [x]));
      }
    var b = [];
    if (i == OrgChart.action.init && e.expand && e.expand.nodes && null == o)
      for (c = 0; c < e.expand.nodes.length; c++) {
        var x = s[e.expand.nodes[c]];
        for (
          !0 === e.expand.allChildren &&
          OrgChart.manager._addExpandedNodeIdsIterate(x, s, b);
          x;

        )
          b.push(x.id),
            null == x.pid && null != x.stpid
              ? ((x = s[x.stpid]).min = !1)
              : (x = s[x.pid]);
      }
    else if (
      (i == OrgChart.action.expand && n.ids && "all" != n.ids) ||
      (i == OrgChart.action.collapse && n && n.expandIds)
    ) {
      nt = i == OrgChart.action.expand ? n.ids : n.expandIds;
      for (c = 0; c < nt.length; c++)
        for (m = s[(x = s[nt[c]]).pid]; m; )
          b.push(m.id),
            null == m.pid && null != m.stpid
              ? ((m = s[m.stpid]).min = !1)
              : (m = s[m.pid]);
    } else if (i == OrgChart.action.centerNode) {
      for (var v = OrgChart._getCenterNodeFromParams(s, n); v; ) {
        if (
          (b.push(v.id),
          n.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS && v)
        )
          for (c = 0; c < v.childrenIds.length; c++) {
            (H = s[v.childrenIds[c]]).collapsed = !0;
          }
        if (null == v.pid && null != v.stpid) {
          if ((((v = s[v.stpid]).min = !1), v.tags))
            -1 != (mt = v.tags.indexOf("filter")) &&
              (v.tags.splice(mt, 1), t.filterUI._removeFilter(v.id));
        } else v = s[v.pid];
      }
      if (
        ((v = OrgChart._getCenterNodeFromParams(s, n)),
        n.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
      )
        for (c = 0; c < v.childrenIds.length; c++) {
          (y = s[v.childrenIds[c]]).collapsed = !1;
          for (var O = 0; O < y.childrenIds.length; O++) {
            s[y.childrenIds[O]].collapsed = !0;
          }
        }
      if (
        n.options.parentState ===
        OrgChart.COLLAPSE_PARENT_SUB_CHILDREN_EXCEPT_CLICKED
      )
        if ((m = s[v.pid]))
          for (c = 0; c < m.childrenIds.length; c++) {
            var y;
            if ((y = s[m.childrenIds[c]]) != v) {
              y.collapsed = !1;
              for (O = 0; O < y.childrenIds.length; O++) {
                s[y.childrenIds[O]].collapsed = !0;
              }
            }
          }
    } else if (i == OrgChart.action.insert)
      for (x = s[n.insertedNodeId]; x; )
        b.push(x.id),
          null == x.pid && null != x.stpid
            ? ((x = s[x.stpid]).min = !1)
            : (x = s[x.pid]);
    var _ = [],
      ...
      S = [];
    for (c = 0; c < l.length; c++)
      OrgChart.manager._iterate(l[c], l[c], s, 0, _, w, k, I, "", b, S, t);
    if (
      i == OrgChart.action.collapse &&
      n &&
      Array.isArray(n.expandIds) &&
      Array.isArray(n.collapseIds)
    )
      for (c = 0; c < n.ids.length; c++) {
        if (n.expandIds.has(n.collapseIds[c]))
          console.error(
            `id ${n.collapseIds[c]} exist in both collapseIds and expandIds`
          );
        else (x = s[n.collapseIds[c]]) && (x.collapsed = !0);
      }
    for (c = l.length - 1; c >= 0; c--) l[c].collapsed && l.splice(c, 1);
    for (c = 0; c < S.length; c++) {
      ...
      var L = [],
        ...
        P = [],
        U = [];
      for (O = 0; O < x.children.length; O++) {
        (H = x.children[O]).isAssistant
          ? L.push(H.id)
          : -1 != H.tags.indexOf("right-partner")
          ? ((H.isPartner = 1), (H.children = []), E.push(H.id))
          : -1 != H.tags.indexOf("left-partner")
          ? ((H.isPartner = 2), (H.children = []), A.push(H.id))
          : -1 == H.tags.indexOf("partner") || $ % 2
          ? -1 != H.tags.indexOf("partner") && $ % 2
            ? ((H.isPartner = 2), (H.children = []), A.push(H.id), $++)
            : H.parentPartner
      ...
      for (O = 0; O < E.length; O++) {
        N[(H = s[E[O]]).id] ? x.children.push(H) : x.children.splice(0, 0, H);
        for (var B = 0; B < H.childrenIds.length; B++) R.push(H.childrenIds[B]);
      }
      var F = [];
      for (O = 0; O < A.length; O++) {
        N[(H = s[A[O]]).id] ? x.children.push(H) : x.children.splice(0, 0, H);
        for (B = 0; B < H.childrenIds.length; B++) F.push(H.childrenIds[B]);
      }
      ...
      for (O = A.length - 1; O >= 0; O--)
        if (N[A[O]])
          for (f = 0; f < N[A[O]].length; f++)
            x.children.push(s[N[A[O]][f]]),
              M++,
              -1 == U.indexOf(A[O]) && U.push(A[O]);
      ...
      for (O = 0; O < E.length; O++)
        if (N[E[O]])
          for (f = 0; f < N[E[O]].length; f++)
            x.children.push(s[N[E[O]][f]]),
              T++,
              -1 == P.indexOf(E[O]) && P.push(E[O]);
    ...
    for (c = 0; c < k.length; c++) {
      var D = r[(x = s[k[c]]).lcn ? x.lcn : "base"];
      for (O = 0; O < x.subLevels; O++) {
        var z = new OrgChart.node(
          x.id + "_sub_level_index_" + O,
          x.pid,
          [],
          "subLevel"
        );
        if ((OrgChart.manager._initDinamicNode(z, x.lcn), (m = x.parent)))
          null != x.movex && (z.movex = x.movex),
            null != x.movey && (z.movey = x.movey),
            (mt = m.children.indexOf(x)) > -1 &&
              (m.children.splice(mt, 1), m.children.splice(mt, 0, z)),
            z.children.push(x),
            (z.parent = m),
            (x.parent = z),
            (s[z.id] = z);
    ...
    for (var j in w) {
      (m = s[j]).hasAssistants = !0;
      z = new OrgChart.node(
        m.id + "_split_assitant_0",
        m.id,
        ["assistant"],
        "split"
      );
      null != m.movex && (z.movex = m.movex),
        null != m.movey && (z.movey = m.movey),
        OrgChart.manager._initDinamicNode(z, m.lcn, !0),
        (s[z.id] = z);
      var q = [];
      for (O = m.children.length - 1; O >= 0; O--) {
        (H = m.children[O]).isAssistant
          ? ((H.parent = null), m.children.splice(O, 1), q.splice(0, 0, H.id))
          : H.isPartner ||
            (H.parent &&
              I[H.parent.id] &&
              z &&
              ...
              (Object.defineProperty(
                I,
                z.id,
                Object.getOwnPropertyDescriptor(I, H.parent.id)
              ),
              delete I[H.parent.id]),
            (H.parent = z),
            z.children.unshift(H),
            m.children.splice(O, 1));
      }
      if (q.length % 2) {
        var Y = s[q[q.length - 1]],
          X = new OrgChart.node(Y.id + "_mirror", m.pid, [], "mirror");
      ...
      for (O = q.length - 1; O >= 0; O--)
        if (O % 2 && O != q.length - 1) {
          var G = new OrgChart.node(
            m.id + "_split_assitant_" + V,
            m.pid,
            [],
            "split"
          );
          OrgChart.manager._initDinamicNode(G, m.lcn, !0),
            null != m.movex && (G.movex = m.movex),
            null != m.movey && (G.movey = m.movey),
            (s[G.id] = G),
            q.splice(O, 0, G.id),
            V++;
        } else O % 2 && q.splice(O, 0, z.id);
      for (O = 0; O < q.length; O += 3) {
        var W = null;
        W = 0 == O ? m : s[q[O - 2]];
        var K = s[q[O]],
          J = s[q[O + 1]],
    ...
    if (Q || et) {
      var rt = { nodes: s, config: e, action: i, actionParams: n };
      if (k.length) {
        var it = !1;
        for (var j in I) {
          var nt = I[j];
          for (c = 0; c < nt.length; c++) {
            if ((x = s[nt[c]]).subLevels) {
              it = !0;
              break;
            }
          }
          ...
          for (var j in I) {
            ...
            for (c = 0; c < nt.length; c++) {
              ...
              (null === ht || k.has(ct)) &&
                ((ht = s[ct].parent.id),
                lt ||
                  OrgChart.isNEU(s[ct].subLevels) ||
                  (lt = s[ct].subLevels > 0)),
                at[ht] || (at[ht] = []),
                at[ht].push(ct),
                lt && ((st[ht] = j), ot[ht] || (ot[ht] = []), ot[ht].push(ct));
            }
          }
          for (var j in ((I = {}), ot))
            if (
              ...
              var dt = st[j];
              for (c = s[dt].children.length - 1; c >= 0; c--) {
                H = s[dt].children[c];
                ot[j].has(H.id) && s[dt].children.splice(c, 1);
              }
            }
          for (var j in at)
            at[j].length >
      ...
      for (var j in I) {
        for (var gt = (m = s[j]); gt.isSplit; ) gt = s[gt.pid];
        for (; gt.isSubLevel; ) gt = s[gt.pid];
        if (0 != (D = r[m.lcn ? m.lcn : "base"]).layout || et) {
          (rt.pnode = m),
            (rt.layout = D.layout),
            (rt.layoutGridColumns = e.layoutGridColumns),
            (rt.childrenIds = I[j]),
            (rt.lastChildrenPidIds = I),
            (rt.subLevels = 0),
            (rt.layouts = []),
            ...
            rt.layouts.length ||
              rt.layouts.push({
                layout: rt.layout,
                childrenIds: rt.childrenIds,
                subLevels: rt.subLevels,
                layoutGridColumns: rt.layoutGridColumns,
              });
          for (var pt = 0; pt < rt.layouts.length; pt++) {
            var ut = rt.layouts[pt];
            for (
              OrgChart.isNEU(ut.subLevels) && (ut.subLevels = 0),
                OrgChart.isNEU(ut.layout) && (ut.layout = D.layout),
                gt = m = s[j];
              gt.isSplit;
            ...
            for (; gt.isSubLevel; ) gt = s[gt.pid];
            var ft = m;
            for (O = 0; O < ut.subLevels; O++) {
              z = new OrgChart.node(
                pt + "_sublevel_layout_" + O,
                ft.id,
                [],
                "subLevel"
              );
              OrgChart.manager._initDinamicNode(z, ft.lcn),
                (z.parent = ft),
                ft.children.push(z),
                (s[z.id] = z),
                (ft = z);
            ...
            if (ut.subLevels) {
              for (O = 0; O < ut.childrenIds.length; O++) {
                var mt;
                H = s[ut.childrenIds[O]];
                -1 != (mt = m.children.indexOf(H)) && m.children.splice(mt, 1),
                  (H.parent = ft),
                  ft.children.push(H);
              }
              m = ft;
            ...
            if (
              ut.layout == OrgChart.layout.grid &&
              ut.childrenIds.length > 2
            ) {
              "dynamic" == ut.layoutGridColumns &&
                (ut.layoutGridColumns = OrgChart._getDynamicGridCoulumns(
                  ut.childrenIds.length
                ));
              var Ct = m.id;
              for (c = m.children.length - 1; c >= 0; c--)
                for (O = 0; O < ut.childrenIds.length; O++) {
                  ct = ut.childrenIds[O];
                  if (m.children[c].id == ct) {
                    m.children.splice(c, 1);
                    break;
                  }
                }
              var bt = ut.layoutGridColumns;
              bt % 2 != 0 && bt > 2 && bt--;
              for (c = 0; c < ut.childrenIds.length; c += bt) {
                var xt = null;
                for (O = 0; O < bt; O++) {
                  var vt = c + bt >= ut.childrenIds.length;
                  if (ut.childrenIds.length - 1 < c + O) break;
                  ((H = s[(ct = ut.childrenIds[c + O])]).parent = s[Ct]),
                    s[Ct].children.push(H),
                    vt ||
                      (bt / 2 - 1 == O &&
                        ((xt = new OrgChart.node(
                          ut.childrenIds[c + O - 1] +
                            "_grid_pseudo_node_" +
                            ut.childrenIds[c + O + 1],
                          Ct,
                          [],
                        ...
                        OrgChart.manager._initDinamicNode(xt, m.lcn),
                        (xt.parent = s[Ct]),
                        s[Ct].children.push(xt),
                        (s[xt.id] = xt)),
                      bt - 1 == O && (Ct = xt.id));
                }
              }
            }
            if (ut.layout == OrgChart.layout.mixed) {
              var Ot = ut.childrenIds;
              for (c = Ot.length - 1; c >= 0; c--) {
                (m = (H = s[Ot[c]]).parent), (H.layout = OrgChart.layout.mixed);
                for (O = m.children.length - 1; O >= 0; O--)
                  if (H.id == m.children[O].id) {
                    m.children.splice(O, 1);
                    break;
                  }
                if (c > 0) {
              ...
              null != m.movex && (z.movex = m.movex),
                null != m.movey && (z.movey = m.movey),
                OrgChart.manager._initDinamicNode(z, m.lcn),
                (s[z.id] = z),
                (z.layout = ut.layout);
              var _t = [];
              for (c = ut.childrenIds.length - 1; c >= 0; c--) {
                for (
                  H = s[ut.childrenIds[c]], O = 0;
                  O < m.children.length;
                  O++
                )
                  m.children[O].id == H.id && m.children.splice(O, 1);
                if (
                  ((H.parent = null),
                  (H.layout = ut.layout),
                  (ut.layout != OrgChart.layout.treeRightOffset &&
                    ut.layout != OrgChart.layout.treeRight) ||
                    _t.splice(0, 0, H.id),
                  ut.layout > 2)
                ) {
                  var wt = new OrgChart.node(
                    pt + "_" + H.id + "_mirror",
                    gt.id,
                    [],
                    "mirror"
                  );
                  OrgChart.manager._initDinamicNode(wt, H.lcn),
                    (wt.layout = ut.layout),
                    (s[wt.id] = wt),
                    _t.splice(0, 0, wt.id);
                }
              ...
              for (V = 1, O = _t.length - 1; O >= 0; O--)
                if (O % 2 && O != _t.length - 1) {
                  G = new OrgChart.node(
                    pt + "_" + m.id + "_split_" + V,
                    gt.id,
                    [],
                  ...
                  OrgChart.manager._initDinamicNode(G, m.lcn),
                    null != m.movex && (G.movex = m.movex),
                    null != m.movey && (G.movey = m.movey),
                    (G.layout = ut.layout),
                    (s[G.id] = G),
                    _t.splice(O, 0, G.id),
                    V++;
                } else O % 2 && _t.splice(O, 0, z.id);
              for (O = 0; O < _t.length; O += 3) {
                W = null;
                0 == O && (W = m);
                (K = s[_t[O]]), (J = s[_t[O + 1]]), (Z = s[_t[O + 2]]);
                0 != O && (W = s[_t[O - 3]]),
                  0 == O || J || (W = s[_t[O - 2]]),
                  (K.parent = W),
                  W.children.push(K),
    ...
    if (OrgChart.VERTICAL_CHILDREN_ASSISTANT)
      for (c = 0; c < l.length; c++)
        OrgChart.manager._verticalAssistantIterate(l[c], s);
    rt = { nodes: s, roots: l };
    return (
  ...
  (OrgChart.manager._getOrderSortArray = function (t) {
    if ("string" == typeof t) return [{ field: t, desc: !1 }];
    if (Array.isArray(t)) {
      var e = [];
      for (var r of t)
        "string" == typeof r
          ? e.push({ field: r, desc: !1 })
          : t instanceof Object
          ? e.push(r)
          : console.error("Unseported orderBy value!");
      return e;
    }
  ...
  (OrgChart.manager._isVisible = function (t, e, r, i, n, a, o) {
    var s = 0;
    if ("auto" == OrgChart.LAZY_LOADING_FACTOR) {
      var l = (a / n) * 2,
        h = (o / n) * 2;
      s = l > h ? Math.ceil(l) : Math.ceil(h);
    } else s = OrgChart.LAZY_LOADING_FACTOR / n;
    if (null != t.x && null != t.y) {
      if (OrgChart._getLazyLoading(e) && i !== OrgChart.action.exporting) {
        function c(t, e) {
          var r = t.x,
            i = t.y,
            n = t.w,
            ...
            c = e[3] + s + e[1],
            d = r + n > o && l > r;
          return d && (d = i + a > h && c > i), d;
        }
        if (c(t, r)) return !0;
        for (var d = 0; d < t.children.length; d++)
          if (c(t.children[d], r)) return !0;
        return !1;
      }
      return !0;
    }
  ...
  (OrgChart.manager._getResponse = function (
    ...
    if (
      ((C.top = s - i.padding),
      (C.left = o - i.padding),
      (C.bottom = a + i.padding - e / O),
      (C.right = n + i.padding - t / O),
      (C.maxX = n),
      (C.minX = o),
      (C.maxY = a),
      (C.minY = s),
      0 == h.length || (null == l && !u && i.align == OrgChart.CENTER))
    ) {
      var y = Math.ceil(t / O),
        _ = Math.ceil(e / O),
        w = 0,
        k = 0;
      if (y - 2 * i.padding >= n - o)
        switch (((w = (n + o) / 2 - y / 2), i.orientation)) {
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            w = (o - n) / 2 - y / 2;
        }
        ...
        switch (
          ...
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            (w = -(y / 2 - (o - n) / 2)) < i.padding - y && (w = i.padding - y);
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.bottom_left:
          case OrgChart.orientation.top_left:
          case OrgChart.orientation.left_top:
            (w = -(y / 2 - (n - o) / 2)) > -i.padding && (w = -i.padding);
        }
      if (_ - 2 * i.padding >= a - s)
        switch (((k = (a + s) / 2 - _ / 2), i.orientation)) {
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            k = (s - a) / 2 - _ / 2;
        }
        ...
        switch (
          ((k = -(_ / 2 - (a - s) / 2)) > -i.padding && (k = -i.padding),
          i.orientation)
        ) {
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            (k = -(_ / 2 - (s - a) / 2)) < i.padding - _ && (k = i.padding - _);
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.right:
      ...
      l = [w, k, y, _];
    } else if (null == l && !u && i.align == OrgChart.ORIENTATION) {
      (y = Math.ceil(t / O)), (_ = Math.ceil(e / O)), (w = 0), (k = 0);
    ...
    if (c == OrgChart.action.centerNode || c == OrgChart.action.maximize) {
      var I = OrgChart._getCenterNodeFromParams(g, d);
      1 == d.options.horizontal && (l[0] = I.x + I.w / 2 - l[2] / 2),
        1 == d.options.vertical && (l[1] = I.y + I.h / 2 - l[3] / 2);
    }
    if (
      ...
      if (
        ...
        (c != OrgChart.action.expand && c != OrgChart.action.collapse) ||
        !d ||
        null == d.id ||
        null == d.id
      ) {
        if (c == OrgChart.action.centerNode) {
          switch (i.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
            case OrgChart.orientation.bottom:
          ...
          S && (S = OrgChart.manager._getMostDeepChild(S));
        }
      } else (S = g[d.id]), (S = OrgChart.manager._getMostDeepChild(S));
      if (!OrgChart.FIXED_POSITION_ON_CLICK && S) {
        if (S.isTreeListItem) {
          for (; !S.stParent; ) S = S.parent;
          S = S.stParent;
        }
        switch (i.orientation) {
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
            var L = S.y + S.h - l[3] + i.padding;
            l[1] < L && (l[1] = L);
            break;
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
          ...
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            L = S.x + S.w - l[2] + i.padding;
            l[0] < L && (l[0] = L);
        }
      }
    }
    for (var E = 0; E < h.length; E++)
      OrgChart.manager._iterate2(h[E], g, i, l, c, d, m, p, r, b, O, t, e);
    return {
      animations: b,
      boundary: C,
      viewBox: l,
  ...
  (OrgChart.manager._iterate2 = function (
    t,
    e,
    r,
    i,
    ...
    if (OrgChart.manager._isVisible(t, r, i, n, c, d, g)) {
      o.push(t.id);
      var p = null;
      if (
        (n == OrgChart.action.expand ||
          n == OrgChart.action.collapse ||
          n == OrgChart.action.maximize) &&
        s &&
        s[t.id] &&
        "expandCollapseToLevel" == a.method
      ) {
        if (((p = { x: (C = s[t.id]).x, y: C.y }), C)) {
          p = { x: C.x, y: C.y };
          for (var u = t, f = null; null != u; )
            s[u.id] && s[u.id].collapsed && (f = u), (u = u.parent);
          f && f.parent && (p = { x: f.parent.x, y: f.parent.y });
        }
        if ((b = e[a.id])) {
          for (u = t.parent; null != u; ) u = u.parent;
          u && (p = { x: b.x + b.w / 2 - t.w / 2, y: b.y + b.h / 2 - t.h / 2 });
        }
      } else if (
        (n == OrgChart.action.expand || n == OrgChart.action.collapse) &&
        s &&
        s[t.id]
      ) {
        if (((p = { x: (C = s[t.id]).x, y: C.y }), "all" == a.ids && C)) {
          p = { x: C.x, y: C.y };
          for (u = t, f = null; null != u; )
            s[u.id] && s[u.id].collapsed && (f = u), (u = u.parent);
          f && f.parent && (p = { x: f.parent.x, y: f.parent.y });
        }
        if ((b = e[a.id])) {
          for (
            u = t.parent;
            null != u && -1 == a.ids.indexOf(t.id) && -1 == a.ids.indexOf(u.id);

          )
            u = u.parent;
          u && (p = { x: b.x + b.w / 2 - t.w / 2, y: b.y + b.h / 2 - t.h / 2 });
        }
      } else if (n == OrgChart.action.centerNode && s && s[t.id]) {
        if (
          (null != (C = s[t.id]).x && null != C.y && (p = { x: C.x, y: C.y }),
          (m = OrgChart._getCenterNodeFromParams(e, a)) && m == t)
        )
          (u = t.parent) &&
            u.id == a.id &&
            (p = { x: m.x + m.w / 2 - t.w / 2, y: m.y + m.h / 2 - t.h / 2 });
      } else if (n == OrgChart.action.maximize && s && s[t.id]) {
        var m;
        if (
          (null != (C = s[t.id]).x && null != C.y && (p = { x: C.x, y: C.y }),
          (m = OrgChart._getCenterNodeFromParams(e, a)) && m == t)
          ...
          (u = t.parent) &&
            u.id == a.id &&
            (p = { x: m.x + m.w / 2 - t.w / 2, y: m.y + m.h / 2 - t.h / 2 });
      } else if (n == OrgChart.action.minimize && s && s[t.id]) {
        p = { x: (C = s[t.id]).x, y: C.y };
      } else if (
        n == OrgChart.action.insert &&
        a &&
        a.insertedNodeId == t.id &&
        t.parent
      )
        p = { x: t.parent.x, y: t.parent.y };
      else if (
        (n != OrgChart.action.update && n != OrgChart.action.insert) ||
        !s
      )
        n !== OrgChart.action.exporting &&
          n !== OrgChart.action.init &&
        ...
        var C, b;
        if (
          (!(C = s[t.id]) || (OrgChart.isNEU(C.x) && OrgChart.isNEU(C.y))) &&
          a
        ) {
          if ((b = e[a.id])) {
            for (u = b; u && u.id == t.id; ) u = u.parent;
            u && (p = { x: b.x, y: b.y });
          }
        } else C && (p = { x: C.x, y: C.y });
      }
      if (null != p && null != p.x && null != p.y)
        if (p.x != t.x || p.y != t.y)
          (a && a.dragNodeIdList && -1 != a.dragNodeIdList.indexOf(t.id)) ||
            t.isSplit ||
            (h[0].push(t.id),
            h[1].push({ transform: [1, 0, 0, 1, p.x, p.y] }),
            h[2].push({ transform: [1, 0, 0, 1, t.x, t.y] }));
    }
    for (var x = 0; x < t.stChildren.length; x++)
  ...
  (OrgChart.manager._setChildCountPropsIterate = function (t, e) {
    void 0 !== t.w || (t.collapsedChildCount = t.childrenIds.length),
      (t.deepChildCount = t.childCount = t.childrenIds.length),
      (t.deepCollapsedChildCount = t.collapsedChildCount);
    for (var r = e[t.pid]; r; )
      (r.deepCollapsedChildCount += t.collapsedChildCount),
        (r.deepChildCount += t.childCount),
        (r = e[r.pid]);
    for (var i of t.stChildrenIds)
      OrgChart.manager._setChildCountPropsIterate(e[i], e);
    for (var i of t.childrenIds)
      OrgChart.manager._setChildCountPropsIterate(e[i], e);
  }),
  (OrgChart.manager._setMinMaxXYAdjustifyIterate = function (
    ...
    for (var l of ((t.x += a.x), (t.y += a.y), t.stChildren))
      OrgChart.manager._setMinMaxXYAdjustifyIterate(l, l, r, 0, n, a, o, s);
    for (var l of (t.isPartner ? (t.sl = i - 1) : (t.sl = i),
    null == n[e.id] && (n[e.id] = {}),
    null == n[e.id][t.sl] &&
      (n[e.id][t.sl] = { minX: null, minY: null, maxX: null, maxY: null }),
    t.layout
      ? (null == s[e.id] && (s[e.id] = {}),
        null == s[e.id][t.sl] && (s[e.id][t.sl] = t))
      : OrgChart._setMinMaxXY(t, n[e.id][t.sl], !0),
    null != t.movex && (t.x += t.movex),
    null != t.movey && (t.y += t.movey),
    OrgChart._setMinMaxXY(t, r, !0),
    i++,
    t.children))
      OrgChart.manager._setMinMaxXYAdjustifyIterate(l, e, r, i, n, a, o, s);
  }),
  (OrgChart.manager._doNotChangePositionOfClickedNodeIfAny = function (
    ...
    var s = e[o],
      l = n[o];
    if (!l) return { x: 0, y: 0 };
    var h = null != l.movex ? l.movex : 0,
      c = null != l.movey ? l.movey : 0,
      d = { x: (l.x ? l.x - h : 0) - s.x, y: (l.y ? l.y - c : 0) - s.y };
    return s && s.isTreeListItem ? { x: 0, y: 0 } : d;
  }),
  (OrgChart.manager._verticalAssistantIterate = function (t, e) {
    ...
    if (t.isAssistant && t.isSplit && t.children.length) {
      for (
        var i = t.parent.children[0], n = t.parent.children[2], a = t.parent;
        !a.hasAssistants;
      ...
      OrgChart.manager._verticalAssistantLevelCountIterate(i, 0, o),
        OrgChart.manager._verticalAssistantLevelCountIterate(n, 0, s);
      var l = Math.max(o.max, s.max),
        h = [];
      for (r = 0; r < l; r++) {
        ...
        OrgChart.manager._initDinamicNode(c, t.lcn, !0),
          null != a.movex && (c.movex = a.movex),
          null != a.movey && (c.movey = a.movey),
  ...
  (OrgChart._addDottedLines = function (t) {
    ...
    if (
      ...
      for (var r = [], i = 0; i < t.groupDottedLines.length; i++) {
        var n = t.groupDottedLines[i];
        null == n.rootId && (n.rootId = n.to);
        var a = `balkan_group_dotted_${n.rootId}`;
        if (!r.has(a))
          for (var o = 0; o < e.length; o++)
            if (e[o].id == n.rootId) {
              ((c = JSON.parse(
                JSON.stringify(e[o])
              )).id = `balkan_group_dotted_${n.rootId}_balkan_id_${e[o].id}`),
                (c.pid = void 0),
                (c.stpid = e[o].id),
                e.push(c),
                r.push(a),
                ...
                e[o].tags.push("group-dotted-lines-" + a);
              break;
            }
        for (o = 0; o < e.length; o++)
          if (e[o].id == n.from) {
            if (
              ...
              (c.pid = `balkan_group_dotted_${n.rootId}_balkan_id_${n.to}`),
              c.tags)
            ) {
              var s = c.tags.indexOf("group-dotted-lines");
              -1 != s && c.tags.splice(s, 1);
            }
            if (
              (c.tags || (c.tags = []),
              ...
              for (var l = 0; l < n.tags.length; l++) c.tags.push(n.tags[l]);
            e.push(c);
            break;
          }
      }
        ...
        for (o = 0; o < e.length; o++)
          if (e[o].id == h.from) {
            ...
            if (
              ...
              h.rootId == h.to
                ? (c.pid = h.to)
                : (c.pid = `balkan_dotted_${h.rootId}_balkan_id_${h.to}`),
              c.tags || (c.tags = []),
              c.tags.push("boc-dotted-connector"),
              h.tags)
            )
              for (l = 0; l < h.tags.length; l++) c.tags.push(h.tags[l]);
            e.push(c);
            break;
          }
      }
  ...
  (OrgChart.templates.base = {
    ...
    plus: function (t, e, r, i, n) {
      var a = "dark" == i.mode ? "#1E1E1E" : "#ffffff";
      return `<g transform="matrix(1,0,0,1,${n.x - 15},${
        n.y - 15
      })"><circle cx="15" cy="15" r="15" fill="${a}" stroke="#aeaeae" stroke-width="1"></circle>\n        <text text-anchor="middle" style="font-size: 14px;cursor:pointer;" fill="#aeaeae" x="15" y="21">${
        t.deepCollapsedChildCount
      }</text></g>`;
    },
    minus: function (t, e, r, i, n) {
      var a = "dark" == i.mode ? "#1E1E1E" : "#ffffff";
      return `<g transform="matrix(1,0,0,1,${n.x - 15},${
        n.y - 15
    ...
    nodeMenuButton:
      '<g style="cursor:pointer;" transform="matrix(1,0,0,1,225,105)"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="7" cy="0" r="2" fill="#ffffff"></circle><circle cx="14" cy="0" r="2" fill="#ffffff"></circle></g>',
    menuButton:
      '<div style="user-select:none;position:absolute;right:{p}px;top:{p}px; width:30px;height:50px;cursor:pointer;" ' +
      OrgChart.attr.control_export_menu +
  ...
  (OrgChart.templates.ana = {
    ...
    assistanseLink:
      '<path stroke-linejoin="round" stroke="#aeaeae" stroke-width="2px" fill="none" d="M{xa},{ya} {xb},{yb} {xc},{yc} {xd},{yd} L{xe},{ye}"/>',
    node: function (t, e, r, i) {
      return `<rect x="0" y="0" height="${t.h}" width="${t.w}" fill="#039BE5" stroke-width="1" stroke="#aeaeae" rx="10" ry="10"></rect>`;
    },
    plus: function (t, e, r, i, n) {
      var a = "dark" == i.mode ? "#1E1E1E" : "#ffffff";
      return `<g transform="matrix(1,0,0,1,${n.x - 15},${
    ...
    nodeMenuButton: function (t, e, r, i) {
      return `<g transform="matrix(1,0,0,1,${t.w - 25},${
        t.h - 15
      })"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="7" cy="0" r="2" fill="#ffffff"></circle><circle cx="14" cy="0" r="2" fill="#ffffff"></circle></g>`;
    },
    menuButton: OrgChart.templates.base.menuButton,
    img_0: function (t, e, r, i, n) {
      var a = OrgChart.randomId();
      return `<clipPath id="${a}"><circle cx="50" cy="30" r="40"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#${a})" xlink:href="${n}" x="10" y="-10" width="80" height="80" ></image>`;
    },
    link_field_0:
      '<text text-anchor="middle" fill="#aeaeae" ' +
      OrgChart.attr.width +
      '="290" x="0" y="0" style="font-size:10px;">{val}</text>',
    field_0: function (t, e, r, i, n) {
      return OrgChart.wrapText(
        n,
        `<text style="font-size: 18px;" fill="#ffffff" x="${t.w / 2}" y="${
          t.h - 25
    ...
    field_1: function (t, e, r, i, n) {
      return OrgChart.wrapText(
        n,
        `<text style="font-size: 14px;" fill="#ffffff" x="${
          t.w - 20
        }" y="30" text-anchor="end"></text>`,
        t.w - 120,
        3
      );
    },
  ...
  (OrgChart.templates.ula.field_0 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      '<text style="font-size: 18px;" fill="#039BE5" x="100" y="55"></text>',
      t.w - 105,
      1
    );
  }),
  (OrgChart.templates.ula.field_1 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      '<text data-text-overflow="multiline" style="font-size: 14px;" fill="#afafaf" x="100" y="76"></text>',
      t.w - 105,
      3
    );
  }),
  (OrgChart.templates.ula.node = function (t, e, r, i) {
    return `<rect x="0" y="0" height="${t.h}" width="${t.w}" fill="#ffffff" stroke-width="1" stroke="#aeaeae"></rect><line x1="0" y1="0" x2="${t.w}" y2="0" stroke-width="2" stroke="#039BE5"></line>`;
  }),
  (OrgChart.templates.ula.img_0 = function (t, e, r, i, n) {
    var a = OrgChart.randomId();
    return `<clipPath id="${a}"><circle cx="50" cy="60" r="40"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#${a})" xlink:href="${n}" x="10" y="20" width="80" height="80" ></image>`;
  }),
  ...
  (OrgChart.templates.ula.nodeMenuButton = function (t, e, r, i) {
    return `<g transform="matrix(1,0,0,1,${t.w - 25}, ${
      t.h - 15
    })"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#AEAEAE"></circle><circle cx="7" cy="0" r="2" fill="#AEAEAE"></circle><circle cx="14" cy="0" r="2" fill="#AEAEAE"></circle></g>`;
  }),
  ...
  (OrgChart.templates.olivia.field_0 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      '<text class="olivia-f0" x="100" y="55"></text>',
      t.w - 105,
      1
    );
  }),
  (OrgChart.templates.olivia.field_1 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      '<text class="olivia-f1" x="100" y="76"></text>',
      t.w - 105,
      3
    );
  }),
  (OrgChart.templates.olivia.node = function (t, e, r, i) {
    return `<rect fill="url(#olivia_gradient)" x="0" y="0" height="${t.h}" width="${t.w}" stroke-width="1" stroke="#aeaeae" rx="10" ry="10"></rect>`;
  }),
  ...
  (OrgChart.templates.olivia.nodeMenuButton = function (t, e, r, i) {
    return `<g style="cursor:pointer;" transform="matrix(1,0,0,1,${t.w - 25},${
      t.h - 15
    })"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#AEAEAE"></circle><circle cx="7" cy="0" r="2" fill="#AEAEAE"></circle><circle cx="14" cy="0" r="2" fill="#AEAEAE"></circle></g>`;
  }),
  ...
  (OrgChart.templates.belinda.node = function (t, e, r, i) {
    return `<circle cx="${t.w / 2}" cy="${t.h / 2}" r="${
      t.w / 2
    }" fill="#039BE5" stroke-width="1" stroke="#aeaeae"></circle>`;
  }),
  (OrgChart.templates.belinda.img_0 = function (t, e, r, i, n) {
    var a = t.w / 2,
      o = OrgChart.randomId();
    return `<clipPath id="${o}"><circle cx="${a}" cy="45" r="40"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#${o})" xlink:href="${n}" x="${
      a - 40
    }" y="5" width="80" height="80" ></image>`;
  }),
  (OrgChart.templates.belinda.field_0 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      `<text style="font-size: 18px;" text-anchor="middle" fill="#ffffff"  x="${
        t.w / 2
      }" y="${t.h / 2 + 15}"></text>`,
      t.w - 10,
      1
  ...
  (OrgChart.templates.belinda.field_1 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      `<text style="font-size: 14px;" text-anchor="middle" fill="#ffffff"  x="${
        t.w / 2
      }" y="${t.h / 2 + 35}"></text>`,
      t.w - 20,
      2
  ...
  (OrgChart.templates.belinda.link =
    '<path stroke="#aeaeae" stroke-width="1px" fill="none" d="M{xa},{ya} C{xb},{yb} {xc},{yc} {xd},{yd}"/>'),
  (OrgChart.templates.belinda.nodeMenuButton = function (t, e, r, i) {
    return `<g style="cursor:pointer;" transform="matrix(1,0,0,1,${
      t.w / 2 - 11
    },5)"><rect x="0" y="0" fill="#000000" fill-opacity="0" width="22" height="22"></rect><line stroke-width="2" stroke="#000" x1="0" y1="3" x2="22" y2="3"></line><line stroke-width="2" stroke="#000" x1="0" y1="9" x2="22" y2="9"></line><line stroke-width="2" stroke="#000" x1="0" y1="15" x2="22" y2="15"></line></g>`;
  }),
  ...
  (OrgChart.templates.rony.img_0 = function (t, e, r, i, n) {
    var a = t.w / 2,
      o = OrgChart.randomId();
    return `<clipPath id="${o}"><circle cx="${a}" cy="160" r="60"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#${o})" xlink:href="${n}" x="${
      a - 60
    }" y="100" width="120" height="120" ></image>`;
  }),
  (OrgChart.templates.rony.node = function (t, e, r, i) {
    return `<rect filter="url(#{randId})" x="0" y="0" height="${t.h}" width="${t.w}" fill="#ffffff" stroke-width="0" rx="10" ry="10"></rect>'`;
  }),
  (OrgChart.templates.rony.field_0 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      `<text style="font-size: 18px;" fill="#039BE5" x="${
        t.w / 2
      }" y="40" text-anchor="middle"></text>`,
      t.w - 15,
      1
    );
  }),
  (OrgChart.templates.rony.field_1 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      `<text style="font-size: 14px;" fill="#F57C00" x="${
        t.w / 2
      }" y="60" text-anchor="middle"></text>`,
      t.w - 15,
      3
    );
  }),
  (OrgChart.templates.rony.field_2 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      `<text style="font-size: 14px;" fill="#FFCA28" x="${
        t.w / 2
      }" y="80" text-anchor="middle"></text>`,
      t.w - 15,
      1
    );
  }),
  ...
  (OrgChart.templates.rony.plus = function (t, e, r, i, n) {
    return `<g transform="matrix(1,0,0,1,${n.x - 15},${
      n.y - 15
    })"><circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#039BE5" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#039BE5"></line><line x1="15" y1="4" x2="15" y2="26" stroke-width="1" stroke="#039BE5"></line></g>`;
  }),
  (OrgChart.templates.rony.minus = function (t, e, r, i, n) {
    return `<g transform="matrix(1,0,0,1,${n.x - 15},${
      n.y - 15
    })"><circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#039BE5" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#039BE5"></line></g>`;
  }),
  (OrgChart.templates.rony.nodeMenuButton = function (t, e, r, i) {
    return `<g transform="matrix(1,0,0,1,${t.w - 25},${
      t.h - 15
    })"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#F57C00"></circle><circle cx="7" cy="0" r="2" fill="#F57C00"></circle><circle cx="14" cy="0" r="2" fill="#F57C00"></circle></g>`;
  }),
  ...
  (OrgChart.templates.mery.node = function (t, e, r, i) {
    return `<rect x="0" y="0" height="${t.h}" width="${
      t.w
    }" fill="#ffffff" stroke-width="1" stroke="#686868" rx="50" ry="50"></rect><rect x="0" y="${
      t.h / 2 - 15
    }" height="30" width="${t.w}" fill="#039BE5" stroke-width="1"></rect>`;
  }),
  (OrgChart.templates.mery.link =
    '<path stroke="#aeaeae" stroke-width="1px" fill="none" d="M{xa},{ya} C{xb},{yb} {xc},{yc} {xd},{yd}" />'),
  (OrgChart.templates.mery.img_0 = function (t, e, r, i, n) {
    var a = t.w / 2,
      o = t.h / 2,
      s = OrgChart.randomId();
    return `<clipPath id="${s}"><circle cx="${a}" cy="${o}" r="24"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#${s})" xlink:href="${n}" x="${
      a - 24
    }" y="${o - 24}" width="48" height="48" ></image>`;
  }),
  (OrgChart.templates.mery.field_0 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      `<text style="font-size: 18px;" fill="#039BE5" x="${t.w / 2}" y="${
        t.h / 2 - 30
      }" text-anchor="middle"></text>`,
      t.w - 30,
      1
  ...
  (OrgChart.templates.mery.field_1 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      `<text style="font-size: 14px;" fill="#039BE5" x="${t.w / 2}" y="${
        t.h / 2 + 40
      }" text-anchor="middle"></text>`,
      t.w - 30,
      1
  ...
  (OrgChart.templates.mery.nodeMenuButton = function (t, e, r, i) {
    return `<g transform="matrix(1,0,0,1,${t.w - 25}, ${
      t.h / 2
    })"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="7" cy="0" r="2" fill="#ffffff"></circle><circle cx="14" cy="0" r="2" fill="#ffffff"></circle></g>`;
  }),
  ...
  (OrgChart.templates.polina.node = function (t, e, r, i) {
    return `<rect x="0" y="0" height="${t.h}" width="${t.w}" fill="#039BE5" stroke-width="1" stroke="#686868" rx="40" ry="40"></rect>`;
  }),
  ...
  (OrgChart.templates.polina.field_0 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      '<text style="font-size: 18px;" fill="#ffffff" x="80" y="30" text-anchor="start"></text>',
      t.w - 90,
      1
    );
  }),
  (OrgChart.templates.polina.field_1 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      '<text  style="font-size: 14px;" fill="#ffffff" x="80" y="55" text-anchor="start"></text>',
      t.w - 90,
      1
    );
  }),
  ...
  (OrgChart.templates.polina.nodeMenuButton = function (t, e, r, i) {
    return `<g transform="matrix(1,0,0,1,${
      t.w - 15
    },33)"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="0" cy="7" r="2" fill="#ffffff"></circle><circle cx="0" cy="14" r="2" fill="#ffffff"></circle></g>`;
  }),
  (OrgChart.templates.mila = Object.assign({}, OrgChart.templates.ana)),
  (OrgChart.templates.mila.padding = [60, 15, 120, 15]),
  (OrgChart.templates.mila.node = function (t, e, r, i) {
    return `<rect x="0" y="0" height="${t.h}" width="${
      t.w
    }" fill="#039BE5" stroke-width="1" stroke="#aeaeae"></rect><rect x="-5" y="${
      t.h - 50
    }" height="30" width="${
      t.w + 10
    }" fill="#ffffff" stroke-width="1" stroke="#039BE5"></rect><line x1="-5" x2="0" y1="${
      t.h - 20
    }" y2="${t.h - 15}" stroke-width="1" stroke="#039BE5"/><line x1="${
      t.w + 5
    }" x2="${t.w}" y1="${t.h - 20}" y2="${
      t.h - 15
    }" stroke-width="1" stroke="#039BE5"/>`;
  }),
  (OrgChart.templates.mila.img_0 = function (t, e, r, i, n) {
    return `<image preserveAspectRatio="xMidYMid slice" xlink:href="${n}" x="20" y="${
      t.h - 115
    }"  width="64" height="64"></image>`;
  }),
  (OrgChart.templates.mila.field_0 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      `<text style="font-size: 18px;" fill="#039BE5" x="${t.w / 2}" y="${
        t.h - 28
  ...
  (OrgChart.templates.mila.nodeMenuButton = function (t, e, r, i) {
    return `<g transform="matrix(1,0,0,1,${t.w - 25},${
      t.h - 10
    })"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="7" cy="0" r="2" fill="#ffffff"></circle><circle cx="14" cy="0" r="2" fill="#ffffff"></circle></g>`;
  }),
  ...
  (OrgChart.templates.diva.node = function (t, e, r, i) {
    return `<rect x="0" y="80" height="${t.h - 80}" width="${
      t.w
    }" fill="#039BE5"></rect><circle cx="${
      t.w / 2
    }" cy="50" fill="#ffffff" r="50" stroke="#039BE5" stroke-width="2"></circle>`;
  }),
  (OrgChart.templates.diva.img_0 = function (t, e, r, i, n) {
    var a = t.w / 2,
      o = OrgChart.randomId();
    return `<clipPath id="${o}"><circle cx="${a}" cy="50" r="45"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#${o})" xlink:href="${n}" x="${
      a - 45
    }" y="5" width="90" height="90" ></image>`;
  }),
  (OrgChart.templates.diva.field_0 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      `<text style="font-size: 18px;" fill="#ffffff" x="${
        t.w / 2
      }" y="125" text-anchor="middle"></text>`,
      t.w - 15,
      1
    );
  }),
  (OrgChart.templates.diva.field_1 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      `<text  style="font-size: 14px;" fill="#ffffff" x="${
        t.w / 2
      }" y="145" text-anchor="middle"></text>`,
      t.w - 15,
      1
    );
  }),
  ...
  (OrgChart.templates.diva.nodeMenuButton = function (t, e, r, i) {
    return `<g transform="matrix(1,0,0,1,${t.w - 30}, ${
      t.h - 15
    })"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="7" cy="0" r="2" fill="#ffffff"></circle><circle cx="14" cy="0" r="2" fill="#ffffff"></circle></g>`;
  }),
  ...
  (OrgChart.templates.luba.node = function (t, e, r, i) {
    return `<rect fill="url(#{randId})" x="0" y="0" height="${t.h}" width="${t.w}" stroke-width="1" stroke="#aeaeae" rx="10" ry="10"></rect>`;
  }),
  (OrgChart.templates.luba.padding = [70, 10, 60, 10]),
  (OrgChart.templates.luba.img_0 = function (t, e, r, i, n) {
    var a = OrgChart.randomId();
    return `<clipPath id="${a}"><circle cx="50" cy="25" r="40"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#${a})" xlink:href="${n}" x="10" y="-15" width="80" height="80" ></image>`;
  }),
  (OrgChart.templates.luba.nodeMenuButton = function (t, e, r, i) {
    return `<g transform="matrix(1,0,0,1,${t.w - 25},${
      t.h - 15
    })"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#aeaeae"></circle><circle cx="7" cy="0" r="2" fill="#aeaeae"></circle><circle cx="14" cy="0" r="2" fill="#aeaeae"></circle></g>`;
  }),
  (OrgChart.templates.luba.field_0 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      `<text style="font-size: 18px;" fill="#aeaeae" x="${t.w / 2}" y="${
        t.h - 30
      }" text-anchor="middle"></text>`,
      t.w - 15,
      1
  ...
  (OrgChart.templates.luba.field_1 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      `<text  style="font-size: 14px;" fill="#aeaeae" x="${
        t.w - 10
      }" y="30" text-anchor="end"></text>`,
      t.w - 110,
      1
  ...
  (OrgChart.templates.isla.node = function (t, e, r, i) {
    return `<rect filter="url(#isla-shadow)" x="0" y="20" rx="10" ry="10" height="${
      t.h - 20
    }" width="${
      t.w
    }" fill="#FFF" stroke-width="1" stroke="#039BE5" ></rect><rect x="25" y="${
      t.h - 45
    }" rx="10" ry="10" height="20" width="${
      t.w - 50
    }" fill="#039BE5" stroke-width="3" stroke="#039BE5"></rect><rect fill="#ffffff" stroke="#039BE5" stroke-width="1" x="${
      t.w / 2 - 20
    }" y="0" rx="13" ry="13" width="40" height="40"></rect><circle stroke="#FFCA28" stroke-width="3" fill="none" cx="${
      t.w / 2
    }" cy="12" r="8"></circle><path d="M${t.w / 2 - 15},34 C${
      t.w / 2 - 15
    },17 ${t.w / 2 + 15},17 ${
      t.w / 2 + 15
    },34" stroke="#FFCA28" stroke-width="3" fill="none"></path>`;
  }),
  (OrgChart.templates.isla.field_0 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      `<text style="font-size: 12px;" fill="#fff" x="${t.w / 2}" y="${
        t.h - 30
      }" text-anchor="middle"></text>`,
      t.w - 60,
      1
  ...
  (OrgChart.templates.isla.field_1 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      `<text  style="font-size: 13px;" fill="#039BE5" x="${
        t.w / 2
      }" y="64" text-anchor="middle"></text>`,
      t.w - 20,
      1
    );
  }),
  (OrgChart.templates.isla.img_0 = ""),
  (OrgChart.templates.isla.img_0 = function (t, e, r, i, n) {
    var a = OrgChart.randomId();
    return `<clipPath id="${a}"><rect filter="url(#isla-shadow)" fill="#ffffff" stroke="#039BE5" stroke-width="1" x="${
      t.w / 2 - 20
    }" y="0" rx="13" ry="13" width="40" height="40"></rect></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#${a})" xlink:href="${n}" x="${
      t.w / 2 - 20
    }" y="0"  width="40" height="40"></image>`;
  }),
  ...
  (OrgChart.templates.isla.nodeMenuButton = function (t, e, r, i) {
    return `<g transform="matrix(1,0,0,1,${
      t.w / 2 - 7
    },45)"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#F57C00"></circle><circle cx="7" cy="0" r="2" fill="#F57C00"></circle><circle cx="14" cy="0" r="2" fill="#F57C00"></circle></g>`;
  }),
  ...
  (OrgChart.templates.deborah.node = function (t, e, r, i) {
    return `<rect x="0" y="0" height="${t.h}" width="${t.w}" fill="#039BE5" stroke-width="1" stroke="#686868" rx="15" ry="15"></rect>`;
  }),
  (OrgChart.templates.deborah.img_0 = function (t, e, r, i, n) {
    var a = OrgChart.randomId();
    return `<clipPath id="${a}"><rect fill="#ffffff" stroke="#039BE5" stroke-width="1" x="5" y="5" rx="15" ry="15" width="${
      t.w - 10
    }" height="${
      t.h - 10
    }"></rect></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#${a})" xlink:href="${n}" x="5" y="5"  width="${
      t.w - 10
    }" height="${t.h - 10}"></image><rect x="3" y="5" height="30" width="${
      t.w - 6
    }" fill="#039BE5" opacity="0.5" rx="3" ry="3"></rect><rect x="3" y="${
      t.h - 35
    }" height="30" width="${
      t.w - 6
    }" fill="#039BE5" opacity="0.5" rx="3" ry="3"></rect>`;
  }),
  (OrgChart.templates.deborah.field_0 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
  ...
  (OrgChart.templates.deborah.field_1 = function (t, e, r, i, n) {
    return OrgChart.wrapText(
      n,
      `<text style="font-size: 11px;" fill="#ffffff" x="15" y="${
        t.h - 15
  ...
  (OrgChart.templates.deborah.nodeMenuButton = function (t, e, r, i) {
    return `<g style="cursor:pointer;" transform="matrix(1,0,0,1,${t.w - 25},${
      t.h - 20
    })"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="7" cy="0" r="2" fill="#ffffff"></circle><circle cx="14" cy="0" r="2" fill="#ffffff"></circle></g>`;
  }),
  ...
  (OrgChart.templates.group_dotted_lines.padding = [50, 20, 35, 20]),
  ...
  (OrgChart.templates.clara.img_0 = function (t, e, r, i, n) {
    var a = 50,
      o = 30,
      s = 40;
    t.stChildren.length || ((s = 60), (a = t.w / 2), (o = 70));
    var l = OrgChart.randomId();
    return `<clipPath id="${l}"><circle cx="${a}" cy="${o}" r="${s}"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#${l})" xlink:href="${n}" x="${
      a - s
    }" y="${o - s}" width="${2 * s}" height="${2 * s}" ></image>`;
  }),
  (OrgChart.templates.clara.treeListMaxHeight = 387),
  (OrgChart.templates.clara.field_0 = function (t, e, r, i, n) {
    var a = 65,
      o = t.w / 2,
      s = "middle",
      l = t.w - 100;
    return (
      t.stChildren.length ||
        ((s = "middle"), (o = t.w / 2), (a = 160), (l = t.w - 20)),
      OrgChart.wrapText(
        n,
        `<text style="font-size: 20px;" fill="#ffffff" x="${o}" y="${a}" text-anchor="${s}"></text>`,
        l,
        1
      )
    );
  }),
  (OrgChart.templates.clara.field_1 = function (t, e, r, i, n) {
    var a = 35,
      o = t.w - 15,
      s = "end",
      l = t.w - 100;
    return (
      t.stChildren.length ||
        ((s = "middle"), (o = t.w / 2), (a = 180), (l = t.w - 20)),
      OrgChart.wrapText(
        n,
        `<text style="font-size: 14px;" fill="#ffffff" x="${o}" y="${a}" text-anchor="${s}"></text>`,
        l,
        1
      )
    );
  }),
  (OrgChart.templates.clara.nodeMenuButton = function (t, e, r, i) {
    return `<g style="cursor:pointer;" transform="matrix(1,0,0,1, ${
      t.w - 35
  ...
  (OrgChart.templates.clara.node = function (t, e, r, i) {
    return `<rect   x="0" y="0" height="${t.h}" width="${t.w}" fill="#039BE5" stroke-width="1" stroke="#aeaeae" rx="10" ry="10"></rect>`;
  }),
  (OrgChart.templates.treeListItem = Object.assign({}, OrgChart.templates.ana)),
  (OrgChart.templates.treeListItem.size = [350, 60]),
  (OrgChart.templates.treeListItem.field_0 = function (t, e, r, i, n) {
    var a = t.level * r.expandCollapseSize + 45,
      o = "dark" == i.mode ? "#ccc" : "#757575";
    return OrgChart.wrapText(
      n,
      `<text fill="${o}"  x="${a}" y="27" style="font-size:16px;"></text>`,
      t.w - a - 70,
      1
    );
  }),
  (OrgChart.templates.treeListItem.field_1 = function (t, e, r, i, n) {
    var a = t.level * r.expandCollapseSize + 45,
      o = "dark" == i.mode ? "#ccc" : "#757575";
    return OrgChart.wrapText(
      n,
      `<text fill="${o}" x="${a}" y="47" style="font-size:12px;"></text>`,
      t.w - a - 70,
      1
    );
  }),
  (OrgChart.templates.treeListItem.img_0 = function (t, e, r, i, n) {
    var a = t.w - 55,
      o = t.h / 2,
      s = t.h / 2 - 4,
      l = OrgChart.randomId();
  ...
  (OrgChart.templates.treeListItem.plus = function (t, e, r, i) {
    var n = r.expandCollapseSize / 2 + t.level * r.expandCollapseSize,
      a = t.h / 2;
    a -= r.expandCollapseSize / 2;
    var o = "dark" == i.mode ? "#ccc" : "#757575";
    return `<g transform="matrix(1,0,0,1,${n},${a})"><text x="6" style="font-size: 10px;" fill="${o}" y="15.5" text-anchor="end">${t.deepCollapsedChildCount}</text><path fill="${o}" d="M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z" /><rect style="opacity: 0" x="-3" y="-3" width="30" height="30"></rect></g>`;
  }),
  (OrgChart.templates.treeListItem.minus = function (t, e, r, i) {
    var n = r.expandCollapseSize / 2 + t.level * r.expandCollapseSize,
      a = t.h / 2;
    return `<g transform="matrix(1,0,0,1,${n},${(a -=
      r.expandCollapseSize / 2)})"><path fill="${
      "dark" == i.mode ? "#ccc" : "#757575"
    }" d="M7.42,8.59L12,13.17L16.59,8.59L18,10L12,16L6,10L7.42,8.59Z" /><rect style="opacity: 0" x="-3" y="-3" width="30" height="30"></rect></g>`;
  }),
  (OrgChart.templates.treeListItem.nodeMenuButton = function (t, e, r, i) {
    var n = "dark" == i.mode ? "#ccc" : "#757575";
    return `<g style="cursor:pointer;" transform="matrix(1,0,0,1, ${
      t.w - 36
    }, ${
      t.h / 2 - 13
  ...
  (OrgChart.templates.treeListItem.node = function (t, e, r, i) {
    var n = "",
      a = "#FFFFFF";
    if (
      (t.isTreeListItem && !t.stParent) ||
      (t.isTreeListItem && t.stParent && t.stParent.stChildren[0] != t)
    ) {
      var o = "#E0E0E0";
      "dark" == i.mode && (o = "#444444"),
        (n = `<line stroke="${o}" stroke-width="1" x1="0" x2="${t.w}" y1="0" y2="0"></line>`);
    }
    return (
      "dark" == i.mode && (a = "#252526"),
      `<rect fill="${a}" x="0" y="0" height="${t.h}" width="${t.w}"  rx="0" ry="0" ></rect>${n}`
    );
  }),
  (OrgChart.ui = {
    _defsIds: {},
    ...
    pointer: function (t, e, r) {
      if (e === OrgChart.action.exporting) return "";
      var i = OrgChart.t(t.template, !1, r).pointer;
      return i || (i = ""), i;
    },
    aiButton: function (t) {
      return t.enableAI
        ? '<div data-boc-ai-button class="boc-ai-button">AI</div>'
        : "";
    },
    node: function (t, e, r, i, n, a, o, s, l, h, c) {
      var d = OrgChart.t(t.templateName, t.min, l),
        g = "";
      "function" == typeof d.node
        ? (g = d.node(t, e, d, i))
        : OrgChart.isNEU(d.node) ||
          ((g = d.node) &&
            (g = g.replaceAll("{w}", t.w).replaceAll("{h}", t.h))),
        d.defs &&
          (g = g.replaceAll("{randId}", OrgChart.ui._defsIds[t.templateName])),
      ...
      for (var u in o) {
        ...
        e && (f = e[m]),
          ...
          (p.value = f);
        var C = !1;
        "function" == typeof p.element &&
          ((C = !0), (p.element = p.element(t, e, d, i, p.value)));
        var b = OrgChart._lblIsImg(i, u);
        if (
          ((p.name = m),
          (p.field = u),
          !1 !== OrgChart.events.publish("field", [h, p]) &&
            null != p.value &&
            null != p.value &&
            null != p.element)
        )
          if (C) g += p.element;
          else if (!b || (b && !OrgChart.isNEU(p.value))) {
            if (!b && "string" == typeof p.value) {
              var x = p.element;
              x &&
                (x = x
                  .replaceAll("{ew}", t.w - (t.padding ? t.padding[1] : 0))
                  .replaceAll("{cw}", t.w / 2)),
                (p.value = OrgChart.wrapText(p.value, x));
            }
      ...
      var O = OrgChart._getPosition(r, t, n, a),
        y = "node";
      Array.isArray(t.tags) && t.tags.length && (y += " " + t.tags.join(" ")),
        t.layout && (y += " tree-layout"),
        c && (y += " treelist-pinned");
      var _ = "";
      t.lcn && (_ = 'lcn="' + t.lcn + '"');
      var w = OrgChart.nodeOpenTag
          .replace("{lcn}", _)
          .replace("{id}", t.id)
          .replace("{class}", y)
          .replace("{sl}", t.sl)
          ...
          .replace("{x}", O.x)
          .replace("{y}", O.y),
        k = OrgChart._getOpacity(r, t);
      return (g =
        (w = w.replace("{opacity}", k)) +
        (g += OrgChart.ui.nodeBtns(i, t, e, s, d, h)) +
        OrgChart.grCloseTag);
    },
    nodeBtns: function (t, e, r, i, n, a) {
      var o = "";
      return (
        null == t.nodeMenu ||
          e.isSplit ||
          i === OrgChart.action.exporting ||
          ("function" == typeof n.nodeMenuButton
            ? (o += n.nodeMenuButton(e, r, n, t))
        ...
        o &&
          (o = `<g style="cursor:pointer;" ${OrgChart.attr.control_node_menu_id}="${e.id}">${o}</g>`),
        null == t.nodeCircleMenu ||
          e.isSplit ||
          i === OrgChart.action.exporting ||
          OrgChart.isNEU(n.nodeCircleMenuButton) ||
          (o +=
            '<g style="cursor:pointer;" transform="matrix(1,0,0,1,' +
            n.nodeCircleMenuButton.x +
            "," +
            n.nodeCircleMenuButton.y +
            ')" ' +
            OrgChart.attr.control_node_circle_menu_id +
            '="' +
            e.id +
            '"><circle cx="0" cy="0" fill="' +
            n.nodeCircleMenuButton.color +
            '" r="' +
            n.nodeCircleMenuButton.radius +
            '" stroke-width="1" stroke="' +
            n.nodeCircleMenuButton.stroke +
            '"></circle><line x1="-' +
            n.nodeCircleMenuButton.radius / 2 +
            '" y1="-6" x2="' +
            n.nodeCircleMenuButton.radius / 2 +
    ...
    expandCollapseBtn: function (t, e, r, i, n, a, o) {
      var s = "";
      if (a !== OrgChart.action.exporting && !e.isSplit) {
        var l = n[e.lcn ? e.lcn : "base"],
          h = OrgChart.t(e.templateName, e.min, o);
        if (e.childrenIds.length > 0) {
          ...
          var p = OrgChart._getDefailtPositionForExpandCollpase(l, e),
            u = {
              x: p.x + e.x - h.expandCollapseSize / 2,
              y: p.y + e.y - h.expandCollapseSize / 2,
            },
            f = t.getCollapsedIds(e);
          f.length
            ? ("function" == typeof h.plus
                ? ((s += OrgChart.expcollOpenTag
                    .replace("{id}", e.id)
                    .replace("{x}", e.x)
                    .replace("{y}", e.y)),
                  (s += h.plus(e, r, h, i, p)))
            ...
            : ("function" == typeof h.minus
                ...
                : ((s += OrgChart.expcollOpenTag
                  ...
                  (s += h.minus)),
              (s += OrgChart.grCloseTag)),
            ((f.length && "function" != typeof h.plus) ||
              (!f.length && "function" != typeof h.minus)) &&
              (-1 != s.indexOf("{collapsed-children-count}") &&
                (s = s.replace(
                  "{collapsed-children-count}",
                  e.collapsedChildCount
                )),
              -1 != s.indexOf("{collapsed-children-total-count}") &&
                (s = s.replace(
                  "{collapsed-children-total-count}",
                  e.deepCollapsedChildCount
                )),
              -1 != s.indexOf("{children-count}") &&
                (s = s.replace("{children-count}", e.childCount)),
              -1 != s.indexOf("{children-total-count}") &&
                (s = s.replace("{children-total-count}", e.deepChildCount)));
        }
        t._nodeHasHiddenParent(e) &&
          ((s += OrgChart.upOpenTag
            .replace("{id}", e.id)
            .replace("{x}", e.x)
            .replace("{y}", e.y)),
          (s += h.up),
    ...
    link: function (t, e, r, i, n, a, o) {
      var s = t.lcn ? t.lcn : "base",
        l = e._layoutConfigs[s],
        h = OrgChart.t(t.templateName, t.min, r),
        c = [],
        d = [],
        g = l.levelSeparation / 2;
      t.layout > 0 && (g = l.mixedHierarchyNodesSeparation / 2);
      var p = 0,
      ...
      if (t.hasPartners) {
        ...
        for (var C = 0; C < t.children.length; C++) {
          (x = t.children[C]).parentPartner
            ? ((m.ppnodes[x.id] = x.parentPartner),
              m.ids.push(x.id),
              1 == x.parentPartner.isPartner
                ? (-1 == m.rightIds.indexOf(x.parentPartner.id) &&
                    m.rightIds.push(x.parentPartner.id),
                  (m.indexes[x.id] = m.rightIds.indexOf(x.parentPartner.id)),
                  m.firstRight || (m.firstRight = x))
                : 2 == x.parentPartner.isPartner &&
                  (-1 == m.leftIds.indexOf(x.parentPartner.id) &&
                    m.leftIds.push(x.parentPartner.id),
                  (m.indexes[x.id] = m.leftIds.indexOf(x.parentPartner.id)),
                  (m.lastLeft = x)))
            : x.isPartner ||
              ((m.lastLeft = x), m.firstRight || (m.firstRight = x));
        }
      ...
      for (C = 0; C < t.children.length; C++) {
        var b,
          ...
          y = (h = OrgChart.t(x.templateName, x.min, r)).link;
        if (x.isChildOfPartner)
          switch (l.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              var _ = 1 == x.layout ? void 0 : v.minY - (v.minY - f.maxY) / 2;
              O = OrgChart.ui._linkTopToBottom(x.parentPartner, x, h, g, _, e);
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              _ = 1 == x.layout ? void 0 : v.maxY - (v.maxY - f.minY) / 2;
              O = OrgChart.ui._linkBottomToTop(x.parentPartner, x, h, g, _, e);
              break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              _ = 1 == x.layout ? void 0 : v.maxX - (v.maxX - f.minX) / 2;
              O = OrgChart.ui._linkRightToLeft(x.parentPartner, x, h, g, _, e);
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              _ = 1 == x.layout ? void 0 : v.minX - (v.minX - f.maxX) / 2;
              O = OrgChart.ui._linkLeftToRight(x.parentPartner, x, h, g, _, e);
          }
        else if (m && -1 != m.ids.indexOf(x.id))
          switch (l.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              O = OrgChart.ui._linkPpTop(m, t, x, v, f, h);
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              O = OrgChart.ui._linkPpBottom(m, t, x, v, f, h);
              break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              O = OrgChart.ui._linkPpRight(m, t, x, v, f, h);
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              O = OrgChart.ui._linkPpLeft(m, t, x, v, f, h);
          }
        else {
          var w =
              x.isAssistant &&
              x.rightNeighbor &&
              x.rightNeighbor.isAssistant &&
              x.parent == x.rightNeighbor.parent,
            k =
              x.isAssistant &&
              x.leftNeighbor &&
              x.leftNeighbor.isAssistant &&
              x.parent == x.leftNeighbor.parent;
          if ((w || x.layout > 1) && x.rightNeighbor && x.rightNeighbor.isSplit)
            switch (l.orientation) {
              case OrgChart.orientation.top:
              case OrgChart.orientation.top_left:
              case OrgChart.orientation.bottom:
              case OrgChart.orientation.bottom_left:
                O = OrgChart.ui._linkRightToLeft(x.rightNeighbor, x, h, g);
                break;
              case OrgChart.orientation.right:
              case OrgChart.orientation.right_top:
              case OrgChart.orientation.left:
              case OrgChart.orientation.left_top:
                O = OrgChart.ui._linkBottomToTop(x.rightNeighbor, x, h, g);
            }
          else if (
            (k || x.layout > 1) &&
            x.leftNeighbor &&
            x.leftNeighbor.isSplit
          )
            switch (l.orientation) {
              case OrgChart.orientation.top:
              case OrgChart.orientation.top_left:
              case OrgChart.orientation.bottom:
              case OrgChart.orientation.bottom_left:
                O = OrgChart.ui._linkLeftToRight(x.leftNeighbor, x, h, g, e);
                break;
              case OrgChart.orientation.right:
              case OrgChart.orientation.right_top:
              case OrgChart.orientation.left:
              case OrgChart.orientation.left_top:
                O = OrgChart.ui._linkTopToBottom(x.leftNeighbor, x, h, g, e);
            }
          else
            switch (l.orientation) {
              case OrgChart.orientation.top:
              case OrgChart.orientation.top_left:
                if (1 == x.isPartner)
                  O = OrgChart.ui._linkLeftToRight(t, x, h, p);
                else if (2 == x.isPartner)
                  O = OrgChart.ui._linkRightToLeft(t, x, h, p);
                else {
                  _ = 1 == x.layout ? void 0 : v.minY - (v.minY - f.maxY) / 2;
                  O = OrgChart.ui._linkTopToBottom(t, x, h, g, _, e);
                }
                break;
              case OrgChart.orientation.bottom:
              case OrgChart.orientation.bottom_left:
                if (1 == x.isPartner)
                  ...
                  _ = 1 == x.layout ? void 0 : v.maxY - (v.maxY - f.minY) / 2;
                  O = OrgChart.ui._linkBottomToTop(t, x, h, g, _, e);
                }
                break;
              case OrgChart.orientation.right:
              case OrgChart.orientation.right_top:
                if (1 == x.isPartner)
                  O = OrgChart.ui._linkTopToBottom(t, x, h, p);
                else if (2 == x.isPartner)
                  O = OrgChart.ui._linkBottomToTop(t, x, h, p);
                else {
                  _ = 1 == x.layout ? void 0 : v.maxX - (v.maxX - f.minX) / 2;
                  O = OrgChart.ui._linkRightToLeft(t, x, h, g, _, e);
                }
                break;
              case OrgChart.orientation.left:
              case OrgChart.orientation.left_top:
                if (1 == x.isPartner)
                  ...
                  _ = 1 == x.layout ? void 0 : v.minX - (v.minX - f.maxX) / 2;
                  O = OrgChart.ui._linkLeftToRight(t, x, h, g, _, e);
                }
            }
        }
        var I = OrgChart.ui._draggableLinkPath(e, t, x, O, g, l.orientation);
        if (I)
          (b = I),
            (y = y
              .replaceAll("{rounded}", I)
              .replaceAll("{edge}", I)
              .replaceAll("{curve}", b));
        else if (-1 != y.indexOf("{rounded}"))
          if (
            (O.xa == O.xb && O.xa == O.xc && O.xa == O.xd) ||
            (O.ya == O.yb && O.ya == O.yc && O.ya == O.yd)
          )
            (b = "M" + O.xa + "," + O.ya + " L" + O.xd + "," + O.yd),
              (y = y.replaceAll("{rounded}", b));
          else if (
            ...
            (b = "M" + O.xa + "," + O.ya + " L" + O.xd + "," + O.ya),
              (y = y.replaceAll("{rounded}", b));
          else {
            var S = OrgChart.ui._roundedEdge(
                O.xa,
                O.ya,
                O.xb,
                O.yb,
              ...
              L = OrgChart.ui._roundedEdge(O.xb, O.yb, O.xc, O.yc, O.xd, O.yd);
            (b =
              "M" +
              S.x1 +
              "," +
        ...
        c.push(
          OrgChart.linkOpenTag
            .replaceAll("{id}", t.id)
            .replaceAll("{class}", "link " + x.tags.join(" "))
            .replaceAll("{child-id}", x.id)
        );
        var E = { node: t, cnode: x, p: O, html: y, action: a };
        OrgChart.events.publish("render-link", [e, E]),
          c.push(E.html),
          o && d.push({ id: t.id, childId: x.id, html: E.html });
        var A = "";
        for (var N in e.config.linkBinding) {
          var $ = e.config.linkBinding[N],
            M = e._get(x.id);
          if (M) {
            var T = M[$];
            (E.value = T),
              (E.element = h[N]),
              (E.name = $),
              !1 !== OrgChart.events.publish("label", [e, E]) &&
                (OrgChart.isNEU(E.value) ||
                  OrgChart.isNEU(E.element) ||
                  (A += E.element.replace("{val}", E.value)));
          }
        }
        if ("" != A) {
          var P = O.x,
            U = O.y;
          null != x.movey && (U += x.movey),
            (A =
              OrgChart.linkFieldsOpenTag
                .replace("{x}", P)
                .replace("{y}", U)
        ...
        c.push(OrgChart.grCloseTag);
      }
      return o ? d : c.join("");
    },
    svg: function (t, e, r, i, n, a) {
      return OrgChart.t(i.template, !1, a)
        .svg.replace("{w}", t)
        .replace("{h}", e)
        .replace("{viewBox}", r)
    ...
    _roundedEdge: function (t, e, r, i, n, a) {
      var o,
        s,
        l,
      ...
      return (
        (t == r && t == n) || (e == i && e == a)
          ...
          : (t != n &&
              ...
              (s = i),
              e < a ? (c = i + h) : e > a && (c = i - h)),
            t < n && r == n ? (r -= h) : t > n && r == n && (r += h),
            e != a &&
              i == a &&
              ((o = r),
              (s = c = i),
              t < n ? (l = r + h) : t > n && (l = r - h)),
            e < a && i == a ? (i -= h) : e > a && i == a && (i += h)),
        {
          x1: t,
          y1: e,
          x2: r,
    ...
    _linkTopToBottom: function (t, e, r, i, n, a) {
      var o,
        s,
        l,
        h,
      ...
      (o = t.x + t.w / 2 + r.linkAdjuster.toX),
        (s = t.y + t.h + r.linkAdjuster.toY),
        (h = l = e.x + e.w / 2 + r.linkAdjuster.fromX),
        (c = e.y + r.linkAdjuster.fromY);
      var g = {
        xa: o,
        ya: s,
        xb: o,
      ...
      return a && OrgChart._addConnectorLines(a._connectorLines, g), g;
    },
    _linkBottomToTop: function (t, e, r, i, n, a) {
      var o,
        s,
        l,
        h,
        ...
        d = 0;
      (o = t.x + t.w / 2 + r.linkAdjuster.toX),
        (s = t.y + r.linkAdjuster.toY),
        (h = l = e.x + e.w / 2 + r.linkAdjuster.fromX),
        (c = e.y + e.h + r.linkAdjuster.fromY);
      var g = {
        xa: o,
        ya: s,
        xb: o,
    ...
    _linkRightToLeft: function (t, e, r, i, n, a) {
      var o,
        s,
        l,
        h,
      ...
      (o = t.x + r.linkAdjuster.toX),
        (s = t.y + t.h / 2 + r.linkAdjuster.toY),
        (c = e.x + e.w + r.linkAdjuster.fromX),
        (d = h = e.y + e.h / 2 + r.linkAdjuster.fromY),
        (l = s);
      var p = {
        xa: o,
        ya: s,
      ...
      return a && OrgChart._addConnectorLines(a._connectorLines, p), p;
    },
    _linkLeftToRight: function (t, e, r, i, n, a) {
      var o,
        s,
        l,
        h,
    ...
    _linkPpTop: function (t, e, r, i, n, a) {
      var o = t.ppnodes[r.id],
        s = o.y + o.h / 2,
        l = i.minY - (i.minY - n.maxY) / 2,
        h = (i.minY - n.maxY) / t.maxSidePartnersWithChildren / 4,
        c = OrgChart.ui.__linkPpBottomTop(t, e, r, l, h, o),
        d = c.x;
      return (
        (l = c.mid),
        OrgChart.ui._linkTopToBottom({ x: d, y: s, w: 0, h: 0 }, r, a, 0, l)
      );
    },
    _linkPpBottom: function (t, e, r, i, n, a) {
      var o = t.ppnodes[r.id],
        s = o.y + o.h / 2,
        l = i.maxY - (i.maxY - n.minY) / 2,
        h = (i.maxY - n.minY) / t.maxSidePartnersWithChildren / 4,
        c = OrgChart.ui.__linkPpBottomTop(t, e, r, l, h, o),
        d = c.x;
      return (
        (l = c.mid),
        OrgChart.ui._linkBottomToTop({ x: d, y: s, w: 0, h: 0 }, r, a, 0, l)
      );
    },
    _linkPpLeft: function (t, e, r, i, n, a) {
      var o = t.ppnodes[r.id],
        s = i.minX - (i.minX - n.maxX) / 2,
        l = (i.minX - n.maxX) / t.maxSidePartnersWithChildren / 4,
        h = o.x + o.w / 2,
        c = OrgChart.ui.__linkPpLeftRight(t, e, r, s, l, o),
        d = c.y;
      return (
        (s = c.mid),
        OrgChart.ui._linkLeftToRight({ x: h, y: d, w: 0, h: 0 }, r, a, 0, s)
      );
    },
    _linkPpRight: function (t, e, r, i, n, a) {
      var o = t.ppnodes[r.id],
        s = i.maxX - (i.maxX - n.minX) / 2,
        l = (i.maxX - n.minX) / t.maxSidePartnersWithChildren / 4,
        h = o.x + o.w / 2,
        c = OrgChart.ui.__linkPpLeftRight(t, e, r, s, l, o),
        d = c.y;
      return (
        (s = c.mid),
        OrgChart.ui._linkRightToLeft({ x: h, y: d, w: 0, h: 0 }, r, a, 0, s)
      );
    },
    __linkPpBottomTop: function (t, e, r, i, n, a) {
      var o = 0;
      return (
        1 == a.isPartner
          ? ((o =
            ...
            t.lastLeft && o < t.lastLeft.x + t.lastLeft.w / 2
              ? o < r.x + r.w / 2
                ? (i -= (t.indexes[r.id] + 1) * n)
                : (i -= (t.rightIds.length - t.indexes[r.id]) * n)
              : o < r.x + r.w / 2
              ? (i += (t.rightIds.length - t.indexes[r.id]) * n)
              : (i += (t.indexes[r.id] + 1) * n))
          : 2 == a.isPartner &&
            ...
            t.firstRight && o > t.firstRight.x + t.firstRight.w / 2
              ? o < r.x + r.w / 2
                ? (i -= (t.indexes[r.id] + 1) * n)
                : (i -= (t.leftIds.length - t.indexes[r.id]) * n)
              : o < r.x + r.w / 2
              ? (i += (t.leftIds.length - t.indexes[r.id]) * n)
              : (i += (t.indexes[r.id] + 1) * n)),
        { x: o, mid: i }
    ...
    __linkPpLeftRight: function (t, e, r, i, n, a) {
      var o = 0;
      return (
        1 == a.isPartner
          ? ((o =
    ...
    _draggableLinkPath: function (t, e, r, i, n, a) {
      if (r.isSubLevel) return null;
      if (e.isSubLevel) return null;
      if (
        (r.leftNeighbor && r.leftNeighbor.isSplit) ||
        (r.rightNeighbor && r.rightNeighbor.isSplit)
      )
        return null;
      ...
      if (OrgChart._isMoved(r) && !OrgChart._isMoved(e)) {
        ...
        switch (a) {
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
            if (i.yb + n / 2 < i.yd) return null;
            (l = i.xa < i.xd ? r.x - n / 2 : r.x + r.w + n / 2),
              (h = r.y - n / 2);
            break;
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
          ...
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            if (i.xb - n / 2 > i.xd) return null;
            (h = i.ya < i.yd ? r.y - n / 2 : r.y + r.h + n / 2),
              (l = r.x + r.w + n / 2);
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
      ...
      if (!OrgChart._isMoved(r) && OrgChart._isMoved(e)) {
        ...
        switch (a) {
          ...
          case OrgChart.orientation.top_left:
            if (i.ya + n / 2 > i.yb)
              (s = !0),
                (l = i.xa < i.xd ? e.x + e.w + n / 2 : e.x - n / 2),
                (h = e.y + e.h + n);
            else {
              if (i.yb + n / 2 < i.yd) return null;
              (l = i.xa < i.xd ? r.x - n / 2 : r.x + r.w + n / 2),
          ...
          case OrgChart.orientation.right_top:
            if (i.xa - n / 2 < i.xb)
              (s = !0),
                (h = i.ya < i.yd ? e.y + e.h + n / 2 : e.y - n / 2),
                (l = e.x - n);
            else {
              if (i.xb - n / 2 > i.xd) return null;
              (h = i.ya < i.yd ? r.y - n / 2 : r.y + r.h + n / 2),
      ...
      if (OrgChart._isMoved(r) && OrgChart._isMoved(e)) {
        ...
        switch (a) {
          ...
          case OrgChart.orientation.top_left:
            if (i.ya + n > i.yd) {
              var l = i.xa < i.xd ? e.x + e.w + n / 2 : e.x - n / 2,
                h = e.y + e.h + n,
                c = r.y - n;
              o.push(["M", i.xa, i.ya]),
                o.push(["L", i.xa, h]),
              ...
              o.push(["M", i.xa, i.ya]),
                o.push(["L", i.xa, e.y + e.h + n]),
                o.push(["L", i.xc, e.y + e.h + n]),
                o.push(["L", i.xd, i.yd]);
            break;
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
          ...
          case OrgChart.orientation.left_top:
            if (i.xa + n > i.xd) {
              ...
              o.push(["M", i.xa, i.ya]),
                o.push(["L", e.x + e.w + n, i.ya]),
                o.push(["L", e.x + e.w + n, i.yc]),
                o.push(["L", i.xd, i.yd]);
        }
        return OrgChart.roundPathCorners(o, OrgChart.LINK_ROUNDED_CORNERS, !1);
      }
  ...
  (OrgChart._interceptions = function (t, e) {
    ...
    if (Array.isArray(t) && Array.isArray(e))
      for (var i in t) for (var n in e) t[i] == e[n] && r.push(t[i]);
    else if (Array.isArray(t) && !Array.isArray(e))
      for (var i in t) for (var n in e) t[i] == n && r.push(t[i]);
    else if (!Array.isArray(t) && Array.isArray(e))
      for (var i in t) for (var n in e) i == e[n] && r.push(e[n]);
    return r;
  }),
  ...
  (OrgChart._centerPointInPercent = function (t, e, r) {
    var i = t.getBoundingClientRect(),
      n = e - i.left,
      a = r - i.top;
    return [n / (i.width / 100), a / (i.height / 100)];
  }),
  ...
  (OrgChart.getScale = function (t, e, r, i, n, a, o, s) {
    var l = 1;
    if (
      t ||
      (i !== OrgChart.match.boundary && i !== OrgChart.match.boundaryIfOutside)
    )
      if (t || i !== OrgChart.match.width)
        if (t || i !== OrgChart.match.height)
          if (t) {
            var h, c;
            l = (h = e / t[2]) > (c = r / t[3]) ? c : h;
          } else l = i;
        else l = r / s;
      else l = e / o;
    else
      (l = (h = e / o) > (c = r / s) ? c : h),
        i === OrgChart.match.boundaryIfOutside && l > 1 && (l = 1);
    return l && l > n && (l = n), l && l < a && (l = a), l;
  }),
  (OrgChart.isObject = function (t) {
    return (
      ...
      null !== t &&
      t.constructor &&
      "object" == t.constructor.name.toLowerCase()
    );
  }),
  ...
  (OrgChart.htmlRipple = function (t) {
    ...
    var r,
      ...
      n,
      a = document.createElement("div");
    (a.className = "boc-ripple-container"),
  ...
  (OrgChart._moveToBoundaryArea = function (t, e, r, i) {
    ...
    e[0] < r.left &&
      e[0] < r.right &&
      (n[0] = r.left > r.right ? r.right : r.left),
      e[0] > r.right &&
        e[0] > r.left &&
        (n[0] = r.left > r.right ? r.left : r.right),
      e[1] < r.top &&
        e[1] < r.bottom &&
        (n[1] = r.top > r.bottom ? r.bottom : r.top),
      e[1] > r.bottom &&
        e[1] > r.top &&
        (n[1] = r.top > r.bottom ? r.top : r.bottom),
      e[0] !== n[0] || e[1] !== n[1]
        ? OrgChart.animate(
            t,
            { viewBox: e },
  ...
  (OrgChart._pinchMiddlePointInPercent = function (t, e, r, i) {
    var n = OrgChart._getTopLeft(t),
      a = i.touches[0].pageX - n.x,
      o = i.touches[0].pageY - n.y,
      s = i.touches[1].pageX - n.x,
      l = i.touches[1].pageY - n.y;
    return [((a - s) / 2 + s) / (e / 100), ((o - l) / 2 + l) / (r / 100)];
  }),
  ...
  (OrgChart._menuPosition = function (t, e, r) {
    var i = t.getBoundingClientRect(),
      ...
      s = i.top - n.top;
    return (
      i.top + a.height > n.top + n.height && (s -= a.height),
      i.left - a.width < n.left && (o += a.width),
      { x: o, y: s }
    );
  }),
  ...
  (OrgChart.wrapText = function (t, e, r, i) {
    if (null != r && null != i) return OrgChart._lineClamp(e, t, r, i);
    var n = e,
      a = n.toLowerCase();
    if (-1 == a.indexOf("<text")) return OrgChart._escapeHtml(t);
    if (-1 == a.indexOf(OrgChart.attr.width)) return OrgChart._escapeHtml(t);
    if (-1 != a.indexOf("foreignobject")) return OrgChart._escapeHtml(t);
    if (-1 == n.indexOf(OrgChart.attr.width)) return OrgChart._escapeHtml(t);
    ...
    var o = OrgChart._getTestDiv();
    (n = n.replaceAll("{cw}", 0)), (o.innerHTML = "<svg>" + n + "</svg>");
    var s,
      l = new DOMParser()
        .parseFromString(n, "text/xml")
        .getElementsByTagName("text")[0],
      h = parseFloat(l.getAttribute("x")),
      c = parseFloat(l.getAttribute("y")),
      d = l.getAttribute("text-anchor"),
      g =
        ((r = l.getAttribute(OrgChart.attr.width)),
        l.getAttribute(OrgChart.attr.text_overflow)),
      p = "http://www.w3.org/2000/svg",
      u = o.getElementsByTagName("svg")[0].getElementsByTagName("text")[0];
    g || (g = "ellipsis");
    var f = g.split("-");
    if (
      (f.length > 1 &&
        ((i = parseInt(g.split("-")[1])),
        f.length > 2 && "ellipsis" == f[2] && (s = !0)),
      !r)
    )
      return OrgChart._escapeHtml(t);
    if (
      ...
      u.removeChild(u.firstChild), (u.textContent = t);
      for (var m = u.getComputedTextLength(), C = 2; m > r; )
        (u.textContent = t.substring(0, t.length - C)),
          (u.textContent += "..."),
          (m = u.getComputedTextLength()),
          C++;
      return C > 2
        ? `<title>${OrgChart._escapeHtml(t)}</title>${u.textContent}`
        : OrgChart._escapeHtml(t);
    }
    if (-1 != g.indexOf("multiline")) {
      var b = t.split(" "),
        x = u.getBBox().height;
      u.textContent = "";
      var v = document.createElementNS(p, "tspan"),
        O = document.createTextNode(b[0]);
      v.setAttributeNS(null, "x", h),
        v.setAttributeNS(null, "y", c),
        v.setAttributeNS(null, "text-anchor", d),
        v.appendChild(O),
        u.appendChild(v);
      C = 1;
      for (var y = 1, _ = !1, w = 1; w < b.length; w++) {
        var k = v.firstChild.data.length;
        if (
          ((v.firstChild.data += " " + b[w]), v.getComputedTextLength() > r)
        ) {
          if (
            ((v.firstChild.data = v.firstChild.data.slice(0, k)),
            y++,
            i && y > i)
          ) {
            if (s && u.children.length == i) {
              var I = u.children[i - 1].textContent;
              (u.children[i - 1].textContent =
          ...
          (v = document.createElementNS(p, "tspan")).setAttributeNS(
            ...
            v.setAttributeNS(null, "y", c + x * C),
            v.setAttributeNS(null, "text-anchor", d),
            (O = document.createTextNode(b[w])),
            v.appendChild(O),
            u.appendChild(v),
            C++;
        }
      ...
      var S = "";
      if (null != u.innerHTML) (S = u.innerHTML), (u.innerHTML = "");
      else {
        var L = "";
        for (w = u.childNodes.length - 1; w >= 0; w--)
          (L = XMLSerializer().serializeToString(u.childNodes[w]) + L),
            u.removeChild(u.childNodes[w]);
        S = L;
      }
      return _ ? `<title>${OrgChart._escapeHtml(t)}</title>${S}` : S;
    }
  }),
  (OrgChart._downloadFile = function (t, e, r, i, n) {
    ...
    if (1 == i) {
      ...
      if (void 0 !== s.download) {
        ...
        var l = r;
        l.toLowerCase().endsWith(n.toLowerCase()) || (l = l + "." + n),
  ...
  (OrgChart._getPosition = function (t, e, r, i) {
    var n = { x: e.x, y: e.y };
    if ((null != r && (n.x = r), null != i && (n.y = r), t && 3 == t.length)) {
      var a = t[0].indexOf(e.id);
      -1 != a &&
        null != t[1][a].transform &&
        (null == r && (n.x = t[1][a].transform[4]),
        null == i && (n.y = t[1][a].transform[5]));
    }
    return n;
  }),
  ...
  (OrgChart.t = function (t, e, r) {
    ...
    if (null != r && i.scaleLessThen) {
      ...
      if (a.length > 0) {
        ...
        var l = i.scaleLessThen[a[0]];
        for (var h in l) null == n && (n = Object.assign({}, i)), (n[h] = l[h]);
      }
    }
    return e
      ? null == n
  ...
  (OrgChart._imgs2base64 = function (t, e, r, i) {
    ...
    for (var o = 0; o < a; o++)
      (function () {
        var t = o,
          e = n[t];
        OrgChart._getDataUri(e.getAttribute(r), function (n) {
          n.success && e.setAttribute(r, n.result), t == a - 1 && i();
        });
      })();
  }),
  ...
  (OrgChart._csvToArray = function (t, e) {
    ...
    for (
      ...
      var a,
        o = n[1];
      o.length && o !== e && i.push([]),
        (a = n[2] ? n[2].replace(new RegExp('""', "g"), '"') : n[3]),
        i[i.length - 1].push(a);
    }
    return i;
  }),
  (OrgChart._json2xml = function (t) {
    for (
      ...
      var n = e.createElement("node"),
        a = t[i];
      for (var o in a) {
        var s = a[o];
        n.setAttribute(o, OrgChart._convertArrayToString(s));
      }
      r.appendChild(n);
    }
    return (
  ...
  (OrgChart._xml2json = function (t) {
    for (
      ...
      for (var n = e[i], a = {}, o = 0; o < n.attributes.length; o++) {
        var s = n.attributes[o];
        a[s.name] = OrgChart._convertStringToArray(s.name, s.value);
      }
      r.push(a);
    }
    return r;
          ...
          for (var r = "", i = 0; i < e.length; i++) {
            ...
            (n =
              "reportsTo" == e[i]
                ...
                : null == t[e[i]]
                ? ""
                : t[e[i]]) instanceof Date && (n = n.toLocaleString());
            var a = (n = null === n ? "" : n.toString()).replace(/"/g, '""'),
              o = new RegExp('("|;|\n)', "g");
            a.search(o) >= 0 && (a = '"' + a + '"'),
  ...
  (OrgChart._isTouchDevice = function () {
  ...
  (OrgChart.childrenTotalCount = function (t, e) {
    for (var r = 0, i = 0; i < e.childrenIds.length; i++) {
      var n = t.nodes[e.childrenIds[i]];
      n && (r++, (r += OrgChart.childrenTotalCount(t, n)));
    }
    return r;
  }),
  ...
  (OrgChart.collapsedChildrenTotalCount = function (t, e, r) {
    for (var i = 0, n = 0; n < e.childrenIds.length; n++) {
      var a = t.nodes[e.childrenIds[n]];
      a &&
        ((r || !0 === a.collapsed) && i++,
        (i += OrgChart.collapsedChildrenTotalCount(t, a, !0)));
    }
    return i;
  }),
  (OrgChart._setMinMaxXY = function (t, e, r) {
    (r && t.isTreeListItem) ||
  ...
  (OrgChart.gradientCircleForDefs = function (t, e, r, i) {
    function n(t, e, r, i) {
      ...
      return { x: t + r * Math.cos(n), y: e + r * Math.sin(n) };
    }
    function a(t, e, r, i, a) {
      var o = n(t, e, r, a),
        s = n(t, e, r, i),
        l = a - i <= 180 ? "0" : "1";
      return ["M", o.x, o.y, "A", r, r, 0, l, 0, s.x, s.y].join(" ");
    }
    return (
      ...
      `<linearGradient id="${t}_linearColors1" x1="0" y1="0" x2="1" y2="1">\n            <stop offset="0%" stop-color="${
        ...
        e[0]
      }"></stop>\n        </linearGradient>        \n        <g id="${t}">\n            <path stroke-width="${i}" fill="none" stroke="url(#${t}_linearColors1)" d="${a(
        r,
        r,
        r,
        1,
        60
      )}"  />\n            <path stroke-width="${i}" fill="none" stroke="url(#${t}_linearColors2)" d="${a(
        r,
        r,
        r,
        60,
        120
      )}"/>\n            <path stroke-width="${i}" fill="none" stroke="url(#${t}_linearColors3)" d="${a(
        r,
        r,
        r,
        120,
        180
      )}" />\n            <path stroke-width="${i}" fill="none" stroke="url(#${t}_linearColors4)" d="${a(
        r,
        r,
        r,
        180,
        240
      )}" />\n            <path stroke-width="${i}" fill="none" stroke="url(#${t}_linearColors5)" d="${a(
        r,
        r,
        r,
        240,
        300
      )}" />\n            <path stroke-width="${i}" fill="none" stroke="url(#${t}_linearColors6)" d="${a(
        r,
        r,
        r,
        300,
  ...
  (OrgChart.convertCsvToNodes = function (t) {
    for (
      var e = OrgChart._csvToArray(t), r = e[0], i = [], n = 1;
      n < e.length;
      n++
    ) {
      for (var a = {}, o = 0; o < e[n].length; o++) {
        var s = r[o],
          l = e[n][o];
        a[r[o]] = OrgChart._convertStringToArray(s, l);
      }
      "" != a.id.trim() && i.push(a);
    }
    return i;
      ...
      for (var c = 1; c < t.length; c++) {
        ...
        if (
          ...
          var u,
            ...
            b = o(p);
          r
            ? ((u = n(C, d.origPoint || m, e)), (f = n(C, p.origPoint || b, e)))
            : ((u = i(C, m, e)), (f = i(C, b, e))),
            a(g, u),
            (g.origPoint = C),
            s.push(g);
          var x = n(u, C, 0.5),
            v = n(C, f, 0.5),
            O = ["C", x.x, x.y, v.x, v.y, f.x, f.y];
          (O.origPoint = C), s.push(O);
        } else s.push(g);
      }
      if (h) {
        var y = o(s[s.length - 1]);
        s.push(["Z"]), a(s[0], y);
      }
    } else s = t;
  ...
  (OrgChart._getDynamicGridCoulumns = function (t) {
    for (var e = 1; e < t && !(t / e - e <= 0); e++);
    return e % 2 != 0 && e > 2 && e--, e;
  }),
  (OrgChart._getLazyLoading = function (t) {
    var e = t.lazyLoading;
    return "auto" == e && (e = !!(t && t.nodes && t.nodes.length > 700)), e;
  }),
  (OrgChart._getSvgAttributes = function (t) {
    const e = t.match(/width="([\d.]+)"/),
      r = t.match(/height="([\d.]+)"/),
      i = t.match(/x="([\d.]+)"/),
      n = t.match(/y="([\d.]+)"/),
      a = t.match(/viewBox="([^"]+)"/),
      o = e ? parseFloat(e[1]) : 0,
      s = r ? parseFloat(r[1]) : 0,
      l = i ? parseFloat(i[1]) : 0,
      h = n ? parseFloat(n[1]) : 0;
    let c = [0, 0, 0, 0];
    return (
      a && ((c = a[1]), (c = JSON.parse(`[${c}]`))),
      { width: o, height: s, viewBox: c, x: l, y: h }
    );
  }),
  (OrgChart._setSvgAttributes = function (t, e) {
    var r = e.x,
      i = e.y,
      n = e.width,
      a = e.height,
      o = e.viewBox.join(",");
    const s = t.match(/<svg\s+([^>]*?)>/);
    if (!s) return t;
    let l = s[0],
      h = s[1];
    const c = (t, e, r) => {
      if (null == r) return t;
      const i = new RegExp(`\\s*${e}="[^"]*"`, "i"),
        n = ` ${e}="${r}"`;
      return t.match(i) ? t.replace(i, n) : t + n;
    };
    (h = c(h, "x", r)),
      (h = c(h, "y", i)),
      (h = c(h, "width", n)),
  ...
  (OrgChart._convertTextToNodes = function (t, e) {
    const r = t.split(/\r?\n/).filter((t) => "" !== t.trim()),
      i = [];
    let n = 1;
    const a = [];
    for (let t of r) {
      let r = 0;
      for (; t.startsWith(e); ) (t = t.slice(e.length)), r++;
      if (((t = t.trim()), !t)) continue;
      const o = t.match(/^\[([^\]]+)](.*)$/);
      if (o) {
        const t = o[1].trim(),
          e = o[2].trim();
        a.length > 0 && (a[a.length - 1][t] = e);
        continue;
      }
      const s = t.match(/^([^\(]+)\(([^)]+)\)$/);
      let l,
        h = [];
      s
        ? ((l = s[1].trim()), (h = s[2].split(",").map((t) => t.trim())))
        : (l = t);
      const c = {
        id: n++,
        pid: 0 === r ? null : a[r - 1].id,
        name: l,
        tags: h,
      };
      (a[r] = c), (a.length = r + 1), i.push(c);
    }
    return i;
  }),
  (OrgChart._convertFromNodesToText = function (t, e) {
    const r = {},
      i = [];
    function n(t, r) {
      const i = e.repeat(r);
      ...
      for (const e of Object.keys(t))
        ["id", "pid", "name", "children", "tags"].includes(e) ||
          (a += i + "[" + e + "]" + t[e] + "\n");
      for (const e of t.children) a += n(e, r + 1);
      return a;
    }
    return (
      t.forEach((t) => {
      ...
      t.forEach((t) => {
        t.pid && r[t.pid] ? r[t.pid].children.push(r[t.id]) : i.push(r[t.id]);
      }),
      i
        .map((t) => n(t, 0))
        .join("")
  ...
  (OrgChart._onClickHandler = function (t, e, r, i, n) {
    var a;
    if (void 0 === r)
      if ("add" === e) {
        var o = { id: t.generateId(), pid: i };
        t.addNode(o, null, !0);
      } else if ("edit" === e) {
        var s = t.getNode(i);
        t.editUI.show(s.id);
        ...
        s = t.getNode(i);
        t.editUI.show(s.id, !0);
      } else if ("remove" === e) t.removeNode(i, null, !0);
      else if ("svg_export" === e || "svg" === e) {
        var l = {};
        OrgChart.isNEU(i) || (l.pages = [{ nodeId: i }]), t.exportToSVG(l);
      } else if ("pdf_export" === e || "pdf" === e) {
        l = {};
        OrgChart.isNEU(i) || (l.pages = [{ nodeId: i }]), t.exportToPDF(l);
      } else if ("png_export" === e || "png" === e) {
        l = {};
        OrgChart.isNEU(i) || (l.pages = [{ nodeId: i }]), t.exportToPNG(l);
      } else if ("visio_export" === e || "visio" === e)
        t.exportToVisio({ nodeId: i });
      else if ("pp_export" === e || "powerpoint" === e) t.exportToPowerPoint();
      else if ("pp_preview" === e || "pppreview" === e) {
        l = {
          parentLevels: 0,
          childLevels: 1,
          expandChildren: !1,
        ...
        null != i && ((l.expandChildren = !1), (l.pages[0].nodeId = i)),
          t.powerPointPreviewUI.show(l);
      } else if ("pdf_preview" === e || "pdfpreview" === e) {
        l = {
          parentLevels: 0,
          childLevels: 1,
          expandChildren: !1,
        ...
        null != i && ((l.expandChildren = !1), (l.pages[0].nodeId = i)),
          t.pdfPreviewUI.show(l);
      } else if ("svg_preview" === e || "svgpreview" === e) {
        l = {
          parentLevels: 0,
          childLevels: 1,
          expandChildren: !1,
        ...
        null != i && ((l.expandChildren = !1), (l.pages[0].nodeId = i)),
          t.svgPreviewUI.show(l);
      } else if ("png_preview" === e || "pngpreview" === e) {
        l = {
          parentLevels: 0,
          childLevels: 1,
          expandChildren: !1,
        ...
        null != i && ((l.expandChildren = !1), (l.pages[0].nodeId = i)),
          t.pngPreviewUI.show(l);
      } else
        "csv_export" === e || "csv" === e
          ? t.exportToCSV({ nodeId: i })
          : "xml_export" === e || "xml" === e
          ? t.exportToXML({ nodeId: i })
          : "json_export" === e || "json" === e
          ? t.exportToJSON({ nodeId: i })
          : "fit" === e
          ? t.fit()
          : "expand_all" === e
          ? t.expand(null, "all")
          ...
          : "zoom_in" === e
          ? t.zoom(!0, null, !0)
          : "zoom_out" === e || "zoom_out" === e
          ? t.zoom(!1, null, !0)
          : "layout_mixed" === e
          ? t.setLayout(OrgChart.layout.mixed)
          : "layout_normal" === e
          ? t.setLayout(OrgChart.layout.normal)
          : "layout_right_offset" === e
          ? t.setLayout(OrgChart.layout.treeRightOffset)
          : "layout_left_offset" === e
          ? t.setLayout(OrgChart.layout.treeLeftOffset)
          : "layout_tree" === e
          ? t.setLayout(OrgChart.layout.tree)
          : "layout_grid" === e && t.setLayout(OrgChart.layout.grid);
    else a = r.call(t, i, n);
    return a;
  }),
  (OrgChart._isSVG = function (t) {
    if ("string" != typeof t) return !1;
    const e = t.trim();
    if (!e.startsWith("<svg") || !e.endsWith("</svg>")) return !1;
    try {
      const t = new DOMParser().parseFromString(e, "image/svg+xml");
      return (
        !t.querySelector("parsererror") &&
        "svg" === t.documentElement.nodeName.toLowerCase()
      );
    } catch {
      return !1;
    }
  }),
  (OrgChart._treeListAdjustToSTNodePostition = function (t, e) {
    for (var r of t)
      (r.y += e.y + e.padding[0]),
        (r.x += e.x + e.padding[3]),
        OrgChart._treeListAdjustToSTNodePostition(r.children, e);
  }),
  (OrgChart._treeListSetProps = function (t, e) {
    var r = -t.treeList.scrollTop,
      i = { nodesByLevels: [], lastNode: null, y: 0 };
    (t.treeList.pinnedIds = []), OrgChart._treeListIterate(t.stChildren, i, -1);
    var n =
      i.lastNode.y +
      i.lastNode.h -
      0 -
      (t.treeList.maxHeight - t.padding[0] - t.padding[2]);
    r > 0 || n < 0 ? (r = 0) : 0 != r && -1 * r > n && (r = -n);
    for (var a = i.nodesByLevels.length - 1; a >= 0; a--)
      for (var o = i.nodesByLevels[a], s = o.length - 1; s >= 0; s--) {
        for (
          var l = (f = o[s]).y, h = 0, c = f.parent;
          c && ((h += c.h), c.parent);

        )
          c = c.parent;
        if (f.children.length && f.y + r <= h) {
          l = -r + h;
          var d = o[s + 1];
          if ((d && d.y < l + f.h && (l = d.y - f.h), c)) {
            var g = t.stChildren.indexOf(c);
            if (t.stChildren.length > g + 1) {
              var p = t.stChildren[g + 1];
              p.y < l + f.h && (l = p.y - f.h);
            }
          }
        }
        f.y != l && t.treeList.pinnedIds.push(f.id), (f.y = l), (f.x = 0);
      }
    if (e == OrgChart.orientation.bottom) {
      var u = i.lastNode.y + i.lastNode.h;
      for (var a of i.nodesByLevels) for (var f of a) f.y = u - f.y - f.h;
    }
    (t.treeList.scrollTop = -r), (t.treeList.scrollTopMax = n);
  }),
  (OrgChart._treeListIterate = function (t, e, r) {
    for (var i of (r++, t))
      (i.y = e.y),
        (e.y += i.h),
        e.nodesByLevels[r] || (e.nodesByLevels[r] = []),
        e.nodesByLevels[r].push(i),
        (e.lastNode = i),
        OrgChart._treeListIterate(i.children, e, r);
  }),
  (OrgChart._treeListGetTumbPositionFromScrollTop = function (t) {
    var e = t.h - t.padding[0] - t.padding[2],
      r = e / ((t.treeList.scrollTopMax + e) / 100),
      i = (e / 100) * r,
      n = e - i,
      a = -t.treeList.scrollTop / (t.treeList.scrollTopMax / 100),
      o = t.y + t.padding[0] + a * (n / -100),
      s = "initial";
    return (
      (isNaN(i) || isNaN(o) || i < 0 || r > 100) &&
        ((s = "none"), (i = 0), (o = 0)),
      { thumbHeight: i, thumbPosition: o, scrollBarDisplay: s }
    );
  }),
  (OrgChart._treeListGetScrollTopFromTumbPosition = function (t, e, r) {
    var i = t.h - t.padding[0] - t.padding[2] - e,
      n =
        ((((r - (t.y + t.padding[0])) / i) * 100) / 100) *
        t.treeList.scrollTopMax;
    return (
      (isNaN(n) || n < 0) && (n = 0),
      n > t.treeList.scrollTopMax && (n = t.treeList.scrollTopMax),
      n
    );
  }),
  (OrgChart._getCenterNodeFromParams = function (t, e) {
    var r = t[e.id];
    if (r) {
      if (r.isTreeListItem) {
        for (; !r.stParent; ) r = r.parent;
        r = r.stParent;
      }
      return r;
    }
  ...
  (OrgChart._getScrollTopForNode = function (t, e) {
    var r = { nodesByLevels: [], lastNode: null, y: 0 };
    OrgChart._treeListIterate(t.stChildren, r, -1);
    var i = null;
    for (var n of r.nodesByLevels) {
      for (var a of n)
        if (a.id == e) {
          i = a;
          break;
    ...
    for (var o = 0, s = i.parent; s && ((o += s.h), s.parent); ) s = s.parent;
    var l = t.padding[0],
      h = t.padding[2],
      c = t.treeList.maxHeight - l - h,
      d = r.lastNode.y + r.lastNode.h - c;
    d < 0 && (d = 0);
    var g = t.treeList.scrollTop,
      p = i.y - o,
      u = i.y + i.h - c,
      f = g;
    return (
      i.y < g + o ? (f = p) : i.y + i.h > g + c && (f = i.h > c - o ? p : u),
      f < 0 ? (f = 0) : f > d && (f = d),
      f
    );
  }),
  (OrgChart._getDefailtPositionForExpandCollpase = function (t, e) {
    var r = { x: 0, y: 0 };
  ...
  (OrgChart._measureCache = { svg: null, text: null }),
  (OrgChart._getMeasureElement = function () {
    if (OrgChart._measureCache.svg) return OrgChart._measureCache.text;
    const t = "http://www.w3.org/2000/svg";
    return (
      (OrgChart._measureCache.svg = document.createElementNS(t, "svg")),
      (OrgChart._measureCache.svg.id = "orgchart_js_test__measure"),
      (OrgChart._measureCache.svg.style.cssText =
        "position:absolute;top:-9999px;visibility:hidden;white-space:pre;"),
      (OrgChart._measureCache.text = document.createElementNS(t, "text")),
      OrgChart._measureCache.svg.appendChild(OrgChart._measureCache.text),
      document.body.appendChild(OrgChart._measureCache.svg),
      OrgChart._measureCache.text
    );
  }),
  (OrgChart._lineClamp = function (t, e, r, i) {
    if (void 0 === e || null == e) return "";
    "string" != typeof e && (e = e.toString()), (e = OrgChart._escapeHtml(e));
    const n = /(\w+(?:-\w+)?)="([^"]*)"/g,
      a = {};
    let o;
    for (; null !== (o = n.exec(t)); ) a[o[1]] = o[2];
    const s = OrgChart._getMeasureElement();
    s.textContent = "";
    for (const [t, e] of Object.entries(a))
      "x" !== t && "y" !== t && s.setAttribute(t, e);
    const l = (t) => ((s.textContent = t), s.getComputedTextLength()),
      h = e.split(" "),
      c = [];
    let d = "",
      g = 0;
    for (; g < h.length && c.length < i; ) {
      const t = h[g],
        e = d ? d + " " + t : t;
      if (l(e) <= r) (d = e), g++;
      else if ("" === d) {
        ...
        for (; e <= i; ) {
          let a = (e + i) >> 1;
          l(t.slice(0, a)) <= r ? ((n = a), (e = a + 1)) : (i = a - 1);
        }
        c.push(t.slice(0, n)), (h[g] = t.slice(n));
      } else c.push(d), (d = "");
    }
    d && c.length < i && c.push(d);
    let p =
      g < h.length || (g === h.length && "" === h[g - 1] && e.endsWith(" "));
    if (p && c.length > 0) {
      let t = c[c.length - 1],
        e = 0,
        i = t.length,
        n = "";
      for (; e <= i; ) {
        let a = Math.floor((e + i) / 2),
          o = t.substring(0, a) + "...";
        l(o) <= r ? ((n = o), (e = a + 1)) : (i = a - 1);
      }
      c[c.length - 1] = n;
    }
    const u = ` x="${a.x || "0"}"`,
      f =
        1 === c.length
          ...
          : c
              .map(
                (t, e) =>
                  `<tspan${u} dy="${0 === e ? 0 : "1.2em"}">${t}</tspan>`
              )
              .join("");
    return `<text${Object.entries(a)
      .map(([t, e]) => ` ${t}="${e}"`)
      .join("")}>${p ? `<title>${e}</title>` : ""}${f}</text>`;
  }),
  (OrgChart._getScrollableTreeListNodeInTouchEnabledDevice = function (t) {
    if (!t || !t.isTreeListItem || !OrgChart._isTouchDevice()) return null;
    var e = OrgChart.getRootOf(t).stParent,
      {
        thumbHeight: r,
        thumbPosition: i,
        scrollBarDisplay: n,
      } = OrgChart._treeListGetTumbPositionFromScrollTop(e);
    return "none" == n ? null : e;
  }),
  (OrgChart._convertImagesToBase64 = async function (t) {
    const e = new DOMParser();
    return await Promise.all(
      t.map(async (t) => {
        const r = e.parseFromString(t, "image/svg+xml"),
          i = r.querySelectorAll("image");
        for (const t of i) {
          ...
          if (e && !e.startsWith("data:"))
            try {
              ...
              if (r > 0 && i > 0) {
                const n = await OrgChart._resizeAndConvert(e, r, i);
                t.setAttribute("href", n),
                  t.removeAttributeNS("http://www.w3.org/1999/xlink", "href");
              }
            } catch (t) {
              console.error("Failed to process image:", e, t);
            }
        }
  ...
  (OrgChart._resizeAndConvert = function (t, e, r) {
      ...
      (a.crossOrigin = "anonymous"),
        (a.onload = () => {
          const t = document.createElement("canvas"),
            n = t.getContext("2d"),
            o = Math.min(e / a.width, r / a.height),
            s = a.width * o,
            l = a.height * o;
          (t.width = s),
            (t.height = l),
            n.drawImage(a, 0, 0, s, l),
  ...
  (OrgChart.xScrollUI = function (t, e, r, i, n) {
    (this.element = t),
      (this.requestParams = r),
      (this.config = e),
      (this.onSetViewBoxCallback = i),
      (this.onDrawCallback = n),
      (this.position = 0),
      (this.bar = null),
      (this._event_id = OrgChart._guid());
  }),
  (OrgChart.xScrollUI.prototype.addListener = function (t) {
    ...
    if (
      ...
      !(function (t, i, n) {
        ...
        function o() {
          a = !0;
          var t = (e.position - e.bar.scrollLeft) / n;
          if (t > 0) t++;
          else {
          ...
          Math.ceil(e.bar.scrollLeft) == Math.ceil(e.position)
            ? (a = !1)
            : ((e.bar.scrollLeft += t), s(o));
        }
        t.addEventListener(
          "wheel",
          function (t) {
            if ((t.preventDefault(), t.ctrlKey)) return;
            var n = 0;
            if (e.config.mouseScrool == OrgChart.action.xScroll)
              (n = t.deltaX || t.wheelDeltaX) ||
                (n = t.deltaY || t.wheelDeltaY);
            else if (
          ...
          if (this.ignore) this.ignore = !1;
            ...
            var t = e.requestParams(),
              r =
                ...
                100,
              i = this.scrollLeft / r,
              n = (t.boundary.right - t.boundary.left) / 100;
            (t.viewBox[0] = i * n + t.boundary.left),
  ...
  (OrgChart.xScrollUI.prototype.setPosition = function () {
    if (this.bar) {
      ...
      (this.bar.ignore = !0),
        ...
        (this.bar.style.visibility = n <= 0 ? "hidden" : ""),
        !0 !== this.config.showXScroll &&
  ...
  (OrgChart.yScrollUI = function (t, e, r, i, n) {
    (this.element = t),
      (this.requestParams = r),
      (this.config = e),
      (this.onSetViewBoxCallback = i),
  ...
  (OrgChart.yScrollUI.prototype.addListener = function (t) {
    ...
    if (
      ...
      !(function (t, i, n) {
        ...
        function o() {
          a = !0;
          var t = (e.position - e.bar.scrollTop) / n;
          if (t > 0) t++;
          else {
            if (0 == t) return void (a = !1);
            t--;
          ...
          if (this.ignore) this.ignore = !1;
            ...
            var t = e.requestParams(),
              r =
                ...
                100,
              i = this.scrollTop / r,
              n = (t.boundary.bottom - t.boundary.top) / 100;
            (t.viewBox[1] = i * n + t.boundary.top),
              e.onSetViewBoxCallback(t.viewBox),
              clearTimeout(this._timeout),
              (this._timeout = setTimeout(function () {
                e.onDrawCallback();
  ...
  (OrgChart.prototype.zoom = function (t, e, r, i) {
    var n = this.getViewBox().slice(0),
      a = n,
      o = n[2],
      s = n[3];
    !0 === t
      ? ((n[2] = n[2] / OrgChart.SCALE_FACTOR),
        (n[3] = n[3] / OrgChart.SCALE_FACTOR))
      : !1 === t
      ? ((n[2] = n[2] * OrgChart.SCALE_FACTOR),
        (n[3] = n[3] * OrgChart.SCALE_FACTOR))
      : ((n[2] = n[2] / t), (n[3] = n[3] / t)),
      e || (e = [50, 50]),
      (n[0] = a[0] - (n[2] - o) / (100 / e[0])),
      (n[1] = a[1] - (n[3] - s) / (100 / e[1]));
    var l = this.getScale(n);
    if (
      ((n[2] = this.width() / l),
      (n[3] = this.height() / l),
  ...
  (OrgChart.pdfPrevUI.show = function (t, e) {
    console.warn(
      "OrgChart.pdfPrevUI.show is obsolete; use chart.pdfPreviewUI.show instead."
    );
  }),
  (OrgChart.pdfPrevUI.hide = function () {
    console.warn(
      "OrgChart.pdfPrevUI.hide is obsolete; use chart.pdfPreviewUI.hide instead."
    );
  }),
  void 0 === OrgChart && (OrgChart = {}),
  OrgChart.events.on("renderdefs", function (t, e) {
    for (var r = 0; r < t.config.clinks.length; r++) {
      ...
      i || (i = "orange");
      var n = OrgChart.clinkTemplates[i];
      e.defs += n.defs;
    }
  }),
  ...
  OrgChart.events.on("drag", function (t, e, r, i) {
    if (t instanceof OrgChart && t.config.movable && i)
      for (var n = 0; n < i.length; n++) {
        for (
          var a = i[n],
            o = t.element.querySelectorAll(`[data-c-l-from="${a}"]`),
            s = t.element.querySelectorAll(`[data-c-l-to="${a}"]`),
            l = 0;
          l < o.length;
          l++
        )
          o[l].parentNode.removeChild(o[l]);
        for (l = 0; l < s.length; l++) s[l].parentNode.removeChild(s[l]);
      }
  }),
  (OrgChart.prototype._clink = function (t, e) {
    for (var r = "", i = 0; i < this.config.clinks.length; i++) {
      var n = this.config.clinks[i],
        a = t.getNode(n.from),
        o = t.getNode(n.to);
      if (
        a &&
        -1 != e.res.visibleNodeIds.indexOf(a.id) &&
        o &&
        ...
        var b = _(d, g, C),
          x = n.template;
        x || (x = "orange");
        var v = OrgChart.clinkTemplates[x];
        if (n.label) {
          var O = OrgChart.clinkLabelPosition(n, d, g, b);
          r += v.label
            .replace("{x}", O.x)
            .replace("{y}", O.y)
            .replace("{val}", n.label);
      ...
      function _(t, e, r) {
        ...
        return (
          (o = (o / (Math.sqrt(i * i + a * a) * r)) * OrgChart.clinkCurve(n)),
  ...
  (OrgChart.clinkLabelPosition = function (t, e, r, i) {
    var n = (r.x - e.x) / 2 + e.x,
      a = (r.y - e.y) / 2 + e.y;
    return { x: (n - i.x) / 2 + i.x, y: (a - i.y) / 2 + i.y };
  }),
  ...
  (OrgChart.prototype.addClink = function (t, e, r, i) {
    this._putInUndoStack(), this.clearRedo();
    for (var n = this.config.clinks.length - 1; n >= 0; n--) {
      var a = this.config.clinks[n];
      a.from == t && a.to == e && this.config.clinks.splice(n, 1);
    }
    return (
  ...
  (OrgChart.prototype.removeClink = function (t, e) {
    ...
    return (
      this._ai.setContext(), OrgChart.events.publish("updated", [this]), this
    );
  }),
  ...
  OrgChart.events.on("renderdefs", function (t, e) {
    for (var r = 0; r < t.config.slinks.length; r++) {
      ...
      i || (i = "orange");
      var n = OrgChart.slinkTemplates[i];
      e.defs += n.defs;
    }
  }),
  OrgChart.events.on("render", function (t, e) {
  ...
  OrgChart.events.on("drag", function (t, e, r, i) {
    if (t instanceof OrgChart && t.config.movable && i)
      for (var n = 0; n < i.length; n++) {
        for (
          var a = i[n],
            o = t.element.querySelectorAll(`[data-s-l-from="${a}"]`),
            s = t.element.querySelectorAll(`[data-s-l-to="${a}"]`),
            l = 0;
          l < o.length;
          l++
        )
  ...
  (OrgChart.prototype._slinks = function (t, e) {
    ...
    function o(e, r, a, o, s) {
      var l,
        h = [],
        c = null,
        d = OrgChart.t(e.templateName, e.min, i),
        g = o.levelSeparation;
      switch (
        (e.parent && e.parent.layout && (g = o.mixedHierarchyNodesSeparation),
        o.orientation)
      ) {
        case OrgChart.orientation.top:
        case OrgChart.orientation.top_left:
          l = { p: e.x + e.w / 2, q: e.y, r: e.x + e.w / 2, s: n.minY + g };
          break;
        case OrgChart.orientation.bottom:
        case OrgChart.orientation.bottom_left:
          l = { p: e.x + e.w / 2, q: e.y + e.h, r: e.x + e.w / 2, s: n.maxY };
          break;
        case OrgChart.orientation.left:
        case OrgChart.orientation.left_top:
          l = { p: e.x, q: e.y + e.h / 2, r: n.minX + g, s: e.y + e.h / 2 };
          break;
        case OrgChart.orientation.right:
        case OrgChart.orientation.right_top:
          l = { p: e.x + e.w, q: e.y + e.h / 2, r: n.maxX, s: e.y + e.h / 2 };
      }
      if (e.sl == r.sl)
        switch (((c = r), o.orientation)) {
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
            h.push([l.p, l.q]),
              h.push([l.p, l.q - 2 * OrgChart.SLINK_GAP]),
              (d = OrgChart.t(c.templateName, c.min, i)),
              h.push([c.x + c.w / 2, h[h.length - 1][1]]),
              h.push([h[h.length - 1][0], c.y]);
            break;
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            h.push([l.p, l.q]),
              ...
              (d = OrgChart.t(c.templateName, c.min, i)),
              h.push([c.x + c.w / 2, h[h.length - 1][1]]),
              h.push([h[h.length - 1][0], c.y + c.h]);
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            h.push([l.p, l.q]),
              h.push([l.p - 2 * OrgChart.SLINK_GAP, l.q]),
              (d = OrgChart.t(c.templateName, c.min, i)),
              h.push([h[h.length - 1][0], c.y + c.h / 2]),
              h.push([c.x, h[h.length - 1][1]]);
            break;
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            h.push([l.p, l.q]),
              ...
              (d = OrgChart.t(c.templateName, c.min, i)),
              h.push([h[h.length - 1][0], c.y + c.h / 2]),
              h.push([c.x + c.w, h[h.length - 1][1]]);
        }
      else {
        switch (o.orientation) {
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
            h.push([l.p, l.q]), h.push([l.r, e.y - 2 * OrgChart.SLINK_GAP]);
            break;
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            h.push([l.p, l.q]),
              h.push([l.r, e.y + e.h + 2 * OrgChart.SLINK_GAP]);
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            h.push([l.p, l.q]), h.push([e.x - 2 * OrgChart.SLINK_GAP, l.s]);
            break;
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            h.push([l.p, l.q]),
              h.push([e.x + e.w + 2 * OrgChart.SLINK_GAP, l.s]);
        }
        for (var p = e, u = e; u.parent; ) u = u.parent;
        for (; null == c; ) {
          var f = !1,
            m = p.parent,
            C = m.leftNeighbor,
          ...
          if (
            (m.id == r.id
              ? (c = m)
              : OrgChart._intersects(m, l, o) &&
                ((l = OrgChart._addPoint(m, h, o, l, s)), (f = !0)),
            m.id != r.id)
          ) {
            for (; C; ) {
              if (C.id == r.id) {
              ...
              OrgChart._intersects(C, l, o) &&
                ((l = OrgChart._addPoint(C, h, o, l, s)), (f = !0)),
                (C = C.leftNeighbor);
            }
            for (; b; ) {
              if (b.id == r.id) {
              ...
              OrgChart._intersects(b, l, o) &&
                ((l = OrgChart._addPoint(b, h, o, l, s)), (f = !0)),
                (b = b.rightNeighbor);
            }
          }
          if (!f) {
            ...
            if (m.parent) {
              (g = o.levelSeparation),
                m.parent.layout && (g = o.mixedHierarchyNodesSeparation);
              var O = t.manager.bordersByRootIdAndLevel[u.id][m.parent.sl];
              switch (o.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                  (x = h[h.length - 1][0]),
                    (v = O.maxY + g - OrgChart.SLINK_GAP);
                  break;
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
                  (x = h[h.length - 1][0]),
                    (v = O.minY - g + OrgChart.SLINK_GAP);
                  break;
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                  (x = O.maxX + g - OrgChart.SLINK_GAP),
                    (v = h[h.length - 1][1]);
                  break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                  (x = O.minX - g + OrgChart.SLINK_GAP),
                    (v = h[h.length - 1][1]);
              }
            }
            h.push([x, v]);
        ...
        switch (
          ...
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
            var y = d.expandCollapseSize;
            "left" == s && (y *= -1),
              h.push([c.x + c.w / 2 + y, h[h.length - 1][1]]),
              h.push([h[h.length - 1][0], c.y + c.h]);
            break;
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            y = d.expandCollapseSize;
            "left" == s && (y *= -1),
              h.push([c.x + c.w / 2 + y, h[h.length - 1][1]]),
              h.push([h[h.length - 1][0], c.y]);
            break;
          ...
          case OrgChart.orientation.left_top:
            y = d.expandCollapseSize;
            "top" == s && (y *= -1),
              h.push([h[h.length - 1][0], c.y + c.h / 2 + y]),
              h.push([c.x + c.w, h[h.length - 1][1]]);
            break;
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
      ...
      return a && (h = h.reverse()), h;
    }
    for (
      var s = [], l = [], h = [], c = [], d = [], g = 0;
      g < this.config.slinks.length;
      g++
    ) {
      var p = this.config.slinks[g],
        u = t.getNode(p.from),
        f = t.getNode(p.to);
      if (
        u &&
        f &&
        -1 != e.res.visibleNodeIds.indexOf(f.id) &&
        -1 != e.res.visibleNodeIds.indexOf(u.id)
      ) {
        var m = u.lcn ? u.lcn : "base",
          C = t._layoutConfigs[m],
          b = u.sl < f.sl,
          x = "left";
        switch (C.orientation) {
          ...
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            (x = "top"), f.y > u.y && (x = "bottom");
        }
        (v = b ? o(f, u, b, C, x) : o(u, f, b, C, x)),
          s.push(v),
          l.push(p),
          c.push(x),
          h.push(C),
    ...
    for (g = 0; g < s.length; g++) {
      var v = s[g];
      (p = l[g]), (x = c[g]);
      switch ((OrgChart._slinkRemoveUnusedPoints(v), C.orientation)) {
        case OrgChart.orientation.top:
        case OrgChart.orientation.top_left:
        case OrgChart.orientation.bottom:
        case OrgChart.orientation.bottom_left:
          OrgChart._slinkAvoidOverlaping(
            t._connectorLines,
            v,
            x,
            C.orientation
        ...
        case OrgChart.orientation.right:
        case OrgChart.orientation.right_top:
          OrgChart._slinkAvoidOverlaping2(
            t._connectorLines,
            v,
            x,
            C.orientation
    ...
    for (g = s.length - 1; g >= 0; g--) {
      ...
      switch (C.orientation) {
        ...
        case OrgChart.orientation.bottom:
        case OrgChart.orientation.bottom_left:
          OrgChart._slinkAvoidOverlapingSecond(
            t._connectorLines,
            v,
            C.orientation
          );
        ...
        case OrgChart.orientation.right:
        case OrgChart.orientation.right_top:
          OrgChart._slinkAvoidOverlapingSecond2(
            t._connectorLines,
            v,
            C.orientation
          );
    ...
    for (g = 0; g < s.length; g++) {
      (v = s[g]), (p = l[g]), (C = h[g]), (u = d[g].from), (f = d[g].to);
      var O = p.template;
      O || (O = "orange");
      var y = OrgChart.slinkTemplates[O],
        _ = null;
      switch (y.labelPosition) {
        case "start":
          ...
          break;
        case "middle":
          var w = Math.ceil(v.length / 2);
          _ = a(v[w], v[w - 1]);
          break;
        case "end":
          _ = { x: v[v.length - 2][0], y: v[v.length - 2][1] };
      }
      var k = structuredClone(v);
      k[0].unshift("M");
      for (var I = 1; I < v.length; I++) k[I].unshift("L");
      var S = OrgChart.roundPathCorners(k, OrgChart.LINK_ROUNDED_CORNERS, !1);
      if (p.label) {
        var L = y.label
            .replace("{x}", _.x)
            .replace("{y}", _.y)
  ...
  (OrgChart.prototype.addSlink = function (t, e, r, i) {
    this._putInUndoStack(), this.clearRedo();
    for (var n = this.config.slinks.length - 1; n >= 0; n--) {
      var a = this.config.slinks[n];
      a.from == t && a.to == e && this.config.slinks.splice(n, 1);
    }
    return (
...
(OrgChart._ai = function (t) {
  (this.instance = t), (this.sessionId = null);
}),
  (OrgChart._ai.prototype.prompt = function (t, e) {
    var r = this;
    (t = t.trim()) &&
      (this.sessionId
        ? r._prompt([{ Role: "user", Text: t }], e)
        : this.setContext(function () {
            r._prompt([{ Role: "user", Text: t }], e);
          }));
  }),
  (OrgChart._ai.prototype._prompt = function (t, e) {
    var r = this,
      i = [];
    for (var n of OrgChart.AI_SYSTEM_MESSAGES)
      i.push({ Role: "system", Text: n });
    var a =
      this.instance.config.serverUrl +
      `/OrgChartJSAI/Prompt?client_messages=${encodeURIComponent(
        JSON.stringify(t)
      )}&system_messages=${encodeURIComponent(JSON.stringify(i))}&sessionId=${
        this.sessionId
      }`;
    const o = new EventSource(a);
    (o.onmessage = function (t) {
      var i = JSON.parse(t.data);
      "end" == i.kind && o.close(),
        "text" == i.kind && (i.text, e && e(i.text)),
        "assistant-message-with-tools" == i.kind
          ? r.toolCalls(i.message, e)
          : "error" == i.kind && console.error(i.text);
    }),
      (o.onerror = function (t) {
        console.error(t), o.close();
      });
  }),
  (OrgChart._ai.prototype.setContext = function (t) {
    if (
      this.instance &&
      this.instance.config.enableAI &&
      this.instance.aiUI.canSetContext
    ) {
      this.sessionId = this.instance._event_id;
      var e = this.instance.config.serverUrl + "/OrgChartJSAI/SetContext",
        r = this.instance.config.aiChatTools.slice();
      for (var i of r)
        null == i.functionParameters && (i.functionParameters = null),
          (i.functionParameters = JSON.stringify(i.functionParameters));
      fetch(e, {
        method: "post",
        headers: {
  ...
  (OrgChart._ai.prototype.toolCalls = function (t, e) {
    var r = this,
      i = { toolCalls: t.ToolCalls };
    OrgChart.events.publish("ai-tool-calls", [this.instance, i]);
    var n = [],
      a = [],
      o = [],
      s = [],
      ...
      g = null,
      p = null;
    for (var u of i.toolCalls)
      null == u.FunctionResult &&
        ("removeNode" == u.FunctionName
          ? n.push(u)
          : "addNode" == u.FunctionName
          ? a.push(u)
          : "updateNode" == u.FunctionName
          ? o.push(u)
          : "select" == u.FunctionName
          ? s.push(u)
          : "deselect" == u.FunctionName
          ? l.push(u)
          : "exportToPDF" == u.FunctionName
          ? (h = u)
          : "changeTemplate" == u.FunctionName
          ? (c = u)
          : "addSlink" == u.FunctionName
          ? (d = u)
          : "removeSlink" == u.FunctionName
          ? (g = u)
          : "fit" == u.FunctionName && (p = u));
    var f = !1;
    if (
      (c &&
        ((f = !0),
        (u.FunctionResult = "ok"),
        (this.instance.config.template = u.FunctionArguments.templateName)),
      d)
    ) {
      var m = this.instance.getNode(u.FunctionArguments.employeeId1),
        C = this.instance.getNode(u.FunctionArguments.employeeId2);
      m && C && m != C
        ? ((f = !0),
          this.instance.addSlink(m.id, C.id),
          (u.FunctionResult = "ok"))
        : (u.FunctionResult = `Cannot add link between ${u.FunctionArguments.employeeId1} and ${u.FunctionArguments.employeeId2}`);
    }
    if (g) {
      (m = this.instance.getNode(u.FunctionArguments.employeeId1)),
        (C = this.instance.getNode(u.FunctionArguments.employeeId2));
      m && C && m != C
        ? ((f = !0),
          this.instance.removeSlink(m.id, C.id),
          (u.FunctionResult = "ok"))
        : (u.FunctionResult = `Cannot remove link between ${u.FunctionArguments.employeeId1} and ${u.FunctionArguments.employeeId2}`);
    }
    for (var u of (p && (this.instance.fit(), (f = !1)), n))
      (f = !0),
        (u.FunctionResult = "ok"),
        this.instance.remove(u.FunctionArguments.id);
    for (var u of a) {
      (f = !0),
        (u.FunctionResult = "ok"),
        (b = JSON.parse(JSON.stringify(u.FunctionArguments))).isAssistant &&
          (b.tags = ["assistant"]),
        delete b.isAssistant,
        OrgChart.isNEU(b.id) && (b.id = this.instance.generateId()),
        this.instance.add(b);
    }
    for (var u of o) {
      (f = !0), (u.FunctionResult = "ok");
      var b = this.instance.get(u.FunctionArguments.id);
      for (var x in u.FunctionArguments)
        "id" != x &&
          null != u.FunctionArguments[x] &&
          (b[x] = u.FunctionArguments[x]);
      this.instance.update(b);
    }
    for (var u of s)
      for (var v of ((u.FunctionResult = "ok"), u.FunctionArguments.ids)) {
        var O = u.FunctionArguments.color;
        O || (O = "#FFCA28");
        var y = this.instance.getNodeElement(v).firstChild;
        y &&
          ((y.style.stroke = u.FunctionArguments.color),
          (y.style.strokeWidth = 5));
      }
    var _ = function () {
      for (var t of l)
        if (((t.FunctionResult = "ok"), t.FunctionArguments.ids))
          for (var e of t.FunctionArguments.ids) {
            var i = r.instance.getNodeElement(e).firstChild;
            i && ((i.style.stroke = "#aeaeae"), (i.style.strokeWidth = 1));
          }
        else f = !0;
    };
    f
      ? (this.setContext(),
        this.instance.draw(OrgChart.action.update, void 0, _))
      : _();
    var w = function () {
      var t = [];
      for (var n of i.toolCalls)
        t.push({ Role: "tool", Text: n.FunctionResult, Id: n.Id });
      r._prompt(t, e);
    };
    h
      ? this.chartInstance.exportToPDF({}, function () {
          (u.FunctionResult = "ok"),
            OrgChart._downloadFile(
              "application/pdf",
              response,
  ...
  (OrgChart.aiUI = function () {
    (this.instance = null),
      (this.interval = null),
      (this.canSetContext = !1),
      (this.element = null),
      (this.inputElement = null),
      (this.btnSendElement = null),
  ...
  (OrgChart.aiUI.title = "AI for OrgChart JS"),
  (OrgChart.aiUI.prototype.init = function (t) {
    this.instance = t;
    var e = this,
      r = this.instance.element.querySelector("[data-boc-ai-button]");
    r &&
      r.addEventListener("click", function (t) {
        e.show();
      });
  }),
  (OrgChart.aiUI.prototype.isVisible = function () {
    return !(!this.element || "none" == this.element.style.display);
  }),
  (OrgChart.aiUI.prototype.show = function (t, e) {
    this.instance.pdfPreviewUI.hide(),
      this.instance.svgPreviewUI.hide(),
      this.instance.pngPreviewUI.hide(),
      this.instance.powerPointPreviewUI.hide(),
      ...
      (this.element.style.display = ""),
      this.canSetContext ||
        ((this.canSetContext = !0), this.instance._ai.setContext());
    var r = this;
    e ||
      (this.timeout && clearInterval(this.interval),
      (this.interval = OrgChart.animate(
        this.element,
        { opacity: 0 },
        { opacity: 1 },
  ...
  (OrgChart.aiUI.prototype._create = function () {
    if (!this.element) {
      var t = this,
        e = "inp_" + this.instance.generateId();
      (this.element = document.createElement("div")),
        this.element.setAttribute("data-boc-ai-form", ""),
        (this.element.style.opacity = 0),
        this.element.classList.add("boc-ai-form"),
        this.element.classList.add(this.instance.config.mode),
        (this.element.innerHTML = `<div class="boc-ai-container">\n                                <div data-boc-ai-close class="boc-ai-close">${OrgChart.icon.x(
          20,
          20,
          "#aeaeae"
      ...
      var r = this.instance.leftElement.querySelector(
        "[data-boc-ai-close] svg"
      );
      r &&
        r.addEventListener("click", function (e) {
          t.hide();
        }),
        (this.inputElement = this.element.querySelector("#" + e)),
        (this.btnSendElement =
          this.inputElement.parentNode.querySelector("[data-boc-ai-send]")),
        (this.messagesElement = this.element.querySelector(
          "[data-boc-ai-messages]"
        )),
        this.inputElement.addEventListener("input", function (t) {
          this.value
            ? this.parentNode
                .querySelector(".boc-ai-send")
                .classList.add("boc-ai-send-cansend")
            : this.parentNode
                .querySelector(".boc-ai-send")
                .classList.remove("boc-ai-send-cansend");
        }),
        this.element
          .querySelector("[data-boc-ai-send]")
          .addEventListener("click", function (e) {
            t.sendUserInput();
          }),
        this.inputElement.addEventListener("keyup", function (e) {
          ...
          switch (
            (t.canSetContext ||
              ((t.canSetContext = !0), t.instance._ai.setContext()),
            r.key)
          ) {
            case "Enter":
              t.sendUserInput();
              break;
            case "ArrowUp":
              if ((i = OrgChart.aiUI._getSuggestions()).length)
                -1 == (n = i.indexOf(t.inputElement.value))
                  ? (n = i.length - 1)
                  : n--,
                  -1 == n && (n = i.length - 1),
                  (t.inputElement.value = i[n]);
              break;
            case "ArrowDown":
              var i, n;
              if ((i = OrgChart.aiUI._getSuggestions()).length)
                -1 == (n = i.indexOf(t.inputElement.value)) ? (n = 0) : n++,
                  n == i.length && (n = 0),
                  (t.inputElement.value = i[n]);
          }
        });
  ...
  (OrgChart.aiUI.prototype.addUserMessage = function (t) {
    this.btnSendElement.classList.remove("boc-ai-send-cansend");
    var e = this.element.querySelector(".boc-ai-start");
    e &&
      (e.classList.remove("boc-ai-start"),
      (this.messagesElement.innerHTML = ""));
    var r = document.createElement("div");
    r.classList.add("boc-ai-user-message"),
      (r.innerHTML = `<span class="boc-inner-user-message">${t}</span>`),
      this.messagesElement.appendChild(r);
  }),
  (OrgChart.aiUI.prototype.hide = function () {
    (this.instance.leftElement.style.display = "none"),
      this.element &&
        (this.element.parentNode.removeChild(this.element),
        (this.element = null));
  }),
  (OrgChart.aiUI.prototype.sendUserInput = function () {
    var t = this;
    OrgChart.aiUI._addSuggestion(this.inputElement.value),
      this.addUserMessage(this.inputElement.value);
    var e = document.createElement("div");
    e.classList.add("boc-ai-assistant-message");
    var r = document.createElement("span");
    r.classList.add("boc-inner-assistant-message"),
      e.appendChild(r),
      this.messagesElement.appendChild(e);
    var i = "";
    this.instance._ai.prompt(this.inputElement.value, function (e) {
      i += e;
      var n = marked.parse(i);
      r.innerHTML = n;
      var a = t.element.querySelector(".boc-ai-middle");
      a.scrollTo(0, a.scrollHeight);
    }),
      (this.inputElement.value = "");
  }),
  (OrgChart.aiUI._addSuggestion = function (t) {
    t = t.trim();
    var e = OrgChart.aiUI._getSuggestions(),
      r = e.indexOf(t);
    -1 != r && e.splice(r, 1),
      e.push(t),
      localStorage.setItem("suggestions", JSON.stringify(e));
  }),
  (OrgChart.aiUI._getSuggestions = function () {
    var t = localStorage.getItem("suggestions");
    return (t = t ? JSON.parse(t) : []);
  }),
  (OrgChart.orgScribeUI = function () {
    (this.instance = null),
      (this.element = null),
  ...
  (OrgChart.orgScribeUI.prototype.init = function (t) {
    this.instance = t;
  }),
  OrgChart.events.on("updated", function (t, e) {
    if (t.orgScribeUI.isVisible()) {
      var r = OrgChart._convertFromNodesToText(
        t.config.nodes,
        OrgChart.ORGSCRIBE_OFFSET
      );
  ...
  (OrgChart.orgScribeUI.prototype.isVisible = function () {
    return !(!this.element || "none" == this.element.style.display);
  }),
  (OrgChart.orgScribeUI.prototype.show = function (t, e) {
    this.instance.pdfPreviewUI.hide(),
      this.instance.svgPreviewUI.hide(),
      this.instance.pngPreviewUI.hide(),
      this.instance.powerPointPreviewUI.hide(),
      ...
      (this.interval = OrgChart.animate(
        ...
        function () {
          if (!t) {
            ...
            r.textAreaElement.focus(),
              r.textAreaElement.setSelectionRange(e, e);
          }
        }
      )));
  }),
  (OrgChart.orgScribeUI.prototype._create = function () {
    if (!this.element) {
      var t = this;
      (this.element = document.createElement("div")),
        this.element.setAttribute("data-boc-orgscribe-form", ""),
        (this.element.style.opacity = 0),
        this.element.classList.add("boc-orgscribe-form"),
        this.element.classList.add(this.instance.config.mode);
      var e = OrgChart._convertFromNodesToText(
        this.instance.config.nodes,
        OrgChart.ORGSCRIBE_OFFSET
      );
      (this.element.innerHTML = `<div class="boc-orgscribe-container">\n                                <div data-boc-orgscribe-close class="boc-orgscribe-close">${OrgChart.icon.x(
        20,
        20,
        "#aeaeae"
      ...
      r &&
        ...
        (this.textAreaElement = this.element.querySelector(
          '[data-id="boc_orgscribe_txt"]'
        )),
        this.textAreaElement.addEventListener("input", function () {
          t._timeout && (clearTimeout(t._timeout), (t._timeout = null));
          var e = this.value;
          t._timeout = setTimeout(function () {
            var r = OrgChart._convertTextToNodes(e, OrgChart.ORGSCRIBE_OFFSET);
            t.instance.load(r);
          }, 500);
        });
    }
  }),
  (OrgChart.orgScribeUI.prototype.hide = function () {
    this.element &&
      (this.element.parentNode.removeChild(this.element),
      (this.element = null));
  }),
  (function (t, e) {
    "object" == typeof exports && "undefined" != typeof module
      ...
      : e(
          ((t =
            "undefined" != typeof globalThis ? globalThis : t || self).marked =
            {})
        );
  })(this, function (t) {
    "use strict";
    ...
    function n(t, e = "") {
      ...
      const i = {
        replace: (t, e) => {
          ...
          return (n = n.replace(a.caret, "$1")), (r = r.replace(t, n)), i;
        },
    ...
    const a = {
      ...
      w = /[^\s\p{P}\p{S}]/u,
      k = n(/^((?![*_])punctSpace)/, "u")
        .replace(/punctSpace/g, _)
        .getRegex(),
      I = /(?!~)[\p{P}\p{S}]/u,
      S = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,
      L = n(S, "u").replace(/punct/g, y).getRegex(),
      E = n(S, "u").replace(/punct/g, I).getRegex(),
      A =
      ...
      P = n(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/)
        ...
        .getRegex(),
      U = n(u).replace("(?:--\x3e|$)", "--\x3e").getRegex(),
      R = n(
      ...
      z = {
        ...
        punctuation: k,
        reflink: H,
        reflinkSearch: n("reflink|nolink(?!\\()", "g")
          .replace("reflink", H)
          .replace("nolink", D)
          .getRegex(),
        tag: R,
      ...
      Y = {
        ...q,
        br: n(O).replace("{2,}", "*").getRegex(),
        text: n(q.text)
          .replace("\\b_", "\\b_| {2,}\\n")
          .replace(/\{2,\}/g, "*")
          .getRegex(),
      },
      X = { normal: C, gfm: x, pedantic: v },
      V = { normal: z, gfm: q, breaks: Y, pedantic: j },
      G = {
        "&": "&amp;",
        "<": "&lt;",
        ">": "&gt;",
    ...
    function K(t, e) {
      if (e) {
        if (a.escapeTest.test(t)) return t.replace(a.escapeReplace, W);
      } else if (a.escapeTestNoEncode.test(t)) return t.replace(a.escapeReplaceNoEncode, W);
      return t;
    }
    function J(t) {
      try {
        t = encodeURI(t).replace(a.percentDecode, "%");
      } catch {
        return null;
      }
      return t;
    ...
    function Z(t, e) {
      ...
      for (; i < r.length; i++) r[i] = r[i].trim().replace(a.slashPipe, "|");
      return r;
    }
    function Q(t, e, r) {
      const i = t.length;
    ...
    function tt(t, e, r, i, n) {
      ...
      return { type: "image", raw: r, href: a, title: o, text: s };
    }
    class et {
      options;
      rules;
      ...
      fences(t) {
        ...
        if (e) {
          const t = e[0],
            r = (function (t, e, r) {
              const i = t.match(r.other.indentCodeCompensation);
              if (null === i) return e;
              const n = i[1];
              return e
                .split("\n")
                .map((t) => {
                  const e = t.match(r.other.beginningSpace);
                  if (null === e) return t;
                  const [i] = e;
        ...
        if (e) {
          ...
          for (; t.length > 0; ) {
            ...
            for (o = 0; o < t.length; o++)
              if (this.rules.other.blockquoteStart.test(t[o]))
                a.push(t[o]), (e = !0);
              else {
                if (e) break;
                a.push(t[o]);
        ...
        if (e) {
          ...
          for (; t; ) {
            ...
            if (
              ...
              c &&
                ...
                ((i += h + "\n"), (t = t.substring(h.length + 1)), (r = !0)),
              !r)
            ) {
              const e = this.rules.other.nextBulletRegex(d),
              ...
              for (; t; ) {
                ...
                if (
                  ...
                  this.options.pedantic
                    ? ((h = h.replace(
                      ...
                      (p = h))
                    : (p = h.replace(this.rules.other.tabCharGlobal, "    ")),
                  n.test(h))
                )
                  break;
                if (a.test(h)) break;
                ...
                if (e.test(h)) break;
                if (r.test(h)) break;
                if (p.search(this.rules.other.nonSpaceChar) >= d || !h.trim())
                  s += "\n" + p.slice(d);
                else {
                  if (c) break;
                  if (
          ...
          for (let t = 0; t < n.items.length; t++)
            if (
              ...
              (n.items[t].tokens = this.lexer.blockTokens(n.items[t].text, [])),
              !n.loose)
            ) {
              const e = n.items[t].tokens.filter((t) => "space" === t.type),
                r =
                  e.length > 0 &&
      ...
      link(t) {
        ...
        if (e) {
          ...
          if (
            ...
            if (t > -1) {
              const r = (0 === e[0].indexOf("!") ? 5 : 4) + e[1].length + t;
      ...
      reflink(t, e) {
        ...
        if (
          ...
          return tt(r, t, r[0], this.lexer, this.rules);
        }
      }
      emStrong(t, e, r = "") {
        ...
        if (
          ...
          for (
            l.lastIndex = 0, e = e.slice(-1 * t.length + r);
            null != (i = l.exec(e));

          ) {
            if (((n = i[1] || i[2] || i[3] || i[4] || i[5] || i[6]), !n))
              continue;
            ...
            if (((o -= a), o > 0)) continue;
            a = Math.min(a, a + o + s);
            const e = [...i[0]][0].length,
              l = t.slice(0, r + i.index + e + a);
            if (Math.min(r, a) % 2) {
              const t = l.slice(1, -1);
              return {
                type: "em",
    ...
    class rt {
      ...
      constructor(e) {
        ...
        const r = { other: a, block: X.normal, inline: V.normal };
        this.options.pedantic
          ? ((r.block = X.pedantic), (r.inline = V.pedantic))
          : this.options.gfm &&
            ((r.block = X.gfm),
            this.options.breaks ? (r.inline = V.breaks) : (r.inline = V.gfm)),
          (this.tokenizer.rules = r);
      }
      static get rules() {
        return { block: X, inline: V };
      }
      static lex(t, e) {
        return new rt(e).lex(t);
      }
      static lexInline(t, e) {
        return new rt(e).inlineTokens(t);
      }
      lex(t) {
        (t = t.replace(a.carriageReturn, "\n")),
      ...
      blockTokens(t, e = [], r = !1) {
        for (
          this.options.pedantic &&
          (t = t.replace(a.tabCharGlobal, "    ").replace(a.spaceLine, ""));
          t;
      ...
      inlineTokens(t, e = []) {
        ...
        if (this.tokens.links) {
          ...
          if (t.length > 0)
            for (
              ...
              t.includes(i[0].slice(i[0].lastIndexOf("[") + 1, -1)) &&
                (r =
                  r.slice(0, i.index) +
                  "[" +
        ...
        for (; t; ) {
          ...
          if ((i = this.tokenizer.reflink(t, this.tokens.links))) {
            t = t.substring(i.raw.length);
            const r = e.at(-1);
            "text" === i.type && "text" === r?.type
              ? ((r.raw += i.raw), (r.text += i.text))
              : e.push(i);
            continue;
          }
          if ((i = this.tokenizer.emStrong(t, r, a))) {
            (t = t.substring(i.raw.length)), e.push(i);
            continue;
          }
          ...
          if ((i = this.tokenizer.inlineText(o))) {
            (t = t.substring(i.raw.length)),
              "_" !== i.raw.slice(-1) && (a = i.raw.slice(-1)),
              (n = !0);
            const r = e.at(-1);
            "text" === r?.type
              ? ((r.raw += i.raw), (r.text += i.text))
    ...
    class it {
      ...
      code({ text: t, lang: e, escaped: r }) {
        const i = (e || "").match(a.notSpaceStart)?.[0],
          n = t.replace(a.endingNewline, "") + "\n";
        return i
      ...
      table(t) {
        ...
        for (let e = 0; e < t.header.length; e++)
          r += this.tablecell(t.header[e]);
        e += this.tablerow({ text: r });
        let i = "";
        for (let e = 0; e < t.rows.length; e++) {
          const n = t.rows[e];
          r = "";
          for (let t = 0; t < n.length; t++) r += this.tablecell(n[t]);
      ...
      link({ href: t, title: e, tokens: r }) {
        const i = this.parser.parseInline(r),
          n = J(t);
        if (null === n) return i;
        let a = '<a href="' + (t = n) + '"';
        return e && (a += ' title="' + K(e) + '"'), (a += ">" + i + "</a>"), a;
      }
      image({ href: t, title: e, text: r }) {
        const i = J(t);
        if (null === i) return K(r);
        let n = `<img src="${(t = i)}" alt="${r}"`;
        return e && (n += ` title="${K(e)}"`), (n += ">"), n;
      }
      text(t) {
    ...
    class at {
      ...
      constructor(e) {
        (this.options = e || t.defaults),
          (this.options.renderer = this.options.renderer || new it()),
      ...
      static parse(t, e) {
        return new at(e).parse(t);
      }
      static parseInline(t, e) {
        return new at(e).parseInline(t);
      }
      parse(t, e = !0) {
        let r = "";
        for (let i = 0; i < t.length; i++) {
    ...
    class st {
          ...
          switch (((r = r.concat(e.call(this, i))), i.type)) {
            case "table": {
              ...
              for (const i of t.rows)
                for (const t of i) r = r.concat(this.walkTokens(t.tokens, e));
              break;
            }
            case "list": {
              const t = i;
        ...
        return (
          t.forEach((t) => {
            ...
            if (
              ...
              t.extensions &&
                (t.extensions.forEach((t) => {
                  ...
                  if ("tokenizer" in t) {
                    ...
                    const r = e[t.level];
                    r ? r.unshift(t.tokenizer) : (e[t.level] = [t.tokenizer]),
                      t.start &&
                        ("block" === t.level
                          ? e.startBlock
              ...
              const e = this.defaults.renderer || new it(this.defaults);
            ...
            if (t.tokenizer) {
              const e = this.defaults.tokenizer || new et(this.defaults);
            ...
            if (t.hooks) {
              const e = this.defaults.hooks || new ot();
              for (const r in t.hooks) {
                if (!(r in e)) throw new Error(`hook '${r}' does not exist`);
                if (["options", "block"].includes(r)) continue;
                const i = r,
                  n = t.hooks[i],
                  a = e[i];
                ot.passThroughHooks.has(r)
                  ? (e[i] = (t) => {
                      if (this.defaults.async)
                        return Promise.resolve(n.call(e, t)).then((t) =>
                          a.call(e, t)
                        );
                      const r = n.call(e, t);
                      return a.call(e, r);
      ...
      lexer(t, e) {
        return rt.lex(t, e ?? this.defaults);
      }
      parser(t, e) {
        return at.parse(t, e ?? this.defaults);
      }
      parseMarkdown(t) {
        return (e, r) => {
          const i = { ...r },
          ...
          const o = n.hooks
            ...
            s = n.hooks
              ...
              : at.parseInline;
          if (n.async)
            return Promise.resolve(n.hooks ? n.hooks.preprocess(e) : e)
              .then((t) => o(t, n))
              .then((t) => (n.hooks ? n.hooks.processAllTokens(t) : t))
              .then((t) =>
                n.walkTokens
                  ? Promise.all(this.walkTokens(t, n.walkTokens)).then(() => t)
                  : t
              )
              .then((t) => s(t, n))
    ...
    (ht.options = ht.setOptions =
      function (t) {
        return (
          lt.setOptions(t), (ht.defaults = lt.defaults), r(ht.defaults), ht
        );
      }),
      (ht.getDefaults = e),
      (ht.defaults = t.defaults),
      (ht.use = function (...t) {
        return lt.use(...t), (ht.defaults = lt.defaults), r(ht.defaults), ht;
      }),
      (ht.walkTokens = function (t, e) {
        return lt.walkTokens(t, e);
      }),
      (ht.parseInline = lt.parseInline),
      (ht.Parser = at),
      (ht.parser = at.parse),
      (ht.Renderer = it),
      (ht.TextRenderer = nt),
    ...
    if (e.node && e.node.tags && e.node.tags.has("group-dotted-lines")) {
      ...
      e.node.min
        ? (i.nodeGroupDottedOpenButton ||
          ...
          (n += `<g style="cursor:pointer;"  data-ctrl-n-dotted-open="${e.node.id}" transform="matrix(1,0,0,1,${e.node.x},${e.node.y})">`),
          (n += i.nodeGroupDottedOpenButton))
        : (i.nodeGroupDottedCloseButton ||
            console.error(
              `[${e.node.templateName}].nodeGroupDottedCloseButton is not defined`
            ),
          (n += `<g style="cursor:pointer;" transform="matrix(1,0,0,1,${e.node.x},${e.node.y})" data-ctrl-n-dotted-close="${e.node.id}">`),
          (n += i.nodeGroupDottedCloseButton)),
        (n = (n += "</g>")
      ...
      var a = t.getNode(e.node.stChildrenIds[0]);
      -1 != n.indexOf("{collapsed-children-count}") &&
        (n = n.replace("{collapsed-children-count}", a.collapsedChildCount)),
        -1 != n.indexOf("{collapsed-children-total-count}") &&
          (n = n.replace(
            "{collapsed-children-total-count}",
            a.deepCollapsedChildCount
          )),
        -1 != n.indexOf("{children-count}") &&
          (n = n.replace("{children-count}", a.childCount)),
        -1 != n.indexOf("{children-total-count}") &&
          (n = n.replace("{children-total-count}", a.deepChildCount)),
        (e.html += n);
    }
  }),
  OrgChart.events.on("redraw", function (t, e) {
    var r = null;
    if (
      (t.manager.action == OrgChart.action.centerNode &&
        (r = t.manager.actionParams.id),
      null != r)
    ) {
      var i = t.getNode(r);
      if (i.isTreeListItem) {
        var n = OrgChart._getCenterNodeFromParams(
            t.manager.nodes,
            t.manager.actionParams
          ),
          a = n.stChildren[0].lcn ? n.stChildren[0].lcn : "base",
          o = t.manager.layoutConfigs[a],
          s = OrgChart._getScrollTopForNode(n, i.id),
          l = n.treeList.scrollTop;
        s != l &&
          (t._treeListUpdateInterval = OrgChart.animate(
            null,
            {},
            {},
            400,
            ...
            function () {},
            function (e) {
              (n.treeList.scrollTop = e * (s - l) + l),
                t._treeListUpdate(n, o.orientation);
            }
          ));
      }
    }
  }),
  (OrgChart.prototype.__mouseScrollHandlerTreeList = function (t, e) {
    var r = e.delta || e.wheelDelta;
    for (
      void 0 === r && (r = -e.detail), r = Math.max(-1, Math.min(1, r));
      t && !t.stParent;

    )
      t = t.parent;
    t = t.stParent;
    var i = OrgChart.TREELIST_WHEEL_STEP;
    "auto" == i && (i = t.stChildren[0].h / 2),
      (t.treeList.scrollTop += -r * i);
    var n = t.stChildren[0].lcn ? t.stChildren[0].lcn : "base",
      a = this.manager.layoutConfigs[n];
    this._treeListUpdateInterval &&
      (clearInterval(this._treeListUpdateInterval),
      (this._treeListUpdateInterval = null)),
      "none" ==
        OrgChart._treeListGetTumbPositionFromScrollTop(t).scrollBarDisplay ||
        (e.preventDefault(), this._treeListUpdate(t, a.orientation));
  }),
  (OrgChart.prototype._treeListUpdate = function (t, e) {
    OrgChart._treeListSetProps(t, e),
      OrgChart._treeListAdjustToSTNodePostition(t.stChildren, t);
    var r = this.getScale(),
      i = this.element.querySelector(`[data-treelist-content="${t.id}"]`),
      n = i.transform.baseVal.consolidate().matrix;
    for (var a of ((n.f = -t.treeList.scrollTop),
    this._treeListIterate2(t.stChildren, t, r, i),
    t.treeList.pinnedIds)) {
      var o = this.getNode(a);
      this._treeListSetPositions(o, r, i, !0);
    }
    var s = this.element.querySelector(`[data-treelist-thumb="${t.id}"]`),
      l = this.element.querySelector(`[data-treelist-scroll="${t.id}"]`),
      {
        thumbHeight: h,
        thumbPosition: c,
        scrollBarDisplay: d,
      } = OrgChart._treeListGetTumbPositionFromScrollTop(t);
    (s.style.display = d),
      (l.style.display = d),
      s.setAttributeNS(null, "height", h),
      s.setAttributeNS(null, "y", +c);
  }),
  (OrgChart.prototype._treeListIterate2 = function (t, e, r, i) {
    for (var n of t)
      e.treeList.pinnedIds.includes(n.id) ||
        this._treeListSetPositions(n, r, i, !1),
        this._treeListIterate2(n.children, e, r, i);
  }),
  (OrgChart.prototype._treeListSetPositions = function (t, e, r, i) {
    var n = this.getNodeElement(t.id);
    if (n) {
      var a = n.transform.baseVal.consolidate().matrix;
      n.classList.remove("treelist-pinned"),
        i && (n.classList.add("treelist-pinned"), r.appendChild(n)),
        (a.f = t.y),
        (a.e = t.x);
      var o = this.element.querySelector(`[data-ctrl-ec-id="${t.id}"]`);
      if (o)
        (o.transform.baseVal.consolidate().matrix.f = t.y), r.appendChild(o);
    }
  }),
  (OrgChart.prototype._treeListThumbMouseDownHandler = function (t, e, r) {
    var i = t.getAttribute("data-treelist-thumb"),
      n = this.getNode(i),
      a = this.getSvg(),
      o = this,
      s = !0,
      ...
      h = this.getScale(),
      c = parseFloat(t.getAttribute("y")),
      d = parseFloat(t.getAttribute("height")),
      g = function (t) {
        if (s) {
          var e = (OrgChart._getClientXY(t).y - l.y) / h;
          thumbPosition = c + e;
          var r = OrgChart._treeListGetScrollTopFromTumbPosition(
            n,
            d,
            thumbPosition
          );
          (n.treeList.scrollTop = r),
            o._treeListUpdateInterval &&
              (clearInterval(o._treeListUpdateInterval),
              (o._treeListUpdateInterval = null)),
            o._treeListUpdate(n);
        }
      },
      p = function (t) {
        (s = !1),
          a.removeEventListener(r.move, g),
          a.removeEventListener(r.up, p);
      };
    a.addEventListener(r.move, g), a.addEventListener(r.up, p);
  }),
  (OrgChart.prototype._treeListExpandCollapseHandler = function (t) {
    var e = this.getNode(t);
    if (e && e.isTreeListItem) {
      var r = OrgChart.getRootOf(e).stParent;
      if (r.treeList.pinnedIds.includes(t)) {
        var i = OrgChart._getScrollTopForNode(r, e.id);
  ...
  (OrgChart.prototype.undo = function (t) {
    if (this.config.undoRedoStorageName) {
      ...
      if (0 != e) {
        ...
        var n = JSON.parse(i);
        (this.config.nodes = n.nodes),
          (this.config.clinks = n.clinks),
          (this.config.slinks = n.slinks),
          (this.config.groupDottedLines = n.groupDottedLines),
          (this.config.dottedLines = n.dottedLines),
          this._ai.setContext(),
          OrgChart.events.publish("updated", [this]),
          this.filterUI.update(),
  ...
  (OrgChart.undoRedoUI.prototype.refresh = function () {
    ...
    if (this.instance.config.undoRedoStorageName) {
      ...
      if (!1 !== OrgChart.events.publish("change", [this, e])) {
        ...
        if (!r || !i) {
          var n = document.createElement("div");
          n.classList.add("boc-undo-redo"),
            (n.innerHTML = `<span data-undo>${OrgChart.icon.undo(
              50,
              50,
              ""
            ...
            this.instance.element.appendChild(n),
    ...
    if (t.config.miniMap) {
      if (t.manager.action != OrgChart.action.move) {
        ...
        var i,
          ...
          a,
          o,
          s = t.element.querySelector('[data-id="mini-map-focus"]'),
          l = !1,
          h = null;
        (s.onmousedown = function (t) {
          ...
          if (
            ...
            (o =
              ...
              OrgChart.miniMap._settings._scale),
            a > r[0] && a < r[0] + r[2] && o > r[1] && o < r[1] + r[3])
          )
            return t.preventDefault(), t.stopPropagation(), void (l = !0);
        }),
          (s.onmousemove = function (e) {
            if (l) {
              ...
              var c = s.getBoundingClientRect(),
                d = c.left,
                g = c.top;
              (a = parseInt(e.clientX - d)), (o = parseInt(e.clientY - g));
              var p = (a - i) / OrgChart.miniMap._settings._scale,
                u = (o - n) / OrgChart.miniMap._settings._scale;
              (r[0] = p + r[0]),
                (r[1] = u + r[1]),
                t.setViewBox(r),
          ...
          (s.onclick = function (e) {
            if (
              ...
              var i = s.getBoundingClientRect(),
                n = i.left,
                l = i.top;
              (a = parseInt(e.clientX - n)), (o = parseInt(e.clientY - l));
              var c = a / OrgChart.miniMap._settings._scale,
                d = o / OrgChart.miniMap._settings._scale;
              (r[0] =
                c -
                (r[0] + r[2] - r[0]) / 2 -
                OrgChart.miniMap._settings._translateX /
  ...
  (OrgChart.miniMap._drawMainCanvas = function (t) {
    ...
    var i = 0,
      n = [];
    !(function t(e, a) {
      if (Array.isArray(a)) for (var o = 0; o < a.length; o++) t(e, a[o]);
      else {
        (r.fillStyle = OrgChart.miniMap.colors[3]),
          r.beginPath(),
          (r.lineWidth = "0.5"),
          r.fillRect(a.x, a.y, a.w, a.h),
          r.strokeRect(a.x, a.y, a.w, a.h);
        for (o = 0; o < a.stChildrenIds.length; o++)
          i++,
            n.includes(a.id) ||
              (1 == i
              ...
              r.strokeRect(a.x, a.y, a.w, a.h),
              n.push(a.id)),
            t(e, e.getNode(a.stChildrenIds[o])),
            i--;
        for (o = 0; o < a.childrenIds.length; o++)
          t(e, e.getNode(a.childrenIds[o]));
      }
    })(t, t.roots);
  }),
  ...
  (OrgChart.miniMap._init = function (t) {
    if (!t.element.querySelector('[data-id="mini-map"]')) {
      ...
      for (
        var n = ["top", "right", "left", "bottom"], a = 0;
        a < n.length;
        a++
      ) {
        var o = n[a];
      ...
      (s.style.position = "relative"),
        (s.style.width = OrgChart.miniMap.width + "px"),
        (s.style.height = OrgChart.miniMap.height + "px"),
        s.appendChild(e),
        s.appendChild(r),
        i.appendChild(s),
      ...
      var l = 0,
        ...
        c = function (t) {
          ...
          if (!OrgChart.isNEU(i.style.left)) {
            var n = parseFloat(i.style.left) + e;
            i.style.left = `${n}px`;
          }
          if (!OrgChart.isNEU(i.style.right)) {
            var a = parseFloat(i.style.right) - e;
            i.style.right = `${a}px`;
          }
          ...
          if (!OrgChart.isNEU(i.style.top)) {
            var s = parseFloat(i.style.top) + r;
            i.style.top = `${s}px`;
          }
          (l = t.clientX), (h = t.clientY);
        },
        d = function () {
  ...
  (OrgChart._search = {}),
  (OrgChart._search.search = function (t, e, r, i, n, a, o) {
    var s = [],
      l = e.toLowerCase();
    document.documentElement.lang &&
      (l = e.toLocaleLowerCase(document.documentElement.lang));
    var h = l.split(" ");
    if (o && h.length > 1) {
      var c = h[0];
      o[c] && ((r = [o[c]]), (h = (l = l.replace(c, "").trim()).split(" ")));
    }
    ...
    for (var d = {}, g = 0; g < t.length; g++)
      for (var p = t[g], u = 0; u < r.length; u++) {
        ...
        if (!OrgChart.isNEU(p[f])) {
          var m = p[f];
          if (
            null != (e = OrgChart._search.searchAndComputeScore(h, m, f, a))
          ) {
            var C = p.id;
            if (d[C]) {
              if (d[C] && d[C] < e.__score) {
                ...
                for (var b = s.length - 1; b >= 0; b--)
                  s[b].id == C && s.splice(b, 1);
                OrgChart._search.addNodeToResult(s, i, p, e, f, n);
              }
            } else
              (d[C] = e.__score),
                OrgChart._search.addNodeToResult(s, i, p, e, f, n);
  ...
  (OrgChart._search.addNodeToResult = function (t, e, r, i, n, a) {
    var o = {};
    (o.id = r.id), OrgChart.isNEU(r[a]) || (o[a] = r[a]);
    for (var s = 0; s < e.length; s++) {
      var l = e[s];
      OrgChart.isNEU(r[l]) || (OrgChart.isNEU(o[l]) && (o[l] = r[l]));
    }
    null != i &&
      (OrgChart.isNEU(o.__score) && (o.__score = i.__score),
      OrgChart.isNEU(o.__searchField) && (o.__searchField = n),
  ...
  (OrgChart._search.searchAndComputeScore = function (t, e, r, i) {
    ...
    var n = e.toLowerCase();
    document.documentElement.lang &&
      (n = e.toLocaleLowerCase(document.documentElement.lang));
    var a = OrgChart._search.searchIndexesOf(n, t);
    if (!a.length) return null;
    for (
      var o = n.length / 100, s = 0, l = 0, h = s > 0 ? 100 : 0, c = 0, d = 0;
      d < t.length;
      d++
    )
      for (var g = t[d], p = 0; p < a.length; p++)
        if (-1 != g.indexOf(a[p].searchPhrase)) {
          c++;
          break;
        }
    ...
    if (a.length) {
      ...
      for (p = 0; p < a.length; p++)
        if (
          ((s += a[p].length),
          a[p].start < l && (l = a[p].start),
          p >= 1 && a[p - 1].start > a[p].start)
        ) {
          h = 0;
          break;
        }
    ...
    for (p = a.length - 1; p >= 0; p--)
      for (d = 0; d < a.length; d++)
        d < p && a[d].start + a[d].length > a[p].start && a.splice(p, 1);
    var x = e;
    for (p = a.length - 1; p >= 0; p--)
      x = (x = x.insert(a[p].start + a[p].length, "</mark>")).insert(
        a[p].start,
        "<mark>"
      );
    return { __searchMarks: x, __score: b };
  }),
  (OrgChart._search.searchIndexesOf = function (t, e) {
    ...
    if (!OrgChart.isNEU(t))
      for (var i = 0; i < e.length; i++) {
        var n = e[i];
        if (!OrgChart.isNEU(n))
          for (var a = 0; (a = t.indexOf(n, a)) > -1; )
            r.push({ length: n.length, start: a, searchPhrase: n }),
              (a += n.length);
      }
    return (
      r.sort(function (t, e) {
      ...
      (r = r.filter(function (t) {
        for (var e = !1, i = 0; i < r.length; i++) {
          var n = r[i].start,
            a = r[i].start + r[i].length - 1,
            o = t.start,
            s = t.start + t.length - 1;
          if (n == o && a == s) {
            e = !1;
            break;
          }
    ...
    if (t.config.state) {
      ...
      !(function t(e) {
        if (Array.isArray(e)) for (var n = 0; n < e.length; n++) t(e[n]);
          ...
          for (n = 0; n < e.stChildren.length; n++) t(e.stChildren[n]);
  ...
  (OrgChart.state._put = function (t, e, r, i, n, a, o, s) {
    if (s && !OrgChart.isNEU(n) && 0 != n.length) {
      var l = OrgChart.state._buildStateNames(s.name),
        h = {
          roots: t,
      ...
      if (s.writeToUrlParams) {
        var c = new URLSearchParams(window.location.search);
        c.has(l.paramScale)
          ? c.set(l.paramScale, h.scale)
          : c.append(l.paramScale, h.scale),
          c.has(l.paramX) ? c.set(l.paramX, h.x) : c.append(l.paramX, h.x),
          c.has(l.paramY) ? c.set(l.paramY, h.y) : c.append(l.paramY, h.y),
          c.has(l.paramExp)
            ? c.set(l.paramExp, h.exp.join("*"))
            : c.append(l.paramExp, h.exp.join("*")),
          c.has(l.paramRoots) && Array.isArray(h.roots)
            ? c.set(l.paramRoots, h.roots.join("*"))
            : Array.isArray(h.roots) &&
              c.append(l.paramRoots, h.roots.join("*")),
          c.has(l.paramMin)
            ? c.set(l.paramMin, h.min.join("*"))
            : c.append(l.paramMin, h.min.join("*")),
          c.has(l.paramAdjustify)
            ? c.set(l.paramAdjustify, h.adjustify.x + "*" + h.adjustify.y)
            : c.append(l.paramAdjustify, h.adjustify.x + "*" + h.adjustify.y),
          window.history.replaceState(null, null, "?" + c);
      }
      s.writeToIndexedDB &&
        ((h.id = s.name),
        OrgChart.idb.put(h, function (t) {
          0 == t && console.error("Cannot write row - " + s.name);
        })),
        s.writeToLocalStorage &&
          OrgChart.localStorage.setItem(s.name, JSON.stringify(h));
    }
  }),
  (OrgChart.state._get = function (t, e, r, i) {
    if (t) {
      var n = OrgChart.state._buildStateNames(t.name);
      if (t.readFromUrlParams) {
        ...
        if (
          ...
          a.has(n.paramExp) &&
          a.has(n.paramMin) &&
          a.has(n.paramAdjustify)
        ) {
          var o = {},
            s = parseFloat(a.get(n.paramScale)),
            l = parseFloat(a.get(n.paramX)),
            h = parseFloat(a.get(n.paramY));
          ((d = [])[0] = l),
            (d[1] = h),
            (d[2] = e / s),
            (d[3] = r / s),
            ...
            (o.y = h),
            (o.roots = null),
            a.has(n.paramRoots) && (o.roots = a.get(n.paramRoots).split("*")),
            (o.exp = a.get(n.paramExp).split("*")),
            (o.min = a.get(n.paramMin).split("*"));
          var c = a.get(n.paramAdjustify).split("*");
          return (
      ...
      t.readFromIndexedDB &&
        OrgChart.idb.read(t.name, function (n, a) {
          if (0 == n) console.error("Cannot read from - " + t.name), i(null);
          else if (null == n) i(null);
          else {
            var o = [];
            (o[0] = a.x),
              (o[1] = a.y),
  ...
  (OrgChart._magnify = {}),
  (OrgChart.prototype.magnify = function (t, e, r, i, n) {
    i || (i = this.config.anim);
    var a = this.getNode(t),
      o = this.getNodeElement(t);
    if (a || o) {
      var s = OrgChart._magnify[t];
      if (
        (s &&
          (null != s.timer && clearInterval(s.timer),
          null != s.timerBack && clearInterval(s.timerBack),
          o.setAttribute(
            "transform",
            "matrix(" + s.transformStart.toString() + ")"
          ),
          (OrgChart._magnify[t] = null)),
        r)
      )
        (o = o.cloneNode(!0)), this.getSvg().appendChild(o);
      var l = OrgChart._getTransform(o),
        h = JSON.parse(JSON.stringify(l));
      (h[0] = e), (h[3] = e);
      var c = a.w + a.w * (e - 1),
        d = a.h + a.h * (e - 1);
      (h[4] += (a.w - c) / 2), (h[5] += (a.h - d) / 2);
  ...
  (OrgChart.prototype.magnifyBack = function (t, e, r) {
    ...
    if (i) {
      ...
      var n = OrgChart._getTransform(i.nodeElement);
  ...
  (OrgChart.prototype._windowKeyDownHandler = function (t, e) {
    ...
    if (r) {
      var n = i ? this.getNode(i) : null,
        a = { node: n, data: i ? this.get(i) : null, event: e };
      if (!1 !== OrgChart.events.publish("key-down", [this, a]) && n)
        if ("KeyF" == e.code) this.searchUI.find("");
        else if (
          "ArrowRight" == e.code ||
          (n.isAssistant && "ArrowDown" == e.code) ||
          (n.isPartner && "ArrowDown" == e.code)
        ) {
          if ((l = this.getNode(n.pid))) {
            var o = l.childrenIds.indexOf(n.id);
            if (++o < l.childrenIds.length) {
              var s = l.childrenIds[o];
              (this._keyNavigationActiveNodeId = s), this.center(s);
            }
          }
        } else if ("ArrowLeft" == e.code) {
          if ((l = this.getNode(n.pid))) {
            o = l.childrenIds.indexOf(n.id);
            if (--o >= 0) {
              s = l.childrenIds[o];
              (this._keyNavigationActiveNodeId = s), this.center(s);
            }
          ...
          if ((l = this.getNode(n.pid))) {
            ...
            if (
              ...
              o = l.childrenIds.indexOf(n.id);
              --o >= 0 && (s = l.childrenIds[o]);
            }
            (this._keyNavigationActiveNodeId = s), this.center(s);
          }
        } else if ("ArrowDown" == e.code)
          n.childrenIds.length &&
            ((this._keyNavigationActiveNodeId = n.childrenIds[0]),
            this.center(n.childrenIds[0]));
  ...
  (OrgChart._keyNavigation = function (t) {
    ...
    if (
      ...
      (n = (i = e).querySelector("title")) && n.parentNode.removeChild(n),
    ...
    if (
      ...
      var n,
        a = { text: "", id: t._keyNavigationActiveNodeId };
      if (
        (OrgChart.events.publish("screen-reader-text", [t, a]),
        !OrgChart.isNEU(a.text))
      )
  ...
  (OrgChart.elements.textbox = function (t, e, r, i) {
    ...
    if (n.doNotRender) return { html: "" };
    var a = "";
    return (
      e.btn &&
        (a = `<a href="#" data-input-btn="" class="boc-link boc-link-boc-button">${e.btn}</a>`),
      {
  ...
  (OrgChart.elements.checkbox = function (t, e, r, i) {
    var n = OrgChart.elements._vidrf(t, e, i);
    if (n.doNotRender) return { html: "" };
    var a = n.value ? "checked" : "",
      o = i ? 'onclick="return false;"' : "";
    return {
      html: `<div class="boc-form-field"  style="min-width: ${r};" >\n                        <label class="boc-checkbox" data-boc-input="" ${
        n.disabledAttribute
      }>\n                            <input ${a} ${o} data-binding="${OrgChart._escapeDoubleQuotes(
        n.binding
    ...
    return n.doNotRender
      ...
      : {
          html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${
            ...
            n.binding
          )}" ${n.readOnlyAttribute} id="${n.id}" name="${
            n.id
          }">\n                            ${(function () {
            for (var t = "", e = 0; e < n.options.length; e++) {
              var r = n.options[e];
              t += `<option ${
                r.value == n.value ? "selected" : ""
      ...
      : {
          html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${
            ...
            for (var t = "", e = 0; e < n.options.length; e++) {
              var r = n.options[e];
              t += `<option ${
                n.value.includes(r.value) ? "selected" : ""
              } value="${OrgChart._escapeDoubleQuotes(
                r.value
              )}">${OrgChart._escapeGreaterLessSign(r.text)}</option>`;
            }
    ...
    return n.doNotRender
      ...
      : {
          html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${
            ...
            n.binding
          )}" ${n.readOnlyAttribute} maxlength="256" id="${n.id}" name="${
            n.id
  ...
  (OrgChart.elements._vidrf = function (t, e, r) {
    ...
    if (
      ...
      for (var n = 0; n < i.options.length; n++)
        if (i.options[n].value == i.value) {
          i.value = i.options[n].text;
          break;
        }
    if (
      ...
      for (var a in e.vlidators)
        i.vlidators += `data-v-${a}="${e.vlidators[a]}" `;
    return i;
  }),
  ...
  (OrgChart.input.init = function (t) {
    ...
    for (var r = 0; r < e.length; r++) {
      var i = e[r],
        n = null;
      i.type && "hidden" == i.type.toLowerCase() && (n = i),
        n || (n = i.querySelector("input")),
        n || (n = i.querySelector("select"));
      ...
      a &&
        (n.value ||
          ("select-one" == n.type &&
            ...
            "" == n.selectedOptions[0].value &&
            n.selectedOptions[0].innerHTML)) &&
        a.classList.add("hasval"),
  ...
  (OrgChart.input.validate = function (t) {
    ...
    var n = t.getAttribute("data-v-required"),
      a = t.getAttribute("data-v-password"),
      o = t.getAttribute("data-v-email"),
      s = t.getAttribute("data-v-emails");
    return n && "" == e.value
      ? ((r.innerHTML +=
          '<span class="boc-validation-error-message">&nbsp;' + n + "</span>"),
        e.classList.add("boc-validation-error"),
        !1)
      : a && !OrgChart.input.validatePassword(e.value)
      ? ((r.innerHTML +=
      ...
      ? ((r.innerHTML +=
        ...
        e.classList.add("boc-validation-error"),
        !1)
      : !(s && !OrgChart.input.isValidEmails(e.value)) ||
        ((r.innerHTML +=
          '<span class="boc-validation-error-message">&nbsp;' + s + "</span>"),
        e.classList.add("boc-validation-error"),
        !1);
  }),
  (OrgChart.input.validateAndGetData = function (t) {
    for (
      ...
      var n = e[i];
      OrgChart.input.validate(n) || (r = !1);
    }
    return !!r && OrgChart.input.getData(t);
  }),
  (OrgChart.input.getData = function (t) {
    for (
      var e = t.querySelectorAll("[data-binding]"), r = {}, i = 0;
      i < e.length;
      i++
    ) {
      var n = e[i],
        a = n.getAttribute("data-binding");
      if ("checkbox" == n.type.toLowerCase()) r[a] = n.checked;
      else if (n.selectedOptions && n.hasAttribute("multiple")) {
        var o = n.selectedOptions;
        r[a] = Array.from(o).map(({ value: t }) => t);
      } else r[a] = n.value;
    }
    return r;
  }),
  ...
  (OrgChart.prototype.onRemoveNode = function (t) {
    return this.on("remove", function (e, r, i) {
      var n = { id: r, newPidsAndStpidsForIds: i };
      return t.call(e, n);
    });
  }),
  ...
  (OrgChart.prototype.onDrop = function (t) {
    return this.on("drop", function (e, r, i, n, a) {
      var o = { dragId: r, dropId: i, dragNodeElement: n, event: a };
      return t.call(e, o);
    });
  }),
  (OrgChart.prototype.onDrag = function (t) {
    return this.on("drag", function (e, r, i, n) {
      var a = { dragId: r, event: i, nodeIds: n };
      return t.call(e, a);
    });
  }),
  (OrgChart.prototype.onExpandCollapseButtonClick =
    OrgChart.prototype.onExpandCollpaseButtonClick =
      function (t) {
        return this.on("expcollclick", function (e, r, i, n) {
          var a = { collapsing: r, id: i, ids: n };
          return t.call(e, a);
        });
      }),
  ...
  (OrgChart.prototype.onCanvasClick = function (t) {
    return this.on("canvas-click", function (e, r) {
      return t.call(e, r);
    });
  }),
  ...
  (OrgChart.prototype.onAIToolCalls = function (t) {
    return this.on("ai-tool-calls", function (e, r) {
      return t.call(e, r);
    });
  }),
    ...
    if (
      ...
      for (var e in this.filterBy) {
        ...
        if (null != r) {
          ...
          if (null != i) {
            var n = i[r];
            if (null != n && !1 === n.checked) return !0;
          }
        }
      }
    return !1;
  ...
  (OrgChart.filterUI.prototype._removeFilter = function (t) {
    var e = this.instance.get(t);
    for (var r in this.filterBy) {
      var i = this.filterBy[r];
      for (var n in e) {
        var a = e[n];
        i[a] && (i[a].checked = !0);
      }
  ...
  (OrgChart.filterUI.prototype.update = function () {
    if (this.instance.config.filterBy) {
      ...
      if ("all" == this.instance.config.filterBy)
        ...
        for (var n in this.instance.config.filterBy) t[n] = {};
      for (var a in t) {
        var o = t[a];
        for (r = 0; r < this.instance.config.nodes.length; r++) {
          var s = this.instance.config.nodes[r][a];
          null != s && (o[s] || (o[s] = { checked: !0, text: s }));
        }
      }
      if (null != this.filterBy)
        for (var l in t)
          if (this.filterBy[l])
            for (var h in t[l])
              this.filterBy[l][h] && (t[l][h] = this.filterBy[l][h]);
      if (OrgChart.FILTER_ALPHABETICALLY) {
        ...
        for (var a in t) {
          o = t[a];
          t[a] = {};
          for (c = Object.keys(o).sort(), r = 0; r < c.length; r++) {
            var g = c[r];
            t[a][g] = o[g];
          }
        }
      ...
      for (var l in this.filterBy) {
        var f = { name: l, html: `<div data-filter-field="${l}">${l}</div>` };
      ...
      (this.element.innerHTML = `<div>${u}</div>`),
        this.element.addEventListener("click", function (t) {
          if (
            ...
            var n = p.instance.element.querySelectorAll(
              ".filter-field-selected"
            );
            for (i = 0; i < n.length; i++)
              n[i].classList.remove("filter-field-selected");
            var a = p.instance.element.querySelector("[data-filter-close]");
            if (
            ...
            if (!o) {
              var s = "checked";
              for (var l in p.filterBy[e]) {
                p.filterBy[e][l].checked || (s = "");
              }
              var h = {
                name: e,
              ...
              var c = h.html;
              for (var d in p.filterBy[e]) {
                var g = p.filterBy[e][d],
                  u = g.text;
                null == u && (u = d),
                  (h = {
                    name: e,
                    ...
                    value: d,
                    checked: g.checked,
                    html: `<div>\n                            <input  type="checkbox" id="${e}_${d}" name="${d}" ${
                      g.checked ? "checked" : ""
                  ...
                  if (e) {
                    ...
                    if (t.target.hasAttribute("data-all")) {
                      for (
                        ...
                        if (i[n] != t.target)
                          for (var a in ((i[n].checked = t.target.checked),
                          p.filterBy[r]))
                            p.filterBy[r][a].checked = t.target.checked;
                    } else if (
                      ...
                      for (
                        var o = p.instance.config.nodes, s = 0;
                        s < o.length;
                        s++
                      )
                        if (o[s][r] == this.name)
                          for (var l = o[s]; l; )
                            if (OrgChart.isNEU(l.stpid))
                              l = OrgChart.isNEU(l.pid)
                                ? null
                                : p.instance._get(l.pid);
                            else if ((l = p.instance._get(l.stpid))[r]) {
                              var h =
                              ...
                              h
                                ? ((h.checked = this.checked),
                                  (p.filterBy[r][l[r]].checked = this.checked))
                                : console.error(
                    ...
                    var c = !0;
                    for (var d in p.filterBy[r]) {
                      p.filterBy[r][d].checked || (c = !1);
                    }
                    (e.querySelector("[data-all]").checked = c),
                      p.instance.draw();
                  }
                });
            }
            (o.style.display = "block"),
              ...
              (a = document.createElement("div")).classList.add("close"),
              (a.innerHTML = "x"),
              a.setAttribute("data-filter-close", ""),
              t.target.parentNode.appendChild(a),
  ...
  (OrgChart.remote._fromResDTO = function (t, e, r, i, n) {
    ...
    (t.x = a.p[0]),
      ...
      (t.w = a.p[2]),
      (t.h = a.p[3]),
      null != a.ln && (t.leftNeighbor = n[a.ln]),
      null != a.rn && (t.rightNeighbor = n[a.rn]),
      a.tl &&
        ((t.treeList = {}),
        (t.treeList.pinnedIds = a.tl[0]),
        (t.treeList.scrollTop = a.tl[1]),
        (t.treeList.scrollTopMax = a.tl[2]),
        (t.treeList.maxHeight = a.tl[3]));
    for (var o = 0; o < t.stChildren.length; o++)
      OrgChart.remote._fromResDTO(t.stChildren[o], e, r, i, n);
    for (o = 0; o < t.children.length; o++)
      OrgChart.remote._fromResDTO(t.children[o], e, r, i, n);
  }),
  (OrgChart.remote._toReqDTO = function (t, e) {
    ...
    t.children.length > 0 &&
      ...
      t.treeList && (r.z = [t.treeList.scrollTop, t.treeList.maxHeight]),
      e.push(r);
  ...
  (OrgChart.remote._setPositions = function (t, e, r, i) {
    for (
      var n = [], a = [], o = OrgChart.remote._toReqLayoutConfigsDTO(e), s = 0;
      s < t.length;
      s++
    )
      a.push(t[s].id), OrgChart.remote._toReqDTO(t[s], n);
    var l = { n: n, c: o, r: a, v: "9.00.19" };
    if (
      (OrgChart.LIMIT_NODES || (l.l = !0), null != OrgChart.remote._fromReqDTO)
    )
      OrgChart.remote._fromReqDTO(l.n, l.r, l.c, function (e) {
        for (var n = 0; n < t.length; n++)
          OrgChart.remote._fromResDTO(t[n], e, 0, t, i);
        r();
      });
    else {
      l = JSON.stringify(l);
      var h = OrgChart.localStorage.getItem(l);
      console.log('hhhhh')
      ...
      //         OrgChart._ajax(e, "post", l, "json", function (e) {
      //           e.error
      //             ? r(2)
      //             : (OrgChart.remote._proceed(t, e, i, r),
      //               OrgChart.localStorage.setItem(l, JSON.stringify(e)));
      //         });
      //       });
    }
  }),
  (OrgChart.remote._proceed = function (t, e, r, i) {
    ...
    if (("string" == typeof e && (e = JSON.parse(e)), e.limit && 1 == e.limit))
      ...
      for (var n = 0; n < t.length; n++)
        OrgChart.remote._fromResDTO(t[n], e, 0, t, r);
      i();
    }
  }),
  (OrgChart.remote._findRegion = function (t) {
    ...
    if (e) {
      ...
      for (n = 0; n < r.length; n++)
        (function () {
          var e = "https://" + r[n] + OrgChart.SERVER_PREFIX,
            a = i[n];
            console.log('地址--------',e);
